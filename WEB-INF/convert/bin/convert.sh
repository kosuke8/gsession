...
export CLASSPATH="$CLASSPATH":../../lib/log4j-api-2.3.jar
export CLASSPATH="$CLASSPATH":../../lib/log4j-core-2.3.jar
export CLASSPATH="$CLASSPATH":../../lib/log4j-jcl-2.3.jar
export CLASSPATH="$CLASSPATH":../../lib/log4j-slf4j-impl-2.3.jar
export CLASSPATH="$CLASSPATH":../../lib/log4j-web-2.3.jar
