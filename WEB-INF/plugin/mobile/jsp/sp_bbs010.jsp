...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <logic:iterate id="forumMdl" name="mbhBbs010Form" property="forumList" indexId="idx">
    ...
    <% int dep = 15 * intLevel - 15; %>
    <li data-theme=<bean:write name="liColor" /> >
      <a href="../mobile/sp_bbs020.do?mobileType=1&bbs010forumSid=<bean:write name="forumMdl" property="bfiSid" />" style="margin-left:<%= dep %>;"><span style="color:<%= titleColor %>;"><bean:write name="forumMdl" property="bfiName" /><span>
