...
<%@page import="jp.groupsession.v2.sml.model.SmailUsrModel"%>
...
<logic:notEqual name="mbhSml050Form" property="sml050GroupSid" value="sac">
  <logic:notEmpty name="mbhSml050Form" property="sml050UserList">
    <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
      <logic:iterate id="userList" name="mbhSml050Form" property="sml050UserList" indexId="idx" type="SmailUsrModel">
      <li>
        <a href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.sml050.MbhSml050Form.PARAM_SELECTADR %><bean:write name="userList" property="usrSid" />');"><span class="<%=UserUtil.getCSSClassNameNormal(userList.getUsrUkoFlg())%>"><bean:write name="userList" property="usiSei" />&nbsp;&nbsp;<bean:write name="userList" property="usiMei" /></span></a>
      </li>
      </logic:iterate>
    </ul>
  </logic:notEmpty>
