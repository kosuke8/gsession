...
<%@page import="jp.groupsession.v2.rng.model.RingiDataModel"%>
...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <logic:iterate id="rngData" name="mbhRng020Form" property="rngDataList" indexId="idx" scope="request" type="RingiDataModel">
    ...
    <li data-theme=<bean:write name="liColor" />>
      ...
      <% if (sMode == mode0) { %>
        ...
        <div class="font_small">
          <logic:equal value="true" name="rngData" property="apprUserDelFlg">
          ■<gsmsg:write key="rng.47" />：<del><bean:write name="rngData" property="apprUser" /></del>
          </logic:equal>
          <logic:notEqual value="true" name="rngData" property="apprUserDelFlg">
          ■<gsmsg:write key="rng.47" />：<span class="<%=UserUtil.getCSSClassNameNormal(rngData.getUsrUkoFlg())%>"><bean:write name="rngData" property="apprUser" /></span>
          </logic:notEqual>
          <br>
