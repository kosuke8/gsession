...
<html:hidden property="rsv030Public" />
...
<logic:notEmpty name="mbhRsv050Form" property="rsv030BelongLabel" scope="request">
  <logic:iterate id="urBean" name="mbhRsv050Form" property="rsv030BelongLabel" scope="request" type="CmnUsrmInfModel">
  <li>
    <a class="<%=UserUtil.getCSSClassNameNormal(urBean.getUsrUkoFlg()) %>" href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.rsv030.MbhRsv030Form.PARAM_SELECTADR %><bean:write name="urBean" property="usrSid" scope="page"/>');"><bean:write name="urBean" property="usiSei" scope="page"/>　<bean:write name="urBean" property="usiMei" scope="page"/></a>
  </li>
</logic:iterate>
</logic:notEmpty>
