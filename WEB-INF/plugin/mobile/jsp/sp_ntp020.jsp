...
<%@page import="jp.groupsession.v2.ntp.ntp010.Ntp010UsrModel"%>
...
<bean:define id="usrMdl" name="weekMdl" property="ntp010UsrMdl" type="Ntp010UsrModel"/>
    ...
    <div data-role="collapsible" data-collapsed="false">
      <h2>
        <div align="center">
          <span class="<%=UserUtil.getCSSClassNameNormal(usrMdl.getUsrUkoFlg())%>"><bean:write name="usrMdl" property="usrName" /></span>
        </div>
      </h2>
...
<bean:define id="usrMdl" name="gpWeekMdl" property="ntp010UsrMdl" type="Ntp010UsrModel"/>
