...
<logic:notEmpty name="mbhRng050Form" property="rng040userList">
  <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
    ...
    <logic:iterate id="userList" name="mbhRng050Form" property="rng040userList" indexId="idx" type="UsrLabelValueBean">
...
--%>
      ...
      <li data-theme=<bean:write name="liColor" />>
        <a href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.rng040.MbhRng040Form.PARAM_SELECTADR %><bean:write name="userList" property="value" />');"><span class="<%=userList.getCSSClassNameNormal()%>"><bean:write name="userList" property="label" /></span></a>
      </li>
    </logic:iterate>
  </ul>
</logic:notEmpty>
