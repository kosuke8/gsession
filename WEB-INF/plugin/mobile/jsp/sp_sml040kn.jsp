...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li>
    ...
    <bean:define id="usrUkoFlg" name="mbhSml040knForm"  property="smlViewAccountUkoFlg" type="Integer"/>
    <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhSml040knForm"  property="smlViewAccountName" /></span>
  </li>

  <li>
    <div class="font_small">■<gsmsg:write key="cmn.from" /></div>
      <logic:notEmpty name="mbhSml040knForm" property="sml040SelectUserList">
      <logic:iterate id="usrLabel" name="mbhSml040knForm" property="sml040SelectUserList" indexId="idx" type="UsrLabelValueBean">
      <span class="<%=usrLabel.getCSSClassNameNormal()%>"><bean:write name="usrLabel" property="label" /></span><br>
      </logic:iterate>
      </logic:notEmpty>
  </li>
  ...
  <logic:notEmpty name="mbhSml040knForm" property="sml040CcSelectUserList">
    ...
    <div class="font_small">■CC</div>
      <logic:iterate id="usrCcLabel" name="mbhSml040knForm" property="sml040CcSelectUserList" indexId="idx" type="UsrLabelValueBean">
        <span class="<%=usrCcLabel.getCSSClassNameNormal()%>"><bean:write name="usrCcLabel" property="label" /></span><br>
      </logic:iterate>
    </li>
  </logic:notEmpty>
  ...
  <logic:notEmpty name="mbhSml040knForm" property="sml040BccSelectUserList">
    ...
    <div class="font_small">■BCC</div>
      <logic:iterate id="usrBccLabel" name="mbhSml040knForm" property="sml040BccSelectUserList" indexId="idx" type="UsrLabelValueBean">
        <span class="<%=usrBccLabel.getCSSClassNameNormal()%>"><bean:write name="usrBccLabel" property="label" /></span><br>
      </logic:iterate>
    </li>
  </logic:notEmpty>
