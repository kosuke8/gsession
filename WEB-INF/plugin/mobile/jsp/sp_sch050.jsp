...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <logic:iterate id="userList" name="mbhSch050Form" property="sch040BelongLavel" indexId="idx" type="CmnUsrmInfModel">
    ...
    <li data-theme=<bean:write name="liColor" />>
      <a href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.sch040.MbhSch040Form.PARAM_SELECTADR %><bean:write name="userList" property="usrSid" />');"><span class="<%=UserUtil.getCSSClassNameNormal(userList.getUsrUkoFlg())%>"><bean:write name="userList" property="usiSei" /> <bean:write name="userList" property="usiMei" /></span></a>
    </li>
  </logic:iterate>
</ul>
...
<logic:notEmpty name="mbhSch050Form" property="sch050UserList">
  <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
    ...
    <bean:define id="mod" value="0" />
    <logic:iterate id="userList" name="mbhSch050Form" property="sch050UserList" indexId="idx" type="UsrLabelValueBean">
      <logic:equal name="mod" value="<%= String.valueOf(idx.intValue() % 2) %>">
        <bean:define id="liColor" value="c" />
      </logic:equal>
      <logic:notEqual name="mod" value="<%= String.valueOf(idx.intValue() % 2) %>">
