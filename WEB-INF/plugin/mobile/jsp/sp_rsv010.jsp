                    ...
                    <div align="center">
                      <ul style="width:80%;" data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
                        ...
                        <li data-role="list-divider" style="background:#ffffff;">
                          ...
                          <logic:iterate id="yrk" name="day" property="yoyakuList" indexId="idx" type="MbhRsvYoyakuModel">
                               ...
                               <li>
                                ...
                                <span class="font_small" style="color:blue;">
                                  ...
                                  <logic:notEmpty name="yrk" property="yrkName">
                                    <logic:equal value="<%=String.valueOf(GSConstUser.USER_JTKBN_DELETE) %>"  name="yrk" property="yrkJkbn"><del><bean:write name="yrk" property="yrkName" /></del></logic:equal>
                                    <logic:notEqual value="<%=String.valueOf(GSConstUser.USER_JTKBN_DELETE) %>" name="yrk" property="yrkJkbn"><span class="<%=UserUtil.getCSSClassNameNormal(yrk.getYrkUkoFlg())%>"><bean:write name="yrk" property="yrkName" /></span></logic:notEqual>
                                  </logic:notEmpty>
                                </span>
                              </a>
                              </li>
