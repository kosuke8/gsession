...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li>
    ...
    <bean:define id="usrUkoFlg" name="mbhCir050knForm" property="cirViewAccountUkoFlg" type="Integer" />
    <span class="text_base <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhCir050Form" property="cirViewAccountName" /></span>
  </li>
  ...
  <li>
    ...
    <br>
    <logic:iterate id="memMdl" name="mbhCir050knForm" property="cir050MemberList" scope="request" type="CirAccountModel">
      <span class="text_base <%=UserUtil.getCSSClassNameNormal(memMdl.getUsrUkoFlg())%>">
