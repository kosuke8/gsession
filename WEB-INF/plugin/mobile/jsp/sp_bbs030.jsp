<%@page import="jp.groupsession.v2.bbs.model.BulletinDspModel"%>
...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  <li data-role="list-divider">
    <div align="center">
      ...
      <hr>
      <b>
        <logic:equal name="mbhBbs030Form" property="bbs030ThreImportance" value="1">
          <img src="../smail/images/zyuu.gif" alt="<gsmsg:write key="sml.61" />" class="img_bottom_buntou">
        </logic:equal>
        <bean:write name="mbhBbs030Form" property="bbs030threadTitle" /></b><logic:notEmpty name="mbhBbs030Form" property="bbsPageLabel"><div class="font_small">(<bean:write name="mbhBbs030Form" property="bbs030page1" />/<bean:write name="mbhBbs030Form" property="bbs030maxPage" />)</div></logic:notEmpty>
    </div>
  </li>
</ul>

  <bean:define id="mod" value="0" />
  <logic:iterate id="writeMdl" name="mbhBbs030Form" property="writeList" indexId="idx" type="BulletinDspModel">
  ...
  <div class="text_box">
      <div class="font_xsmall">
        ...
        <logic:notEqual name="writeMdl" property="userJkbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_DELETE) %>">
          <span class="<%=UserUtil.getCSSClassNameNormal(writeMdl.getUserYukoKbn())%>"><bean:write name="writeMdl" property="userName" /></span>
        </logic:notEqual>
        </b>
        <br>
      ...
      <logic:equal name="writeMdl" property="bwiType" value="<%= String.valueOf(jp.groupsession.v2.bbs.GSConstBulletin.CONTENT_TYPE_TEXT_PLAIN) %>"><bean:write name="writeMdl" property="bwiValueView" filter="false" /></logic:equal>
      <logic:equal name="writeMdl" property="bwiType" value="<%= String.valueOf(jp.groupsession.v2.bbs.GSConstBulletin.CONTENT_TYPE_TEXT_HTML) %>"><bean:write name="writeMdl" property="bwiValuePlainView" filter="false" /></logic:equal>
      <br>
      <div class="font_xsmall">
