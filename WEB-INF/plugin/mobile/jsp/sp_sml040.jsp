...
<bean:define id="usrUkoFlg" name="mbhSml040Form"  property="smlViewAccountUkoFlg" type="Integer"/>
<div class="font_small">■<gsmsg:write key="cmn.sender" />：<span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhSml040Form"  property="smlViewAccountName" /></span></div>
