...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <bean:define id="usrUkoFlg" name="mbhCir030Form" property="cirViewAccountUkoFlg" type="Integer" />
  <span class="text_base <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhCir030Form" property="cirViewAccountName" /></span>
  </li>
  ...
  <li>
    ...
    <span class="text_base">
      <logic:equal name="dspMdl" property="cacJkbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
        <bean:define id="usrUkoFlg" name="dspMdl" property="usrUkoFlg" type="Integer" />
        <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="dspMdl" property="cacName" /></span>
      </logic:equal>
