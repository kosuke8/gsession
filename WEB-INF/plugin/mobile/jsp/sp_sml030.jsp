<%@page import="jp.groupsession.v2.sml.model.AtesakiModel"%>
<%@page import="jp.groupsession.v2.usr.UserUtil"%>
<%@page import="jp.groupsession.v2.sml.model.SmailDetailModel"%>
...
<logic:iterate id="msg" name="mbhSml030Form" property="sml030SmlList" indexId="idx" scope="request" type="SmailDetailModel">
  ...
  <logic:equal name="mbhSml030Form" property="sml010ProcMode" value="<%= gomi %>">
    ...
    <logic:equal name="mbhSml030Form" property="sml020SelectedMailKbn" value="<%= sosin %>">
      <li>
        ...
        <logic:iterate id="atesaki" name="msg" property="atesakiList" indexId="idx_at" scope="page" type="AtesakiModel">
          <logic:equal name="atesaki" property="usrJkbn" value="<%= toroku %>"><span class="text_base <%=UserUtil.getCSSClassNameNormal(atesaki.getUsrUkoFlg())%>"><bean:write name="atesaki" property="usiSei" />&nbsp;&nbsp;<bean:write name="atesaki" property="usiMei" /></span></logic:equal>
      ...
      <logic:notEmpty name="msg" property="ccList" scope="page">
        <li>
          ...
          <logic:iterate id="cc" name="msg" property="ccList" indexId="idx_cc3" scope="page" type="AtesakiModel">
            <logic:equal name="cc" property="usrJkbn" value="<%= toroku %>"><span class="text_base <%=UserUtil.getCSSClassNameNormal(cc.getUsrUkoFlg())%>"><bean:write name="cc" property="usiSei" />&nbsp;&nbsp;<bean:write name="cc" property="usiMei" /><logic:notEqual name="msg" property="ccListSize" value="<%= String.valueOf(idx_cc3.intValue()) %>"><br></logic:notEqual></span></logic:equal>
      ...
      <logic:notEmpty name="msg" property="bccList" scope="page">
        <li>
          ...
          <logic:iterate id="bcc" name="msg" property="bccList" indexId="idx_bcc3" scope="page" type="AtesakiModel">
            <logic:equal name="bcc" property="usrJkbn" value="<%= toroku %>"><span class="text_base <%=UserUtil.getCSSClassNameNormal(bcc.getUsrUkoFlg())%>"><bean:write name="bcc" property="usiSei" />&nbsp;&nbsp;<bean:write name="bcc" property="usiMei" /><logic:notEqual name="msg" property="bccListSize" value="<%= String.valueOf(idx_bcc3.intValue()) %>"><br></logic:notEqual></span></logic:equal>
