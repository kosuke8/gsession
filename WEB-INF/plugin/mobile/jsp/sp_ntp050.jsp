...
<logic:iterate id="userList" name="mbhNtp050Form" property="ntp050UserList" indexId="idx" type="UsrLabelValueBean">
<li>
<a href="./<bean:write name="mbhNtp050Form" property="ntp050DispId" />.do?mobileType=1&CMD=addUser&ntp010SelectUsrSid=<bean:write name="userList" property="value" />&ntp010DspDate=<bean:write name="mbhNtp050Form" property="ntp010DspDate" />&ntp010DspGpSid=<bean:write name="mbhNtp050Form" property="ntp050GroupSid" />&changeDateFlg=<bean:write name="mbhNtp050Form" property="changeDateFlg" />"><span class="<%=userList.getCSSClassNameNormal()%>"><bean:write name="userList" property="label" /></span></a><br>
</li>
</logic:iterate>
</ul>
</logic:notEmpty>
