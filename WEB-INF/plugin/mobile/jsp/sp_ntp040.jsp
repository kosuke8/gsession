...
<span style="color: red"><html:errors/></span>
    ...
    <logic:equal name="mbhNtp040Form" property="cmd" value="add">
      ...
      <bean:define id="usrUkoFlg" name="mbhNtp040Form" property="ntp040UsrUkoFlg" type="Integer"/>
      <span class="text_base <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhNtp040Form" property="ntp040UsrName" /></span>
  ...
  <logic:notEmpty name="trgDspMdl" property="ntgList">
    ...
    <logic:equal name="mbhNtp040Form" property="cmd" value="add">
      <jsp:include page="/WEB-INF/plugin/mobile/jsp/sp_ntp040_add.jsp" />
    </logic:equal>

    <logic:notEqual name="mbhNtp040Form" property="cmd" value="add">
      <jsp:include page="/WEB-INF/plugin/mobile/jsp/sp_ntp040_edit.jsp" />
    </logic:notEqual>
