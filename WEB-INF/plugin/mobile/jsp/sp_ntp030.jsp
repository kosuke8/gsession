...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li data-role="list-divider" style="background:#ffffff;">
    <div align="center">
      <bean:define id="usrUkoFlg" name="mbhNtp030Form" property="ntp010UserUkoFlg" type="Integer"/>
      <b><span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhNtp030Form" property="ntp030UsrName" /></span></b>
      <hr>
