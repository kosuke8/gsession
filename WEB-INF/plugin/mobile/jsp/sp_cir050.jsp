...
<bean:define id="usrUkoFlg" name="mbhCir050Form" property="cirViewAccountUkoFlg" type="Integer" />
<span class="text_base <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhCir050Form" property="cirViewAccountName" /></span><br><br>
...
<logic:notEmpty name="mbhCir050Form" property="cir050MemberList" scope="request">
  <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
      <logic:iterate id="memMdl" name="mbhCir050Form" property="cir050MemberList" scope="request" type="CirAccountModel">
        ...
        <logic:greaterThan name="memMdl" property="cacSid" value="0">
          ...
          <logic:greaterThan name="memMdl" property="usrSid" value="0">
            <li data-icon="delete">
              <a class="<%=UserUtil.getCSSClassNameNormal(memMdl.getUsrUkoFlg())%>" href="#" onClick="delPush('<bean:write name="memMdl" property="usrSid" />');" ><bean:write name="memMdl" property="cacName" /></a>
            </li>
          </logic:greaterThan>
