...
<% String sousin = String.valueOf(jp.groupsession.v2.cir.GSConstCircular.MODE_SOUSIN); %>
...
<bean:define id="cirCmdMode" name="mbhCir040Form" property="cir020cmdMode" type="java.lang.String" />
<bean:define id="cirCreateFlg" name="mbhCir040Form" property="cirCreateFlg" type="java.lang.Boolean" />

<div data-role="controlgroup" data-type="horizontal" align="center">
  <span class="font_small">
    <% if (!cirCmdMode.equals(gomi) && cirCreateFlg.booleanValue()) { %>
      <input name="copyButton" value="<gsmsg:write key="cmn.register.copy.new" />" class="btn_dell_n1" type="submit">
    <% } %>

    <!-- 削除 -->
    <% if (!cirCmdMode.equals(sousin) || cirCreateFlg.booleanValue()) { %>
...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li>
    ...
    <bean:define id="usrUkoFlg" name="mbhCir040Form" property="cirViewAccountUkoFlg" type="Integer" />
    <span class="text_base <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhCir040Form" property="cirViewAccountName" /></span>
  </li>
    ...
    <logic:iterate id="memMdl" name="mbhCir040Form" property="cir030memList" scope="request">
      <li>
        ...
        <logic:equal name="memMdl" property="cacJkbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_TOROKU) %>">
          <bean:define id="usrUkoFlg" name="memMdl" property="usrUkoFlg" type="Integer" />
          <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="memMdl" property="cacName" /></span>
        </logic:equal>
