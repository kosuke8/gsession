...
<%@page import="jp.groupsession.v2.sml.model.SmailModel"%>
...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li data-role="list-divider">
    <div align="center">
      <bean:define id="usrUkoFlg" name="mbhSml020Form"  property="smlViewAccountUkoFlg" type="Integer"/>
      <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhSml020Form"  property="smlViewAccountName" /></span><br>
      <b>
        <logic:equal name="mbhSml020Form" property="sml010ProcMode" value="0"><gsmsg:write key="cmn.receive" /><gsmsg:write key="cmn.list" /></logic:equal>
        <logic:equal name="mbhSml020Form" property="sml010ProcMode" value="1"><gsmsg:write key="cmn.sent" /><gsmsg:write key="cmn.list" /></logic:equal>
        <logic:equal name="mbhSml020Form" property="sml010ProcMode" value="2"><gsmsg:write key="cmn.draft" /><gsmsg:write key="cmn.list" /></logic:equal>
  ...
  <logic:iterate id="msg" name="mbhSml020Form" property="sml020SmlList" indexId="idx" scope="request" type="SmailModel">
    ...
    <li data-theme=<bean:write name="liColor" />>
      ...
      <logic:equal name="mbhSml020Form" property="sml010ProcMode" value="<%= sosin %>">
        ...
        <logic:iterate id="atesaki" name="msg" property="atesakiList" indexId="idx_at" scope="page" type="AtesakiModel">
          ...
          <span class="<%=UserUtil.getCSSClassNameNormal(atesaki.getUsrUkoFlg())%>"><bean:write name="atesaki" property="usiSei" />&nbsp;&nbsp;<bean:write name="atesaki" property="usiMei" /></span>
          </logic:equal>
