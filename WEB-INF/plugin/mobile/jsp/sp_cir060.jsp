...
<%@page import="jp.groupsession.v2.cir.model.CircularUsrModel"%>
...
<logic:notEqual name="mbhCir060Form" property="cir060GroupSid" value="cac">
  <logic:notEmpty name="mbhCir060Form" property="cir060UserList">
    <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
      <logic:iterate id="userList" name="mbhCir060Form" property="cir060UserList" indexId="idx" type="CircularUsrModel ">
      <li>
        <a class="<%=UserUtil.getCSSClassNameNormal(userList.getUsrUkoFlg()) %>" href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.cir060.MbhCir060Form.PARAM_SELECTADR %><bean:write name="userList" property="usrSid" />');"><bean:write name="userList" property="usiSei" />&nbsp;&nbsp;<bean:write name="userList" property="usiMei" /></a>
      </li>
      </logic:iterate>
    </ul>
  </logic:notEmpty>
