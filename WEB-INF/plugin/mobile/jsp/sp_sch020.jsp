...
<%@page import="jp.groupsession.v2.sch.sch010.Sch010UsrModel"%>
...
<bean:define id="usrMdl" name="weekMdl" property="sch010UsrMdl" type="Sch010UsrModel"/>
  ...
  <logic:iterate id="dayMdl" name="weekMdl" property="sch010SchList">
    ...
    <logic:empty name="dayMdl" property="schDataList">
      <div align="center">
        <p class="btn_fake"><b><span class="<%=UserUtil.getCSSClassNameNormal(usrMdl.getSchUkoFlg())%>"><bean:write name="usrMdl" property="usrName"/></span></b></p>
      </div>
...
<bean:define id="usrMdl" name="weekMdl" property="sch010UsrMdl"  type="Sch010UsrModel"/>
  ...
  <logic:iterate id="dayMdl" name="weekMdl" property="sch010SchList">
    ...
    <div data-role="collapsible" data-collapsed="false">
      <h2>
        <div align="center">
          <span class="<%=UserUtil.getCSSClassNameNormal(usrMdl.getSchUkoFlg())%>"><bean:write name="usrMdl" property="usrName"/></span>
        </div>
      </h2>
    <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
