...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li data-role="list-divider" style="background:#ffffff;">
    <div align="center">
      <bean:define id="usrUkoFlg" name="mbhSch030Form" property="sch010UserUkoFlg" type="Integer"/>
      <b><span class=" <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhSch030Form" property="sch030UsrName" /></span></b>
      <hr>
