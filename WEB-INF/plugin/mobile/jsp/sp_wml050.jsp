...
<%@page import="jp.groupsession.v2.wml.wml010.model.Wml010AddressModel"%>
...
<html:hidden property="wml040fileTempDirId" />
...
<logic:notEmpty name="mbhWml050Form" property="userList">
  <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
    ...
    <logic:iterate id="userData" name="mbhWml050Form" property="userList" type="Wml010AddressModel">
      <li>
        <a href="#" onClick="addUser('<%= jp.groupsession.v3.mbh.wml050.MbhWml050Form.PARAM_SELECTADR %><bean:write name="userData" property="userSid" />');"><span class="<%=UserUtil.getCSSClassNameNormal(userData.getUsrUkoFlg())%>"><bean:write name="userData" property="userName" /></span></a>
      </li>
    </logic:iterate>
  </ul>
</logic:notEmpty>
