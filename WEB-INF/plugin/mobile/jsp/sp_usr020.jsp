...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li>
    ...
    <bean:define id="usrUkoFlg" name="mbhUsr020Form" property="usr020usrUkoFlg" type="Integer"/>
    <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhUsr020Form" property="usr020usiSei" />&nbsp;&nbsp;<bean:write name="mbhUsr020Form" property="usr020usiMei" /></span>
  </li>
  <li>
    <div class="font_small">■<gsmsg:write key="cmn.name" />（<gsmsg:write key="cmn.kana" />）</div>
    <span class="<%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhUsr020Form" property="usr020usiSeiKn" />&nbsp;&nbsp;<bean:write name="mbhUsr020Form" property="usr020usiMeiKn" /></span>
  </li>
