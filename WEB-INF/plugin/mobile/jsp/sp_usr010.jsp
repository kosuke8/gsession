...
<logic:notEmpty name="mbhUsr010Form" property="usr010users">
  <ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
    ...
    <logic:iterate id="user" name="mbhUsr010Form" property="usr010users" scope="request" indexId="labelIdx" type="CmnUsrmInfModel">
      ...
      <logic:equal name="mbhUsr010Form" property="usr010cmdMode" value="2">
        <li data-theme=<bean:write name="liColor" />>
          <a href="../mobile/sp_usr020.do?mobileType=1&userSid=<bean:write name="user" property="usrSid" />&usr010cmdMode=<bean:write name="mbhUsr010Form" property="usr010cmdMode" />&usr010pageNum1=<bean:write name="mbhUsr010Form" property="usr010pageNum1" />&selectgsid=<bean:write name="mbhUsr010Form" property="selectgsid" />"><span class="<%=UserUtil.getCSSClassNameNormal(user.getUsrUkoFlg())%>"><bean:write name="user" property="usiSei" />&nbsp;<bean:write name="user" property="usiMei" /></span></a>
        </li>
      </logic:equal>
      <logic:notEqual name="mbhUsr010Form" property="usr010cmdMode" value="2">
        <li>
          <a href="../mobile/sp_usr020.do?mobileType=1&userSid=<bean:write name="user" property="usrSid" />&usr010cmdMode=<bean:write name="mbhUsr010Form" property="usr010cmdMode" />&usr010pageNum1=<bean:write name="mbhUsr010Form" property="usr010pageNum1" />&usr010selectedLabel=<bean:write name="mbhUsr010Form" property="usr010selectedLabel" />&usr010SelectInd=<bean:write name="mbhUsr010Form" property="usr010SelectInd" />&usr010SearchInd=<bean:write name="mbhUsr010Form" property="usr010SearchInd" />&usr010SearchTopFlg=<bean:write name="mbhUsr010Form" property="usr010SearchTopFlg" />&usr010SearchKanaFlg=<bean:write name="mbhUsr010Form" property="usr010SearchKanaFlg" />"><span class="<%=UserUtil.getCSSClassNameNormal(user.getUsrUkoFlg())%>"><bean:write name="user" property="usiSei" />&nbsp;<bean:write name="user" property="usiMei" /></span></a>
        </li>
      </logic:notEqual>
    </logic:iterate>
  </ul>
