...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <logic:iterate id="threadMdl" name="mbhBbs020Form" property="threadList" indexId="idx" type="BulletinDspModel">
  ...
  <logic:notEqual name="mod" value="<%= String.valueOf(idx.intValue() % 2) %>">
    ...
    <li data-theme=<bean:write name="liColor" />>
      <a href="./sp_bbs030.do?mobileType=1&bbs010forumSid=<bean:write name="mbhBbs020Form" property="bbs010forumSid" />&threadSid=<bean:write name="threadMdl" property="btiSid" />">
      <b>
        ...
        <span style="color:<%= titleColor %>;"><bean:write name="threadMdl" property="btiTitle" /></span>
      </b>
      ...
      <br>
      ■<gsmsg:write key="cmn.contributor" />：<span class="<%=UserUtil.getCSSClassNameNormal(threadMdl.getUserYukoKbn())%>"><bean:write name="threadMdl" property="userName" /></span>
      <br>
