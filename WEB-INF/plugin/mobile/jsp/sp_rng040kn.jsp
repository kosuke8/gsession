...
<%@page import="jp.groupsession.v2.rng.model.RingiChannelDataModel"%>
...
<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="c">
  ...
  <li>
    ...
    <logic:iterate id="channelModel" name="mbhRng040knForm" property="channelList" indexId="idx" type="RingiChannelDataModel">
    <span class="<%=UserUtil.getCSSClassNameNormal(channelModel.getUsrUkoFlg())%>"><bean:write name="channelModel" property="userName"  /></span>
  ...
  <li>
    ...
    <logic:iterate id="confirmChannelModel" name="mbhRng040knForm" property="confirmChannelList" indexId="indx" type="RingiChannelDataModel">
    <span class="<%=UserUtil.getCSSClassNameNormal(confirmChannelModel.getUsrUkoFlg())%>"><bean:write name="confirmChannelModel" property="userName" /></span>
