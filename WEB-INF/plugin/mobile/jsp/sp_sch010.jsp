...
<div class="title_1" align="center">
  <bean:define id="usrUkoFlg" name="mbhSch010Form" property="sch010UserUkoFlg" type="Integer"/>
  <b><div class="font_small <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhSch010Form" property="sch010UserName" /></div></b>
</div>
