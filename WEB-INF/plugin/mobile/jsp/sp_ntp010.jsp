...
<div class="title_1" align="center">
  <bean:define id="usrUkoFlg" name="mbhNtp010Form" property="ntp010UserUkoFlg" type="Integer"/>
  <b><div class="font_small <%=UserUtil.getCSSClassNameNormal(usrUkoFlg)%>"><bean:write name="mbhNtp010Form" property="ntp010UserName" /></div></b>
</div>
