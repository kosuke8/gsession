...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_setting_n1" onClick="buttonPush('doSetting');">
    ...
    <logic:equal name="man420knForm" property="man420UsrImpFlg" value="1">
      ...
      <tr id="usrImportFolder">
        <td class="table_bg_A5B4E1" width="0%" nowrap><span class="text_bb1">
