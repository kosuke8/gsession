    ...
    <td align="left" class="td_type20">
      ...
      <td align="center">
        <html:select property="man290SelectLeftUser" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man290Form" property="man290LeftUserList" type="UsrLabelValueBean">
      ...
      <td>
        <html:select property="man290SelectRightUser" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man290Form" property="man290RightUserList" type="UsrLabelValueBean">
          <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>"><bean:write name="user" property="label"/></html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
