    ...
    <td align="left" class="td_type20">
      ...
      <td align="center">
        <html:select property="man300SelectLeftUser" size="8" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man300Form" property="man300LeftUserList" type="UsrLabelValueBean">
      ...
      <td>
        <html:select property="man300SelectRightUser" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man300Form" property="man300RightUserList" type="UsrLabelValueBean">
          <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>"><bean:write name="user" property="label"/></html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
