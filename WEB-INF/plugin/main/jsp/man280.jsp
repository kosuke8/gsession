    ...
    <td align="left" class="td_type20" width="80%">
      ...
      <td align="center">
        <html:select property="man280SelectLeftAdmin" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man280Form" property="man280LeftAdminList">
      ...
      <td>
        <html:select property="man280SelectRightAdmin" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man280Form" property="man280RightAdminList">
            <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>"><bean:write name="user" property="label"/> </option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
    ...
    <td id="pluginUseMember2" align="left" class="td_type20">
      ...
      <td align="center">
        <html:select property="man280SelectLeftUser" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man280Form" property="man280LeftUserList">
            <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>"><bean:write name="user" property="label"/> </option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
      ...
      <td>
        <html:select property="man280SelectRightUser" size="7" styleClass="select01" multiple="true">
          ...
          <logic:iterate id="user" name="man280Form" property="man280RightUserList">
            <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>"><bean:write name="user" property="label"/> </option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
