      ...
      <logic:equal name="man210Form" property="man210ObjKbn" value="1">
        ...
        <td>
          <html:select property="man210selectUserSid" size="6" multiple="true" styleClass="select01">
            <logic:iterate id="user" name="man210Form" property="man210MbLabelList">
            <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="ukoclass" value="mukouser_option" /></logic:equal>
            <logic:notEqual name="user" property="usrUkoFlg" value="1"><bean:define id="ukoclass" value="" /></logic:notEqual>
            <option value="<bean:write name="user" property="value"/>" class="<bean:write name="ukoclass"/>"><bean:write name="user" property="label"/></option>
            </logic:iterate>
            <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
          </html:select>
        </td>
        ...
        <td align="center">
          <html:select property="man210addUserSid" size="6" multiple="true" styleClass="select01">
            <logic:iterate id="user" name="man210Form" property="man210AdLabelList">
            <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="ukoclass" value="mukouser_option" /></logic:equal>
            <logic:notEqual name="user" property="usrUkoFlg" value="1"><bean:define id="ukoclass" value="" /></logic:notEqual>
            <option value="<bean:write name="user" property="value"/>" class="<bean:write name="ukoclass"/>"><bean:write name="user" property="label"/></option>
            </logic:iterate>
