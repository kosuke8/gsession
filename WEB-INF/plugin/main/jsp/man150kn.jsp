    ...
    <td valign="middle" align="left" class="td_wt2" width="100%" colspan="1">
      ...
      <td align="left" class="td_type1" width="100%">
        ...
        <logic:equal  name="man150knForm" property="man150LicenseKbn" value="0">
          ...
          <tr>
          <td align="right">
            <span class="text_bb1"><gsmsg:write key="main.man150kn.5" /></span>
          </td>
          <td style="border:1px;border-bottom-style:solid;border-color:#cccccc;">
             <span class="text_gray"><gsmsg:write key="main.man002.101" /></span>
          </td>
          </tr>
        </logic:equal>
      ...
      <tr>
      <td><span class="text_base4"><gsmsg:write key="main.man150kn.4" /></span></td>
      </tr>
