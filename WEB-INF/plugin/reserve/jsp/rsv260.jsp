      ...
      <td>
        ...
        <td align="center">
          <html:select property="rsv260SelectedLeft" size="5" styleClass="select01" multiple="true">
            ...
            <logic:iterate id="user" name="rsv260Form" property="rsv260AdmUser" type="UsrLabelValueBean">
        ...
        <td align="center">
          <html:select property="rsv260SelectedRight" size="5" styleClass="select01" multiple="true">
            ...
            <logic:iterate id="user" name="rsv260Form" property="rsv260NotAdmUser" type="UsrLabelValueBean">
                <html:option value="<%=user.getValue() %>" styleClass="<%= user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
            </logic:iterate>
            </logic:notEmpty>
          </html:select>
