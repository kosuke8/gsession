...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <!-- 期間 -->
    <% String periodRow = ""; %>
    <logic:equal name="rsv280knForm" property="rsv280PeriodKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPERIODKBN_ADM) %>">
    <% periodRow = " rowspan=\"2\""; %>
    </logic:equal>

    <tr>
    <td valign="middle" align="left" class="table_bg_A5B4E1" width="20%" nowrap id="rsvPeriodArea1"<%= periodRow %>>
       <span class="text_bb1"><gsmsg:write key="cmn.period" /></span>
    </td>
       <td valign="middle" align="left" class="td_wt">
      <logic:equal name="rsv280knForm" property="rsv280PeriodKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPERIODKBN_ADM) %>"><span class="text_base6_2"><gsmsg:write key="cmn.set.the.admin" /></span></logic:equal>
      <logic:equal name="rsv280knForm" property="rsv280PeriodKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPERIODKBN_USER) %>"><span class="text_base6_2"><gsmsg:write key="cmn.set.eachuser" /></span></logic:equal>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <bean:write name="rsv280knForm" property="rsv280knDefFrHDsp" /><gsmsg:write key="cmn.hour.input" />
    ...
    <br>
      ...
      <span class="text_base2">
      <bean:write name="rsv280knForm" property="rsv280knDefToHDsp" /><gsmsg:write key="cmn.hour.input" />
    ...
    <!-- 編集権限 -->
    <% String editRow = ""; %>
    <logic:equal name="rsv280knForm" property="rsv280EditKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIEDITKBN_ADM) %>">
    <% editRow = " rowspan=\"2\""; %>
    </logic:equal>
    ...
    <!-- 公開区分 -->
    <% String publicRow = ""; %>
    <logic:equal name="rsv280knForm" property="rsv280PublicKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPUBLICKBN_ADM) %>">
    <% publicRow = " rowspan=\"2\""; %>
    </logic:equal>

    <tr>
    <td valign="middle" align="left" class="table_bg_A5B4E1" width="20%" nowrap id="rsvPublicArea1"<%= publicRow %>>
      <span class="text_bb1"><gsmsg:write key="cmn.edit.permissions" /></span>
    </td>
    <td valign="middle" align="left" class="td_wt">
      <logic:equal name="rsv280knForm" property="rsv280PublicKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPUBLICKBN_ADM) %>"><span class="text_base6_2"><gsmsg:write key="cmn.set.the.admin" /></span></logic:equal>
      <logic:equal name="rsv280knForm" property="rsv280PublicKbn" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.RAC_INIPUBLICKBN_USER) %>"><span class="text_base6_2"><gsmsg:write key="cmn.set.eachuser" /></span></logic:equal>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt" id="rsvPublicArea2">
      <span class="text_base2">
      <logic:equal name="rsv280knForm" property="rsv280Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.EDIT_AUTH_NONE) %>" ><gsmsg:write key="cmn.public" /></logic:equal>
      <logic:equal name="rsv280knForm" property="rsv280Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.EDIT_AUTH_PER_AND_ADU) %>" ><gsmsg:write key="reserve.175" /></logic:equal>
      <logic:equal name="rsv280knForm" property="rsv280Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.EDIT_AUTH_GRP_AND_ADU) %>" ><gsmsg:write key="reserve.176" /></logic:equal>
    </span>
    </td>
    </tr>
    </logic:equal>
