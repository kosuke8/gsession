...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base2">
      <logic:equal name="rsv230knForm" property="rsv230Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_ALL) %>" ><gsmsg:write key="cmn.public" /></logic:equal>
      <logic:equal name="rsv230knForm" property="rsv230Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_PLANS) %>" ><gsmsg:write key="reserve.175" /></logic:equal>
      <logic:equal name="rsv230knForm" property="rsv230Public" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_GROUP) %>" ><gsmsg:write key="reserve.176" /></logic:equal>
    </span>
    </td>
    </tr>
    </logic:equal>
