...
<logic:notEmpty name="rsv060knForm" property="rsv060memberSid">
<logic:iterate id="usid" name="rsv060knForm" property="rsv060memberSid">
  <input type="hidden" name="rsv060memberSid" value="<bean:write name="usid" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="rsv060knForm" property="rsv060memberSidRead">
<logic:iterate id="usid" name="rsv060knForm" property="rsv060memberSidRead">
  <input type="hidden" name="rsv060memberSidRead" value="<bean:write name="usid" />">
</logic:iterate>
</logic:notEmpty>
</logic:equal>

<logic:notEmpty name="rsv060knForm" property="rsvIkkatuTorokuKey" scope="request">
  <logic:iterate id="key" name="rsv060knForm" property="rsvIkkatuTorokuKey" scope="request">
...
<input type="hidden" name="helpPrm" value="<bean:write name="rsv060knForm" property="rsv060ProcMode" />">
      ...
      <logic:notEmpty name="rsv060knForm" property="rsv060knKanriUser" scope="request">
        <logic:iterate id="usr" name="rsv060knForm" property="rsv060knKanriUser" scope="request" indexId="idx">
          ...
          <bean:define id="styleStr" value=""/>
            <logic:equal name="usr" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser"; %>
            </logic:equal>
          <span class="<%=styleStr %>" ><bean:write name="usr" property="label"/><br></span>
    ...
    <td align="left" class="td_type1">
      ...
      <td align="left" class="td_type1">
        ...
        <logic:iterate id="memNameEdit" name="rsv060knForm" property="rsv060knEditUser">
          ...
          <bean:define id="styleStr" value="text_base"/>
          <bean:define id="selectValue" name="memNameEdit" property="value"/>
            <logic:equal name="memNameEdit" property="usrUkoFlg" value="1">
              <% styleStr = "text_base mukouser"; %>
            </logic:equal>
          <span class="<%=styleStr %>" ><bean:write name="memNameEdit" property="label"/><br></span>
      ...
      <td align="left" class="td_type1">
        ...
        <logic:iterate id="memNameRead" name="rsv060knForm" property="rsv060knReadUser">
          ...
          <bean:define id="styleStr" value="text_base"/>
          <bean:define id="selectValue" name="memNameRead" property="value"/>
            <logic:equal name="memNameRead" property="usrUkoFlg" value="1">
              <% styleStr = "text_base mukouser"; %>
            </logic:equal>
          <span class="<%=styleStr %>" ><bean:write name="memNameRead" property="label"/><br></span>
