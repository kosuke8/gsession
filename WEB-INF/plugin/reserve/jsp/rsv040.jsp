...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <tr>
    <td align="right">
      <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onclick="buttonPush('rsv040_back_to_menu');">
    </td>
    </tr>
    </table>
    ...
    <td align="left">
      ...
      <dl class="decorate_textbox1">
      <dt><a href="#" onclick="buttonPush('rsv040_sisetu_settei');"><span class="text_link"><gsmsg:write key="reserve.rsv050.1" /></span></a></dt>
      <dd><div class="text"><li><gsmsg:write key="reserve.rsv040.10" /></div></dd>
      </dl>
