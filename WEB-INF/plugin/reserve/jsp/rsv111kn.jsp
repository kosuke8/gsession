...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%">
      ...
      <tr>
        ...
        <logic:equal name="rsv111knForm" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
          ...
          <span class="<%=styleStr %>" ><bean:write name="rsv111knForm" property="rsv110Torokusya" /></span>
        </logic:equal>
        <logic:equal name="rsv111knForm" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
          <span class="<%=styleStr %>" ><del><bean:write name="rsv111knForm" property="rsv110Torokusya" /></del></span>
        </logic:equal>
        </td>
        </tr>
        <%-- 更新者 --%>
        ...
        <logic:equal name="rsv111knForm" property="rsv110EditUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
          <span class="<%=styleStr %>" ><del><bean:write name="rsv111knForm" property="rsv110Koshinsya" /></del></span>
        </logic:equal>
        </td>
      </tr>
      </logic:notEqual>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.update.user" /></span></td>
    ...
    <td align="left" class="td_type1" width="80%">
      ...
      <td width="60%" nowrap>
      <span class="text_base_rsv">
      <logic:equal name="rsv111knForm" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_NOSET) %>">未設定</label></logic:equal>
      <logic:equal name="rsv111knForm" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KAIGI) %>">会議</label></logic:equal>
      <logic:equal name="rsv111knForm" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KENSYU) %>">研修</label></logic:equal>
      <logic:equal name="rsv111knForm" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_OTHER) %>">その他</label></logic:equal>
      </span>
      </td>
      </tr>
      </table>
