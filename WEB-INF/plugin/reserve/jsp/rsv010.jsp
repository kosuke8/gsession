...
<td width="100%" align="center">
  <table width="100%" class="tl0 rsv_top_frame">
  <tr><td colspan="8"><%@ include file="/WEB-INF/plugin/common/jsp/header001.jsp" %></td></tr>
  <tr>
  <td colspan="8">
                ...
                <logic:iterate id="yrk" name="day" property="yoyakuList" indexId="idx">
                  ...
                  <logic:equal name="yrk" property="public" value="<%= String.valueOf(dspPlans) %>">
                    <span class="sc_nolink">
                      <logic:notEmpty name="yrk" property="yrkRiyoDateStr"><font size="-2"><bean:write name="yrk" property="yrkRiyoDateStr" /></font><br></logic:notEmpty>
                      <logic:notEmpty name="yrk" property="rsyMok"><%= mokApprStatus[2] %><bean:write name="yrk" property="rsyMok" /></logic:notEmpty>
                      <logic:notEmpty name="yrk" property="rsyMok">
                        <logic:notEmpty name="yrk" property="yrkName">&nbsp;/&nbsp;</logic:notEmpty>
                      </logic:notEmpty>
