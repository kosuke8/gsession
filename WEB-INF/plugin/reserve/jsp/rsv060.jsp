    ...
    <td align="left" class="td_wt">
      ...
      <td width="100%">
        ...
        <html:select property="rsv060SelectedLeft" size="5" styleClass="select01" multiple="true">
          ...
          <logic:iterate name="rsv060Form" property="rsv060AdmUser" id="admUserLeft">
          <bean:define id="styleStr" value=""/>
          <bean:define id="selectValue" name="admUserLeft" property="value"/>
            <logic:equal name="admUserLeft" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser_option"; %>
            </logic:equal>
            <html:option styleClass="<%= styleStr %>" value="<%= String.valueOf(selectValue) %>">
              <bean:write name="admUserLeft" property="label"/>
            </html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
        ...
        <html:select property="rsv060SelectedRight" size="5" styleClass="select01" multiple="true">
          ...
          <logic:iterate name="rsv060Form" property="rsv060NotAdmUser" id="notAdmUserRight">
          <bean:define id="styleStr" value=""/>
          <bean:define id="selectValue" name="notAdmUserRight" property="value"/>
            <logic:equal name="notAdmUserRight" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser_option"; %>
            </logic:equal>
            <html:option styleClass="<%= styleStr %>" value="<%= String.valueOf(selectValue) %>">
              <bean:write name="notAdmUserRight" property="label"/>
            </html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
    ...
    <td align="left" class="td_wt" width="80%">
      ...
      <td align="center">
        <html:select property="rsv060SelectLeftUser" size="5" styleClass="select01" multiple="true">
          ...
          <logic:iterate name="rsv060Form" property="rsv060LeftUserList" id="reserveAccess">
          <bean:define id="styleStr" value=""/>
          <bean:define id="selectValue" name="reserveAccess" property="value"/>
            <logic:equal name="reserveAccess" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser_option"; %>
            </logic:equal>
            <html:option styleClass="<%= styleStr %>" value="<%= String.valueOf(selectValue) %>">
              <bean:write name="reserveAccess" property="label"/>
            </html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
      ...
      <td rowspan="3">
        <html:select property="rsv060SelectRightUser" size="13" styleClass="select01" multiple="true">
          ...
          <logic:iterate name="rsv060Form" property="rsv060RightUserList" id="accsesSelectUser">
          <bean:define id="styleStr" value=""/>
          <bean:define id="selectValue" name="accsesSelectUser" property="value"/>
            <logic:equal name="accsesSelectUser" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser_option"; %>
            </logic:equal>
            <html:option styleClass="<%= styleStr %>" value="<%= String.valueOf(selectValue) %>">
              <bean:write name="accsesSelectUser" property="label"/>
            </html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
      ...
      <td align="center">
        <html:select property="rsv060SelectLeftUserRead" size="5" styleClass="select01" multiple="true">
          ...
          <logic:iterate name="rsv060Form" property="rsv060LeftUserListRead" id="viewAccess">
          <bean:define id="styleStr" value=""/>
          <bean:define id="selectValue" name="viewAccess" property="value"/>
            <logic:equal name="viewAccess" property="usrUkoFlg" value="1">
              <% styleStr = "mukouser_option"; %>
            </logic:equal>
            <html:option styleClass="<%= styleStr %>" value="<%= String.valueOf(selectValue) %>">
              <bean:write name="viewAccess" property="label"/>
            </html:option>
          </logic:iterate>
          </logic:notEmpty>
        </html:select>
