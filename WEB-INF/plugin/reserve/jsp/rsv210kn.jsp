...
<html:hidden property="rsv210RsyPublic" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv210knForm" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_ALL) %>"><gsmsg:write key="cmn.public" /></logic:equal>
        <logic:equal name="rsv210knForm" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_PLANS) %>"><gsmsg:write key="reserve.175" /></logic:equal>
        <logic:equal name="rsv210knForm" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_GROUP) %>"><gsmsg:write key="reserve.176" /></logic:equal>
      </span>
    </td>
    </tr>
    ...
    <logic:notEmpty name="rsv210knForm" property="userNameArray" scope="request">
      ...
      <td align="left" class="td_type1">
        <logic:iterate id="usr" name="rsv210knForm" property="userNameArray" scope="request" type="UsrLabelValueBean">
          <span class="text_base_rsv <%=usr.getCSSClassNameNormal()%>">
