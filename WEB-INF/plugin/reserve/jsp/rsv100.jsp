  ...
  <td width="100%">
    ...
    <td class="td_type20" colspan="4">
      ...
      <div class="text_base_rsv">
        ...
        <span style="white-space: nowrap"><html:multibox styleId="public" name="rsv100Form" property="rsv100CsvOutField" value="12" /><label for="public"><gsmsg:write key="cmn.public.kbn" /></label></span><wbr>

        <span class="csvOutFieldHeya" style="white-space: nowrap"><html:multibox styleId="usekbn" name="rsv100Form" property="rsv100CsvOutField" value="13" /><label for="usekbn"><gsmsg:write key="reserve.use.kbn" /></label></span><wbr>
        <span class="csvOutFieldHeyaCar" style="white-space: nowrap"><html:multibox styleId="contact" name="rsv100Form" property="rsv100CsvOutField" value="14" /><label for="contact"><gsmsg:write key="reserve.contact" /></label></span><wbr>
        <span class="csvOutFieldHeya" style="white-space: nowrap"><html:multibox styleId="guide" name="rsv100Form" property="rsv100CsvOutField" value="15" /><label for="guide"><gsmsg:write key="reserve.guide" /></label></span><wbr>
        <span class="csvOutFieldHeya" style="white-space: nowrap"><html:multibox styleId="parknum" name="rsv100Form" property="rsv100CsvOutField" value="16" /><label for="parknum"><gsmsg:write key="reserve.park.num" /></label></span><wbr>
        <span class="csvOutFieldCar" style="white-space: nowrap"><html:multibox styleId="dest" name="rsv100Form" property="rsv100CsvOutField" value="17" /><label for="dest"><gsmsg:write key="reserve.dest" /></label></span><wbr>
        <span class="csvOutFieldHeyaCar" style="white-space: nowrap"><html:multibox styleId="busyo" name="rsv100Form" property="rsv100CsvOutField" value="18" /><label for="busyo"><gsmsg:write key="reserve.busyo" /></label></span><wbr>
        <span class="csvOutFieldHeyaCar" style="white-space: nowrap"><html:multibox styleId="usename" name="rsv100Form" property="rsv100CsvOutField" value="19" /><label for="usename"><%= headName %></label></span><wbr>
        <span class="csvOutFieldHeyaCar" style="white-space: nowrap"><html:multibox styleId="usenum" name="rsv100Form" property="rsv100CsvOutField" value="20" /><label for="usenum"><gsmsg:write key="reserve.use.num" /></label></span><wbr>
  ...
  <td class="td_type_tab">
    ...
    <bean:define id="mod" value="0" />
      <logic:iterate id="list" name="rsv100Form" property="rsv100resultList" indexId="idx" scope="request">
        ...
        <td class="<bean:write name="tblColor" />" align="left" valign="middle" nowrap>
          ...
          <logic:equal name="list" property="usrJKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_TOROKU) %>">
            ...
            <logic:equal name="list" property="usrUkoFlg" value="1"><bean:define id="mukouserClass">mukouser</bean:define></logic:equal>
            <span class="<%=mukouserClass%>"><bean:write name="list" property="rsySeiMei" /><br></span>
          </logic:equal>
          <logic:equal name="list" property="usrJKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_DELETE) %>">
            <del><bean:write name="list" property="rsySeiMei" /></del><br>
          </logic:equal>
        ...
        <td class="<bean:write name="tblColor" />" align="left" valign="middle">
          ...
          <logic:equal name="list" property="public" value="<%= String.valueOf(GSConstReserve.PUBLIC_KBN_PLANS) %>" >
            <span class="nolink_search"><bean:write name="list" property="rsyContent"/></span>
          </logic:equal>
        </td>
        </tr>
      </logic:iterate>
