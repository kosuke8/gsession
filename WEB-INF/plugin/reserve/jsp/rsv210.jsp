...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt">
      ...
      <html:select styleId="rsv210FrHour" property="rsv210SelectedHourFr" onchange="setToTime()">
      ...
      <html:select styleId="rsv210FrMin" property="rsv210SelectedMinuteFr" onchange="setToTime()">
      ...
      <html:select styleId="rsv210ToHour" property="rsv210SelectedHourTo" onchange="setFromTime()">
        <logic:notEmpty name="rsv210Form" property="rsv210HourComboList">
          <html:optionsCollection name="rsv210Form" property="rsv210HourComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>
      ...
      <html:select styleId="rsv210ToMin" property="rsv210SelectedMinuteTo" onchange="setFromTime()">
        <logic:notEmpty name="rsv210Form" property="rsv210MinuteComboList">
          <html:optionsCollection name="rsv210Form" property="rsv210MinuteComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>
      ...
      <span class="text_base">
        ...
        <span class="tooltips">
          <bean:write name="rsv210Form" property="rsv210AmFrHour" format="00" />:<bean:write name="rsv210Form" property="rsv210AmFrMin" format="00" />～<bean:write name="rsv210Form" property="rsv210AmToHour" format="00" />:<bean:write name="rsv210Form" property="rsv210AmToMin" format="00" />
        </span>
        </a>
      </span>
      &nbsp;&nbsp;
      <span class="text_base"><a href="javaScript:void(0);" onclick="setPmTime();"><gsmsg:write key="cmn.pm" />
        <span class="tooltips">
          <bean:write name="rsv210Form" property="rsv210PmFrHour" format="00" />:<bean:write name="rsv210Form" property="rsv210PmFrMin" format="00" />～<bean:write name="rsv210Form" property="rsv210PmToHour" format="00" />:<bean:write name="rsv210Form" property="rsv210PmToMin" format="00" />
        </span>
        </a>
      </span>
      &nbsp;&nbsp;
      <span class="text_base"><a href="javaScript:void(0);" onclick="setAllTime();"><gsmsg:write key="cmn.allday" />
        <span class="tooltips">
          <bean:write name="rsv210Form" property="rsv210AllDayFrHour" format="00" />:<bean:write name="rsv210Form" property="rsv210AllDayFrMin" format="00" />～<bean:write name="rsv210Form" property="rsv210AllDayToHour" format="00" />:<bean:write name="rsv210Form" property="rsv210AllDayToMin" format="00" />
        </span>
        </a>
      </span>
      </div>
    ...
    <td align="left" class="td_type1">
      ...
      <textarea styleClass="text_base_rsv" name="rsv210Naiyo" style="width:489px;" rows="6" onkeyup="showLengthStr(value, <%= maxLengthNaiyo %>, 'inputlength');" id="inputstr">
<bean:write name="rsv210Form" property="rsv210Naiyo" /></textarea>
      <br>
    ...
    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.public.kbn" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></td>
    <td align="left" class="td_type1">
      <html:radio styleId="rsv210RsyPublic1" name="rsv210Form" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_ALL) %>" /><label for="rsv210RsyPublic1"><gsmsg:write key="cmn.public" /></label>&nbsp;
      <html:radio styleId="rsv210RsyPublic2" name="rsv210Form" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_PLANS) %>" /><label for="rsv210RsyPublic2"><gsmsg:write key="reserve.175" /></label>&nbsp;
      <html:radio styleId="rsv210RsyPublic3" name="rsv210Form" property="rsv210RsyPublic" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_GROUP) %>" /><label for="rsv210RsyPublic3"><gsmsg:write key="reserve.176" /></label>
    </td>
    </tr>
        ...
        <td width="100%" align="left" class="tbl_in_tbl">
          ...
          <td align="center">
            ...
            <logic:notEmpty name="rsv210Form" property="rsv210SelectUsrLabel" scope="request">
              <logic:iterate id="urBean" name="rsv210Form" property="rsv210SelectUsrLabel" scope="request" type="CmnUsrmInfModel">
          ...
          <td>
            ...
            <logic:notEmpty name="rsv210Form" property="rsv210BelongLabel" scope="request">
              <logic:iterate id="urBean" name="rsv210Form" property="rsv210BelongLabel" scope="request" type="CmnUsrmInfModel">
                <option class="<%=UserUtil.getCSSClassNameOption(urBean.getUsrUkoFlg()) %>" value="<bean:write name="urBean" property="usrSid" scope="page"/>"><bean:write name="urBean" property="usiSei" scope="page"/>　<bean:write name="urBean" property="usiMei" scope="page"/></option>
              </logic:iterate>
            </logic:notEmpty>
            <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
