...
<%-- 公開区分 --%>
    ...
    <td valign="middle" align="left" class="td_wt">
      <html:radio name="rsv230Form" property="rsv230Public" styleId="rsv230Public0" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_ALL) %>" /><span class="text_base"><label for="rsv230Public0"><gsmsg:write key="cmn.public" /></label></span>&nbsp;
      <html:radio name="rsv230Form" property="rsv230Public" styleId="rsv230Public1" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_PLANS) %>" /><span class="text_base"><label for="rsv230Public1"><gsmsg:write key="reserve.175" /></label>&nbsp;</span>
      <html:radio name="rsv230Form" property="rsv230Public" styleId="rsv230Public2" value="<%= String.valueOf(jp.groupsession.v2.rsv.GSConstReserve.PUBLIC_KBN_GROUP) %>" /><span class="text_base"><label for="rsv230Public2"><gsmsg:write key="reserve.176" /></label>&nbsp;</span>
    </td>
    </tr>
    </logic:equal>
