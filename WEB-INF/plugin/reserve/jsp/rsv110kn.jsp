...
<title>[GroupSession] <gsmsg:write key="cmn.reserve" />
  <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_SINKI) %>"> [ <gsmsg:write key="reserve.rsv110kn.1" /> ]</logic:equal>
  <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_EDIT) %>">[ <gsmsg:write key="reserve.rsv110kn.2" /> ]</logic:equal>
</title>
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_white_bg_text">
      <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_SINKI) %>"> [ <gsmsg:write key="reserve.rsv110kn.1" /> ]</logic:equal>
      <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_EDIT) %>">[ <gsmsg:write key="reserve.rsv110kn.2" /> ]</logic:equal>
      <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_COPY_ADD) %>"> [ <gsmsg:write key="reserve.rsv110kn.1" /> ]</logic:equal>
    </td>
  ...
  <tr><td>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv110knForm" property="rsv110Prop2Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110Prop2Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv110knForm" property="rsv110Prop3Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110Prop3Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv110knForm" property="rsv110Prop7Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110Prop7Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
  ...
  <td>
    ...
    <tr>
      ...
      <td align="left" class="td_type1" width="80%">
        <table class="tl0" width="99%">
          ...
          <tr>
          <td>
          <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_EDIT) %>" >
            <span class="text_base_rsv"><gsmsg:write key="reserve.178"/>：</span>
          </logic:equal>
          <bean:define id="styleStr" value="text_base_rsv"/>
          <logic:equal name="rsv110knForm" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
              <logic:equal name="rsv110knForm" property="rsv110AddUsrUkoFlg" value="1">
                <% styleStr = "text_base_rsv mukouser"; %>
              </logic:equal>
            <span class="<%=styleStr %>" ><bean:write name="rsv110knForm" property="rsv110Torokusya" /></span>
          </logic:equal>
          <logic:equal name="rsv110knForm" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
            <span class="<%=styleStr %>" ><del><bean:write name="rsv110knForm" property="rsv110Torokusya" /></del></span>
          </logic:equal>
          </td>
          </tr>
          <%-- 最終更新者 --%>
          ...
          <bean:define id="styleStr" value="text_base_rsv"/>
          <logic:equal name="rsv110knForm" property="rsv110EditUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
              <logic:equal name="rsv110knForm" property="rsv110EditUsrUkoFlg" value="1">
                <% styleStr = "text_base_rsv mukouser"; %>
              </logic:equal>
            <span class="<%=styleStr %>" ><bean:write name="rsv110knForm" property="rsv110Koshinsya" /></span>
          </logic:equal>
          <logic:equal name="rsv110knForm" property="rsv110EditUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
            <span class="<%=styleStr %>" ><del><bean:write name="rsv110knForm" property="rsv110Koshinsya" /></del></span>
          </logic:equal>
          </td>
          </tr>
          </logic:equal>
    ...
    <logic:equal name="rsv110knForm" property="rsv110SisetuKbn" value="<%= String.valueOf(GSConstReserve.RSK_KBN_CAR) %>">
        <logic:equal name="rsv110knForm" property="rsvPrintUseKbn" value="<%= String.valueOf(GSConstReserve.RSV_PRINT_USE_YES) %>">
        <tr>
    ...
    <logic:equal name="rsv110knForm" property="rsv110SisetuKbn" value="<%= String.valueOf(GSConstReserve.RSK_KBN_HEYA) %>">

       <tr>
       <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="reserve.use.kbn" /></span></td>
       <td align="left" class="td_type1"><span class="text_base_rsv">
      <logic:equal name="rsv110knForm" property="rsv110UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_NOSET) %>"><gsmsg:write key="reserve.use.kbn.noset" /></logic:equal>
      <logic:equal name="rsv110knForm" property="rsv110UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KAIGI) %>"><gsmsg:write key="reserve.use.kbn.meeting" /></logic:equal>
      <logic:equal name="rsv110knForm" property="rsv110UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KENSYU) %>"><gsmsg:write key="reserve.use.kbn.training" /></logic:equal>
      <logic:equal name="rsv110knForm" property="rsv110UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_OTHER) %>"><gsmsg:write key="reserve.use.kbn.other" /></logic:equal>
       </span></td>
       </tr>
       </logic:equal>
   ...
   <% } %>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv110knForm" property="rsv110RsyEdit" value="<%= String.valueOf(GSConstReserve.EDIT_AUTH_NONE) %>"><gsmsg:write key="cmn.nolimit" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110RsyEdit" value="<%= String.valueOf(GSConstReserve.EDIT_AUTH_PER_AND_ADU) %>"><gsmsg:write key="cmn.only.principal.or.registant" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110RsyEdit" value="<%= String.valueOf(GSConstReserve.EDIT_AUTH_GRP_AND_ADU) %>"><gsmsg:write key="cmn.only.affiliation.group.membership" /></logic:equal>
      </span>
    </td>
    </tr>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv110knForm" property="rsv110Public" value="<%= String.valueOf(GSConstReserve.PUBLIC_KBN_ALL) %>"><gsmsg:write key="cmn.public" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110Public" value="<%= String.valueOf(GSConstReserve.PUBLIC_KBN_PLANS) %>"><gsmsg:write key="reserve.175" /></logic:equal>
        <logic:equal name="rsv110knForm" property="rsv110Public" value="<%= String.valueOf(GSConstReserve.PUBLIC_KBN_GROUP) %>"><gsmsg:write key="reserve.176" /></logic:equal>
      </span>
    </td>
    </tr>
   ...
   %>
    ...
    <logic:equal name="rsv110knForm" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_EDIT) %>">
      <logic:equal name="rsv110knForm" property="rsv110EditAuth" value="true">
        ...
        <td align="left" class="td_type1">
          <span class="text_base_rsv">
            <logic:equal name="rsv110knForm" property="rsv110ScdReflection" value="<%= String.valueOf(GSConstReserve.SCD_REFLECTION_OK) %>" ><gsmsg:write key="reserve.86" /></logic:equal>
            <logic:equal name="rsv110knForm" property="rsv110ScdReflection" value="<%= String.valueOf(GSConstReserve.SCD_REFLECTION_NO) %>" ><gsmsg:write key="reserve.87" /></logic:equal>
          </span>
        </td>
        </tr>
        </logic:greaterThan>
    ...
    <logic:notEmpty name="rsv110knForm" property="rsvSchUserNameArray" scope="request">
      ...
      <td align="left" class="td_type1">
        ...
        <logic:iterate id="usrName" name="rsv110knForm" property="rsvSchUserNameArray" scope="request" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
          <span class="text_base_rsv <%=usrName.getCSSClassNameNormal()%>">
