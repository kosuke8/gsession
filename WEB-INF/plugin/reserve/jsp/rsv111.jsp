...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv111Form" property="rsv110Prop2Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv111Form" property="rsv110Prop2Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv111Form" property="rsv110Prop3Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv111Form" property="rsv110Prop3Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
    ...
    <td align="left" class="td_type1">
      <span class="text_base_rsv">
        <logic:equal name="rsv111Form" property="rsv110Prop7Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_KA) %>"><gsmsg:write key="cmn.accepted" /></logic:equal>
        <logic:equal name="rsv111Form" property="rsv110Prop7Value" value="<%= String.valueOf(GSConstReserve.PROP_KBN_HUKA) %>"><gsmsg:write key="cmn.not" /></logic:equal>
      </span>
    </td>
    </tr>
    </logic:notEmpty>
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%">
      ...
      <bean:define id="styleStr" value="text_base_rsv"/>
        <logic:equal name="rsv111Form" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
          ...
          <span class="<%=styleStr %>" ><bean:write name="rsv111Form" property="rsv110Torokusya" /></span>
        </logic:equal>
        <logic:equal name="rsv111Form" property="rsv110AddUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
          <span class="<%=styleStr %>" ><del><bean:write name="rsv111Form" property="rsv110Torokusya" /></del></span>
        </logic:equal>
      </td>
      ...
      <tr>
        ...
        <bean:define id="styleStr" value="text_base_rsv"/>
          <logic:equal name="rsv111Form" property="rsv110EditUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
            ...
            <span class="<%=styleStr %>" ><bean:write name="rsv111Form" property="rsv110Koshinsya" /></span>
          </logic:equal>
          <logic:equal name="rsv111Form" property="rsv110EditUsrJKbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
            <span class="<%=styleStr %>" ><del><bean:write name="rsv111Form" property="rsv110Koshinsya" /></del></span>
          </logic:equal>
        </td>
        <td width="40%" align="left" nowrap>
        <span class="text_base"><bean:write name="rsv111Form" property="rsv110EditDate"/></span>
        </td>
      </td>
      </tr>
      </logic:notEqual>
    ...
    <tr>
    <td colspan="2" class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="reserve.72" /></span><logic:equal name="rsv111Form" property="rsv110EditAuth" value="true"><logic:notEqual name="rsv111Form" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_POPUP) %>"><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></logic:notEqual></logic:equal></td>
    <td align="left" class="td_type1">
    ...
    <td align="left" class="td_type1" width="80%">
      ...
      <td width="60%" nowrap>
      <span class="text_base_rsv">
      <html:radio name="rsv111Form" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_NOSET) %>" styleId="rsyUkbnNoset"><label for="rsyUkbnNoset">未設定</label></html:radio>&nbsp;
      <html:radio name="rsv111Form" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KAIGI) %>" styleId="rsyUkbnKaigi"><label for="rsyUkbnKaigi">会議</label></html:radio>&nbsp;
      <html:radio name="rsv111Form" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_KENSYU) %>" styleId="rsyUkbnKensyu"><label for="rsyUkbnKensyu">研修</label></html:radio>&nbsp;
      <html:radio name="rsv111Form" property="rsv111UseKbn" value="<%= String.valueOf(GSConstReserve.RSY_USE_KBN_OTHER) %>" styleId="rsyUkbnOther"><label for="rsyUkbnOther">その他</label></html:radio>
      </span>
      </td>
      </tr>
      </table>
    ...
    <td align="left" class="td_wt">
      ...
      <td colspan="1" rowspan="2" align="left" width="80%" nowrap>
        ...
        <tr>
        <th class="td_type9"><html:checkbox name="rsv111Form" property="rsv111RsrDweek1" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type1"><html:checkbox name="rsv111Form" property="rsv111RsrDweek2" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type1"><html:checkbox name="rsv111Form" property="rsv111RsrDweek3" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type1"><html:checkbox name="rsv111Form" property="rsv111RsrDweek4" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type1"><html:checkbox name="rsv111Form" property="rsv111RsrDweek5" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type1"><html:checkbox name="rsv111Form" property="rsv111RsrDweek6" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        <th class="td_type8"><html:checkbox name="rsv111Form" property="rsv111RsrDweek7" value="<%= String.valueOf(GSConstReserve.COMBO_DEFAULT_ON_VALUE) %>" /></th>
        </tr>
    ...
    <td align="left" class="td_wt">
      ...
      <html:select property="rsv111RsrDateYearFr" styleId="fromYear" onchange="setToDay();">
      ...
      <html:select property="rsv111RsrDateMonthFr" styleId="fromMonth" onchange="setToDay();">
        <logic:notEmpty name="rsv111Form" property="rsv110MonthComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110MonthComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>

      <html:select property="rsv111RsrDateDayFr" styleId="fromDay" onchange="setToDay();">
      ...
      <input type="button" value="Cal" onclick="wrtCalendarByBtn(this.form.fromDay, this.form.fromMonth, this.form.fromYear, 'rsv111_1')" onfocus="setToDay();" class="calendar_btn", id="rsv111_1">
    ...
    <td align="left" class="td_wt">
      ...
      <html:select property="rsv111RsrDateYearTo" styleId="toYear" onchange="setFromDay();">
        <logic:notEmpty name="rsv111Form" property="rsv110YearComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110YearComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>

      <html:select property="rsv111RsrDateMonthTo" styleId="toMonth" onchange="setFromDay();">
        <logic:notEmpty name="rsv111Form" property="rsv110MonthComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110MonthComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>

      <html:select property="rsv111RsrDateDayTo" styleId="toDay" onchange="setFromDay();">
        <logic:notEmpty name="rsv111Form" property="rsv110DayComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110DayComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>

      <input type="button" value="Cal" onclick="wrtCalendarByBtn(this.form.toDay, this.form.toMonth, this.form.toYear, 'rsv111_2')" onfocus="setFromDay();" class="calendar_btn", id="rsv111_2">
    ...
    <td align="left" class="td_wt">
      ...
      <html:select styleId="rsv111FrHour" property="rsv111RsrTimeHourFr" onchange="setToTime()">
      ...
      <html:select styleId="rsv111FrMin" property="rsv111RsrTimeMinuteFr" onchange="setToTime()">
      ...
      <html:select styleId="rsv111ToHour" property="rsv111RsrTimeHourTo" onchange="setFromTime()">
        <logic:notEmpty name="rsv111Form" property="rsv110HourComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110HourComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>
      ...
      <html:select styleId="rsv111ToMin" property="rsv111RsrTimeMinuteTo" onchange="setFromTime()">
        <logic:notEmpty name="rsv111Form" property="rsv110MinuteComboList">
          <html:optionsCollection name="rsv111Form" property="rsv110MinuteComboList" value="value" label="label" />
        </logic:notEmpty>
      </html:select>
    ...
    <% if (editSchFlg) { %>
        ...
        <td align="left" class="td_type1">
          <html:radio styleId="refOk" name="rsv111Form" property="rsv111ScdReflection" value="<%= String.valueOf(GSConstReserve.SCD_REFLECTION_OK) %>" onclick="rsvSchDisabled();" /><label for="refOk"><gsmsg:write key="reserve.86" /></label>&nbsp;
          <html:radio styleId="refNo" name="rsv111Form" property="rsv111ScdReflection" value="<%= String.valueOf(GSConstReserve.SCD_REFLECTION_NO) %>" onclick="rsvSchDisabled();" /><label for="refNo"><gsmsg:write key="reserve.87" /></label>
        </td>
        </tr>
    <% } %>
    ...
    <logic:equal name="rsv111Form" property="schedulePluginKbn" value="<%= String.valueOf(GSConst.PLUGIN_USE) %>">
      ...
      <td align="left" class="td_type1">
        ...
        <html:radio property="rsv111SchKbn" value="<%= String.valueOf(GSConstReserve.RSV_SCHKBN_USER) %>" styleId="rsvSchKbn0" onclick="rsvSchChange();" /><label for="rsvSchKbn0"><span class="text_base"><gsmsg:write key="cmn.user" /></span></label>
        <html:radio property="rsv111SchKbn" value="<%= String.valueOf(GSConstReserve.RSV_SCHKBN_GROUP) %>" styleId="rsvSchKbn1" onclick="rsvSchChange();" /><label for="rsvSchKbn1"><span class="text_base"><gsmsg:write key="cmn.group" /></span></label>
        <br>
        ...
        <td width="100%" align="left" class="tbl_in_tbl">
          ...
          <td width="40%" align="left">
            ...
            <br><input type="checkbox" name="rsv111SelectUsersKbn" value="<%= String.valueOf(GSConstReserve.SELECT_ON) %>" id="select_user" onclick="return selectUsersList();" />
          ...
          <td align="center">
            ...
            <logic:notEmpty name="rsv111Form" property="rsv110SelectUsrLabel" scope="request">
              <logic:iterate id="urBean" name="rsv111Form" property="rsv110SelectUsrLabel" scope="request" type="jp.groupsession.v2.cmn.model.base.CmnUsrmInfModel">
          ...
          <td>
            ...
            <logic:notEmpty name="rsv111Form" property="rsv110BelongLabel" scope="request">
              <logic:iterate id="urBean" name="rsv111Form" property="rsv110BelongLabel" scope="request" type="jp.groupsession.v2.cmn.model.base.CmnUsrmInfModel">
                <option class="<%= UserUtil.getCSSClassNameOption(urBean.getUsrUkoFlg()) %>" value="<bean:write name="urBean" property="usrSid" scope="page"/>"><bean:write name="urBean" property="usiSei" scope="page"/>　<bean:write name="urBean" property="usiMei" scope="page"/></option>
              </logic:iterate>
            </logic:notEmpty>
            <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
  ...
  <td>
    ...
    <td width="50%" align="right">
      <input type="submit" value="OK" class="btn_ok1">
      <logic:equal name="rsv111Form" property="rsv110ProcMode" value="<%= String.valueOf(GSConstReserve.PROC_MODE_EDIT) %>"><input type="button" value="<gsmsg:write key="cmn.delete" />" class="btn_dell_n1" onclick="buttonPush('delete');"></logic:equal>
      <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onclick="buttonPush('back_to_menu');">
    </td>
    </tr>
    </table>
