...
public class Rsv110knBiz extends AbstractReserveBiz {
     ...
     * @throws SQLException SQL実行時例外
     */
    private Rsv110SisetuModel __getYoyakuEditData(Rsv110knParamModel paramMdl) throws SQLException {
     ...
     * @throws SQLException SQL実行時例外
     */
    private Rsv110SisetuModel __getYoyakuEditData(int yoyakuSid) throws SQLException {
     ...
     * @throws SQLException SQL実行時例外
     */
    private Rsv110SisetuModel __getYoyakuAddData(Rsv110knParamModel paramMdl) throws SQLException {
     ...
     * @throws SQLException SQL実行時例外
     */
    private Rsv110SisetuModel __getYoyakuAddData(int yoyakuSid) throws SQLException {

        RsvSisYrkDao yrkDao = new RsvSisYrkDao(con_);
        Rsv110SisetuModel ret = yrkDao.selectYoyakuAddData(yoyakuSid);
