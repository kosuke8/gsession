...
public class Rsv260ParamModel extends Rsv050ParamModel {
    ...
    /** セレクトエリア(左) */
    private List<UsrLabelValueBean> rsv260AdmUser__ = null;
    /** 選択済ユーザ(右) */
    private String[] rsv260SelectedRight__ = null;
    /** セレクトエリア(右) */
    private List<UsrLabelValueBean> rsv260NotAdmUser__ = null;
    /** グループコンボリスト */
     ...
     */
    public List<UsrLabelValueBean> getRsv260AdmUser() {
     ...
     */
    public void setRsv260AdmUser(List<UsrLabelValueBean> rsv260AdmUser) {
     ...
     */
    public List<UsrLabelValueBean> getRsv260NotAdmUser() {
     ...
     */
    public void setRsv260NotAdmUser(List<UsrLabelValueBean> rsv260NotAdmUser) {
