...
public class Rsv210Biz extends AbstractReserveBiz {
    ...
    public void setInitData(Rsv210ParamModel paramMdl, PluginConfig pconfig) throws SQLException {
        ...
        //午前
        paramMdl.setRsv210AmFrHour(confModel.getRacAmTimeFrH());
        paramMdl.setRsv210AmFrMin(confModel.getRacAmTimeFrM());
        paramMdl.setRsv210AmToHour(confModel.getRacAmTimeToH());
        paramMdl.setRsv210AmToMin(confModel.getRacAmTimeToM());

        //午後
        paramMdl.setRsv210PmFrHour(confModel.getRacPmTimeFrH());
        paramMdl.setRsv210PmFrMin(confModel.getRacPmTimeFrM());
        paramMdl.setRsv210PmToHour(confModel.getRacPmTimeToH());
        paramMdl.setRsv210PmToMin(confModel.getRacPmTimeToM());

        //終日
        paramMdl.setRsv210AllDayFrHour(confModel.getRacAllDayTimeFrH());
        paramMdl.setRsv210AllDayFrMin(confModel.getRacAllDayTimeFrM());
        paramMdl.setRsv210AllDayToHour(confModel.getRacAllDayTimeToH());
        paramMdl.setRsv210AllDayToMin(confModel.getRacAllDayTimeToM());
    ...
    private void __setDefHourMin(Rsv210ParamModel paramMdl) throws SQLException {
        ...
        paramMdl.setRsv210RsyPublic(rsvBiz.getInitPublicAuth(con_, conf));
    }
