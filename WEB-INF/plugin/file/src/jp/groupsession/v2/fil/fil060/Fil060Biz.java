...
public class Fil060Biz {
    ...
    public void setInitData(
       ...
       int personalFlg = paramMdl.getFil040PersonalFlg();
        ...
        paramMdl.setFil060AcEditGroupLavel(__getAccessGroupLavle(
                true, parentSid, Integer.parseInt(GSConstFile.ACCESS_KBN_WRITE), personalFlg));
        //アクセス権限 追加・変更・削除 候補一覧
        paramMdl.setFil060AcEditRightLavel(__getAccessEditRightLavle(paramMdl, personalFlg));
        //アクセス権限 フルアクセス一覧
        paramMdl.setFil060AcFullLavel(__getAccessFullLavle(paramMdl));

        //アクセス権限 閲覧 グループコンボ
        paramMdl.setFil060AcReadGroupLavel(__getAccessGroupLavle(
                true, parentSid, Integer.parseInt(GSConstFile.ACCESS_KBN_READ), personalFlg));
        //アクセス権限 閲覧 候補一覧
        paramMdl.setFil060AcReadRightLavel(__getAccessReadRightLavle(paramMdl, personalFlg));
        //アクセス権限 閲覧アクセス一覧
    ...
    private ArrayList<UsrLabelValueBean> __getAccessEditRightLavle(
            Fil060ParamModel paramMdl, int personalFlg) throws SQLException {
     ...
     * 個人キャビネット内の場合、セーブ用フルアクセスユーザを更新する。
     * @param paramMdl Fil060ParamModel
     * @return グループ一覧
     * @throws SQLException SQL実行時例外
     */
    ...
    throws SQLException {
        ...
        //取得するユーザSID・グループSID
        String[] leftFull = paramMdl.getFil060SvAcFull();
        //個人キャビネット内の場合、所有ユーザは常にフルアクセス権限を持つ
