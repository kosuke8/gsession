...
public class Fil010Action extends AbstractFileAction {
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        } else if (cmd.equals("fil010chnageCabinet")) {
            //表示キャビネットの切り替え
            forward = __doChangeDspCabinet(map, thisForm, req, res, con);
        } else {
            //初期表示
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doChangeDspCabinet(ActionMapping map,
                                    Fil010Form form,
                                    HttpServletRequest req,
                                    HttpServletResponse res,
