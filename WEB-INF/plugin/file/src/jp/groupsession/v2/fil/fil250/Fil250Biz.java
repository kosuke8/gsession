...
public class Fil250Biz {
     ...
     * @throws SQLException SQL実行時例外
     */
    protected ArrayList<UsrLabelValueBean> _getCallUserCombo(
            Connection con, Fil250ParamModel paramMdl)
    throws SQLException {

        String[] usrSids = paramMdl.getFil250SvCallUser();
        UserGroupSelectBiz selBiz = new UserGroupSelectBiz();
        return selBiz.getSelectedLabel(usrSids, con);
    }
     ...
     * @throws SQLException SQL実行時例外
     */
    private ArrayList<UsrLabelValueBean> __getCallUserRightCombo(
            Fil250ParamModel paramMdl)
    throws SQLException {
        ...
        if (sltGrp > -1) {
            UserGroupSelectBiz selBiz = new UserGroupSelectBiz();
            return selBiz.getNonSelectLabel(sltGrp, leftAdm, con__);
        }
