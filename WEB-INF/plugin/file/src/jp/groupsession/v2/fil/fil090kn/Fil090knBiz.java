...
public class Fil090knBiz {
    ...
    public void setInitData(
        ...
        List<LabelValueBean> fileLabelList = new ArrayList<LabelValueBean>();
        fileLabelList.add(new LabelValueBean(dirModel.getFdrName(),
                String.valueOf(dirModel.getBinSid())));
        //添付ファイルラベルリストの設定
        paramMdl.setFil090FileLabelList(fileLabelList);
     ...
     * @throws TempFileException 添付ファイルUtil内での例外
     */
    private void __setDirDataForPlural(Fil090knParamModel paramMdl)
    throws SQLException, IOToolsException, IOException, TempFileException {
