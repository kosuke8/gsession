...
public class Fil100Biz {
    ...
    public void setCombo(Fil100ParamModel paramMdl,
                         ...
                         FileAconfModel aconf)
        throws SQLException {

        Fil010Biz biz = new Fil010Biz(reqMdl__);
        int privateFlg = NullDefault.getInt(paramMdl.getFil010DspCabinetKbn(),
    ...
    private Fil100SearchParameterModel __getSvSearchParameter(
        ...
        // キャビネット区分(共有 / 個人)
        int personalFlg = NullDefault.getInt(paramMdl.getFil010DspCabinetKbn(),
                                             GSConstFile.CABINET_KBN_PUBLIC);
        prmModel.setPersonalFlg(personalFlg);
