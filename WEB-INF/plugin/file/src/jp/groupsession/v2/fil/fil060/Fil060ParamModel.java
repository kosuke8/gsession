...
public class Fil060ParamModel extends Fil050ParamModel {
    ...
    private List<UsrLabelValueBean> fil060AcFullLavel__ = null;

    /** ユーザリスト（追加・変更・削除 候補）*/
    private String[] fil060AcEditRight__ = null;
    /** アクセス制限 追加・変更・削除 候補リスト */
    private List< UsrLabelValueBean > fil060AcEditRightLavel__ = null;
    ...
    private List< UsrLabelValueBean > fil060AcReadLavel__ = null;

    /** ユーザリスト（閲覧 候補）*/
    private String[] fil060AcReadRight__ = null;
    /** アクセス制限 閲覧 候補リスト */
    private List< UsrLabelValueBean > fil060AcReadRightLavel__ = null;
     ...
     */
    public List<UsrLabelValueBean> getFil060AcFullLavel() {
     ...
     */
    public void setFil060AcFullLavel(List<UsrLabelValueBean> fil060AcFullLavel) {
     ...
     */
    public List< UsrLabelValueBean > getFil060AcEditRightLavel() {
     ...
     */
    public void setFil060AcEditRightLavel(List< UsrLabelValueBean > fil060AcEditRightLavel) {
     ...
     */
    public List< UsrLabelValueBean > getFil060AcReadLavel() {
     ...
     */
    public void setFil060AcReadLavel(List< UsrLabelValueBean > fil060AcReadLavel) {
     ...
     */
    public List< UsrLabelValueBean > getFil060AcReadRightLavel() {
     ...
     */
    public void setFil060AcReadRightLavel(List< UsrLabelValueBean > fil060AcReadRightLavel) {
