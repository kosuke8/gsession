...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="user" name="fil060Form" property="fil060AcFullLavel" type="UsrLabelValueBean">
      ...
      <logic:iterate id="user" name="fil060Form" property="fil060AcEditRightLavel" type="UsrLabelValueBean">
        <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil060Form" property="fil060AcReadLavel" type="UsrLabelValueBean">
        <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil060Form" property="fil060AcReadRightLavel" type="UsrLabelValueBean">
        <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
