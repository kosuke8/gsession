...
<logic:equal name="fil080knForm" property="fil040PersonalFlg" value="0">
<input type="hidden" name="helpPrm" value="<bean:write name="fil080knForm" property="fil080Mode" />">
</logic:equal>

<logic:equal name="fil080knForm" property="fil040PersonalFlg" value="1">
<input type="hidden" name="helpPrm" value="<bean:write name="fil080knForm" property="fil080Mode" /><bean:write name="fil080knForm" property="fil040PersonalFlg" />">
</logic:equal>
...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:equal name="fil080knForm" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>">
    <tr>
      <td class="td_sub_title" nowrap>
        <span class="text_bb1"><gsmsg:write key="fil.146" /></span>
      </td>
      <td align="left" class="td_sub_detail">
        <bean:write name="fil080knForm" property="fil040PersonalCabOwnerName"/>
      </td>
    </tr>
    </logic:equal>
    ...
    <td align="left" class="td_sub_detail">
      <logic:equal name="fil080knForm" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="fullBean" name="fil080knForm" property="fil080AcFullLavel" scope="request" type="UsrLabelValueBean">
      ...
      <tr>
      <td align="left" class="td_wt">
      <logic:iterate id="readBean" name="fil080knForm" property="fil080AcReadLavel" scope="request" type="UsrLabelValueBean">
