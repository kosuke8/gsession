...
<input type="hidden" name="helpPrm" value="<bean:write name="fil080Form" property="fil080Mode" /><bean:write name="fil080Form" property="fil040PersonalFlg" />">
</logic:equal>
<%-- BODY --%>
...
<% } %>
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="editMdl" name="fil080Form" property="fil080ParentEditList" indexId="idx" length="<%= GSConstFile.MAXCOUNT_PARENT_ACCESS %>" type="FileParentAccessDspModel">
        ...
        <logic:equal name="editMdl" property="grpFlg" value="1">
          ...
          <span class="<%=UserUtil.getCSSClassNameNormal(editMdl.getUsrUkoFlg())%>"><bean:write name="editMdl" property="userName" /></span>
        </div>
      </logic:iterate>
      </logic:notEmpty>
      <div class="hide0">
      ...
      <logic:iterate id="readMdl" name="fil080Form" property="fil080ParentReadList" indexId="idx" length="<%= GSConstFile.MAXCOUNT_PARENT_ACCESS %>" type="FileParentAccessDspModel">
        ...
        <logic:equal name="readMdl" property="grpFlg" value="1">
          <span class="sc_link_g">G</span> </logic:equal>
          <span class="<%=UserUtil.getCSSClassNameNormal(readMdl.getUsrUkoFlg())%>"><bean:write name="readMdl" property="userName" /></span>
        </div>
      </logic:iterate>
      </logic:notEmpty>
      <div class="hide0">
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:equal name="fil080Form" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>">
        ...
        <logic:iterate id="user" name="fil080Form" property="fil080AcFullLavel" type="UsrLabelValueBean">
        ...
        <logic:iterate id="user" name="fil080Form" property="fil080AcEditRightLavel" type="UsrLabelValueBean">
            <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
        </logic:iterate>
        </logic:notEmpty>
        <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil080Form" property="fil080AcReadLavel" type="UsrLabelValueBean">
          <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil080Form" property="fil080AcReadRightLavel" type="UsrLabelValueBean">
          <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
