        ...
        <logic:equal name="fil010Form" property="shortcutCallListFlg" value="1">
          ...
          <p class="file-cabinet-control">
            ...
            <logic:equal name="fil010Form" property="dspPersonalCabFlg" value="<%= String.valueOf(GSConstFile.DSP_PERSONAL_CAB) %>">
              <logic:equal name="fil010Form" property="fil010DspCabinetKbn" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
                <input type="button" value="<gsmsg:write key="fil.142" />" class="btn_change_to_private" onClick="ChangeCabinet();">
              </logic:equal>
              <logic:equal name="fil010Form" property="fil010DspCabinetKbn" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
                <input type="button" value="<gsmsg:write key="fil.141" />" class="btn_change_to_public" onClick="ChangeCabinet();">
              </logic:equal>
            </logic:equal>
          </p>

           <%-- マイキャビネット --%>
           <%-- 個人キャビネットの使用を許可されている場合 --%>
          <logic:equal name="fil010Form" property="personalCabAuthFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>">
            <table id="file-list-table">
            <bean:define id="tdColor" value="" />
            <% String[] tdColors = new String[] {"row-gray", "row-sky"}; %>
            <logic:empty name="fil010Form" property="myCabinet">
             <tr class="row-heading">
              <th width="75%"><gsmsg:write key="fil.140" /></th>
            </tr>
            <tr>
              <td class="td_type1" align="center">
                <input type="button" value="<gsmsg:write key="fil.152" />" class="btn_folder_n1" onClick="CreateMyCabinet();">
              </td>
            </tr>
            </logic:empty>
            ...
            <tr>
              ...
              <logic:notEqual name="myCabinet" property="fcbMark" value="0">
                <img name="iconImage" width="30" src="../file/fil010.do?CMD=tempview&fil010SelectCabinet=<bean:write name="myCabinet" property="fcbSid" />&fil010binSid=<bean:write name="myCabinet" property="fcbMark" />" name="pictImage<bean:write name="myCabinet" property="fcbMark" />" >
              </logic:notEqual>
              </td>
              <td>
                <a href="#" onclick="MoveToRootFolderList(<bean:write name="myCabinet" property="fcbSid" />, <bean:write name="myCabinet" property="rootDirSid" />);"><bean:write name="myCabinet" property="dspfcbName" filter="false" />
              ...
              <logic:notEqual name="myCabinet" property="callIconKbn" value="1">
                &nbsp;
              </logic:notEqual>
                </a>

              <logic:notEmpty name="myCabinet" property="dspBikoString">
                <p><bean:write name="myCabinet" property="dspBikoString" filter="false"/></p>
              </logic:notEmpty>
              <logic:empty name="myCabinet" property="dspBikoString">
                &nbsp;
              </logic:empty>
              </td>
              <td>
              <logic:notEqual name="myCabinet" property="diskUsedWarning" value="1">
                <span class="text_title" ><bean:write name="myCabinet" property="diskUsedString" filter="false" /></span>
              </logic:notEqual>
              <logic:equal name="myCabinet" property="diskUsedWarning" value="1">
                ...
                <span class="text_warning"><bean:write name="myCabinet" property="diskUsedString" filter="false" /></span>
              </logic:equal>
              </td>
              <td><input type="button" value="<gsmsg:write key="fil.18" />" class="btn_base1s" onclick="personalCabinetDetail(<bean:write name="myCabinet" property="fcbSid" />);"></td>
            </tr>
            </logic:notEmpty>
             </table>
             <div style="margin-top: 5px;"></div>
          ...
          <tr class="row-heading">
            <th width="0">&nbsp;</th>
            <th width="75%"><gsmsg:write key="fil.141" /></th>
            <th width="20%"><gsmsg:write key="fil.fil010.1" />/<gsmsg:write key="fil.fil010.2" /></th>
            <th width="5%"><gsmsg:write key="cmn.detail" /></th>
          </tr>
          ...
          <tr class="row-heading">
            <th width="0">&nbsp;</th>
            <th width="75%"><gsmsg:write key="fil.142" /></th>
            <th width="20%"><gsmsg:write key="fil.fil010.1" />/<gsmsg:write key="fil.fil010.2" /></th>
            <th width="5%"><gsmsg:write key="cmn.detail" /></th>
          </tr>
          <logic:iterate id="cabBean" name="fil010Form" property="cabinetList" scope="request" indexId="idx">
          ...
          <tr class="<%= tdColor %>">
            ...
            <td><input type="button" value="<gsmsg:write key="fil.18" />" class="btn_base1s" onclick="personalCabinetDetail(<bean:write name="cabBean" property="fcbSid" />);"></td>
          </tr>
          </logic:iterate>
          </table>
