...
<td>
  ...
  <logic:notEqual name="detailMdl" property="usrJKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_DELETE) %>">
    <span class="text_base <%=UserUtil.getCSSClassNameNormal(detailMdl.getUsrUkoFlg())%>"><bean:write name="detailMdl" property="usrSei" />&nbsp;<bean:write name="detailMdl" property="usrMei" /></span>
  </logic:notEqual>
  </td>
