...
<logic:equal name="fil060knForm" property="fil040PersonalFlg" value="0">
<input type="hidden" name="helpPrm" value="<bean:write name="fil060knForm" property="fil060CmdMode" />">
</logic:equal>

<logic:equal name="fil060knForm" property="fil040PersonalFlg" value="1">
<input type="hidden" name="helpPrm" value="<bean:write name="fil060knForm" property="fil060CmdMode" /><bean:write name="fil060knForm" property="fil040PersonalFlg" />">
</logic:equal>
...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:equal name="fil060knForm" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>">
    <tr>
      <td class="td_sub_title" nowrap>
        <span class="text_bb1"><gsmsg:write key="fil.146" /></span>
      </td>
      <td align="left" class="td_sub_detail">
        <bean:write name="fil060knForm" property="fil040PersonalCabOwnerName"/>
      </td>
    </tr>
    </logic:equal>
    ...
    <td align="left" class="td_sub_detail">
      <logic:equal name="fil060knForm" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="fullBean" name="fil060knForm" property="fil060AcFullLavel" scope="request" type="UsrLabelValueBean">
      ...
      <tr>
      <td align="left" class="td_wt">
      <logic:iterate id="readBean" name="fil060knForm" property="fil060AcReadLavel" scope="request" type="UsrLabelValueBean">
      ...
      <logic:notEqual name="fil060Form" property="fil040PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        <br>
