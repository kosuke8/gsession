...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    &nbsp;<input type="button" value="<gsmsg:write key="fil.fil050.1" />" class="btn_base1s" onClick="MoveToFolderDsp();">
    </td>
    </tr>
    ...
    <span class="text_base <%=UserUtil.getCSSClassNameNormal(fil070Model.getUsrUkoFlg())%>"><bean:write name="fil070Model" property="usrSeiMei" /></span>
    </logic:notEqual>
    ...
    <tr class="<%= td_colors[idx.intValue() % 2] %>">
    <td class="prj_td" align="left"><span class="<%=UserUtil.getCSSClassNameNormal(accessMdl.getUsrUkoFlg())%>"><bean:write name="accessMdl" property="usiSyainNo" /></span></td>
    <td class="prj_td" align="left"><span class="text_base <%=UserUtil.getCSSClassNameNormal(accessMdl.getUsrUkoFlg())%>"><bean:write name="accessMdl" property="usiSei" />&nbsp;<bean:write name="accessMdl" property="usiMei" /></span></td>
    <td class="prj_td" align="left"><span class="text_base <%=UserUtil.getCSSClassNameNormal(accessMdl.getUsrUkoFlg())%>"><bean:write name="accessMdl" property="usiYakusyoku" /></span></td>
    <td class="prj_td" align="center">
