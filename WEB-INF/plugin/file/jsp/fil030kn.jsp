...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:equal name="fil030knForm" property="fil010DspCabinetKbn" value="<%=GSConstFile.DSP_CABINET_PUBLIC %>">
    ...
    <logic:equal name="fil030knForm" property="fil010DspCabinetKbn" value="<%=GSConstFile.DSP_CABINET_PRIVATE %>">
      <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="fil.145" /> ]</td>
    </logic:equal>
    ...
    <td class="td_sub_title" nowrap>
     <logic:equal name="fil030knForm" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
      ...
      <logic:equal name="fil030knForm" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        <span class="text_bb1"><gsmsg:write key="fil.146" /><span class="text_r2">※</span></span>
      </logic:equal>
    </td>
    ...
    <td align="left" class="td_sub_detail">
      ...
      <logic:equal name="fil030knForm" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        <span class="text_base_prj"><gsmsg:write key="cmn.not.permit" /></span>
      </logic:equal>
    </td>
    </logic:equal>
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="fullBean" name="fil030knForm" property="fil030AcFullLavel" scope="request" type="UsrLabelValueBean">
      <span class="text_base <%=fullBean.getCSSClassNameNormal()%>"><bean:write name="fullBean" property="label" /></span><br>
      </logic:iterate>
      </td>
      </tr>
      </logic:notEmpty>
      ...
      <tr>
      <td align="left" class="td_wt">
      <logic:iterate id="readBean" name="fil030knForm" property="fil030AcReadLavel" scope="request" type="UsrLabelValueBean">
      <span class="text_base <%=readBean.getCSSClassNameNormal()%>"><bean:write name="readBean" property="label" /></span><br>
      </logic:iterate>
      </td>
      </tr>
      </logic:notEmpty>
      ...
      <logic:notEqual name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        <br>
    ...
    <logic:iterate id="admBean" name="fil030knForm" property="fil030AdmLavel" scope="request" type="UsrLabelValueBean">
      <span class="text_base <%= admBean.getCSSClassNameNormal() %>"><bean:write name="admBean" property="label" /></span><br>
    </logic:iterate>
    </logic:notEmpty>
    </td>
    </tr>
    ...
    <td class="td_sub_detail" align="left" width="80%">
      ...
      <td width="0%">
        ...
        <logic:equal name="fil030knForm" property="cmnMode" value="0">
          <img width="30" src="../file/fil030kn.do?CMD=getImageFile&fil010DspCabinetKbn=<bean:write name="fil030knForm" property="fil010DspCabinetKbn" />" name="pitctImage" alt="<gsmsg:write key="cmn.photo" />" border="1" onload="">
        </logic:equal>
