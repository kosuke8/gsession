...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td align="left" class="td_sub_detail">
      ...
      <logic:iterate id="callUser" name="fil250knForm" property="fil250callUserCombo" type="UsrLabelValueBean">
        <span class="text_base <%=callUser.getCSSClassNameNormal()%>"><bean:write name="callUser" property="label" /></span><br>
      </logic:iterate>
      </logic:notEmpty>
    </td>
    </tr>
