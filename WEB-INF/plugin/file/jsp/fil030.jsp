...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:equal name="fil030Form" property="fil010DspCabinetKbn" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>">
      <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="fil.144" /> ]</td>
    </logic:equal>
    ...
    <logic:equal name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
        <span class="text_bb1"><gsmsg:write key="fil.13" /><span class="text_r2">※</span></span>
      </logic:equal>
      <logic:equal name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        <span class="text_bb1"><gsmsg:write key="fil.146" /></span>
      </logic:equal>
    </td>
    ...
    <logic:equal name="fil030Form" property="cmnMode" value="2">
      ...
      <tr>
        ...
        <td valign="middle" align="left" class="td_wt" width="100%">        <html:radio name="fil030Form" property="fil030AccessKbn" styleId="okini0" value="0" onclick="showOrHide();"/>
      ...
      <tr>
        <td valign="middle" align="left" class="td_sub_title" width="0%" nowrap>
          <span class="text_bb1"><gsmsg:write key="fil.153" /></span><span class="text_r2">※</span>
        </td>
        ...
        <span class="text_base7"><label for="okini0"><gsmsg:write key="cmn.not.permit" /></label></span>&nbsp;
        <html:radio name="fil030Form" property="fil030AccessKbn" styleId="okini1" value="1" onclick="showOrHide();"/>
        <span class="text_base7"><label for="okini1"><gsmsg:write key="cmn.permit" /></label>&nbsp;</span>
      </logic:equal>
    ...
    <div id="show0">
      ...
      <logic:iterate id="user" name="fil030Form" property="fil030AcFullLavel" type="UsrLabelValueBean">
      ...
      <logic:iterate id="user" name="fil030Form" property="fil030AcRightLavel" type="UsrLabelValueBean">
        <html:option value="<%= user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil030Form" property="fil030AcReadLavel" type="UsrLabelValueBean">
        <html:option value="<%= user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:equal name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
        ...
        <td width="40%" align="left">
        <input class="btn_group_n1" value="<gsmsg:write key="cmn.sel.all.group" />" onclick="return openAllGroup_setDisable(this.form.fil030AcSltGroup, 'fil030AcSltGroup', '<bean:write name="fil030Form" property="fil030AcSltGroup" />', '0', 'changeGrp', 'fil030SvAcRead', '-1', '1', '0', '0', '0', 'ownerSid', '0', '0')" type="button"><br>
        <html:select name="fil030Form" property="fil030AcSltGroup" styleClass="select01" onchange="return buttonPush('changeGrp');" style="width: 150px;">
        <logic:notEmpty name="fil030Form" property="fil030AcGroupLavel">
        <html:optionsCollection name="fil030Form" property="fil030AcGroupLavel" value="value" label="label" />
        </logic:notEmpty>
        ...
        <tr>
        <td align="center">
        <html:select name="fil030Form" property="fil030AcRead" size="13" multiple="true" styleClass="select01" style="width:220px;">
        <logic:notEmpty name="fil030Form" property="fil030AcReadLavel">
        <logic:iterate id="user" name="fil030Form" property="fil030AcReadLavel" type="UsrLabelValueBean">
          <html:option value="<%= user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
        </logic:iterate>
    ...
    <td valign="middle" align="left" class="td_wt" width="100%">
      ...
      <logic:iterate id="user" name="fil030Form" property="fil030AdmLavel" type="UsrLabelValueBean">
        <html:option value="<%= user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <logic:iterate id="user" name="fil030Form" property="fil030AdmRightLavel" type="UsrLabelValueBean">
        <html:option value="<%= user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
      </logic:iterate>
      </logic:notEmpty>
      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
...
<%-- 容量設定 --%>
      ...
      <td class="td_sub_title" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="fil.3" /></span></td>
      <td class="td_sub_detail" align="left" width="80%">
        <logic:equal name="fil030Form" property="fil030CapaKbn" value="<%= String.valueOf(GSConstFile.CAPA_KBN_OFF) %>">
          <span class="text_base7"><label for="disksize0"><gsmsg:write key="cmn.noset" /></label></span>
        </logic:equal>
      </logic:equal>
      <div id="hide1">
      </div>
      ...
      <logic:equal name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PUBLIC %>" >
        ...
        <html:text name="fil030Form" maxlength="8" property="fil030CapaSize" styleClass="text_base" style="width:73px;" />
      ...
      <logic:equal name="fil030Form" property="fil030CapaKbn" value="<%= String.valueOf(GSConstFile.CAPA_KBN_ON) %>" >
        <span class="text_base"><gsmsg:write key="fil.4" />：<b><bean:write name="fil030Form" property="fil030CapaSize"/>MB</b></span>
        <br>
      </logic:equal>
      </logic:equal>
      ...
      <logic:equal name="fil030Form" property="fil030CapaKbn" value="<%= String.valueOf(GSConstFile.CAPA_KBN_ON) %>" >
        <span class="text_base"><gsmsg:write key="fil.fil030kn.1" />：<b><bean:write name="fil030Form" property="fil030CapaWarn"/>%</b></span>
      </logic:equal>
      </logic:equal>
      </div>
...
<%-- バージョン管理 --%>
    <logic:equal name="fil030Form" property="admVerKbn" value="1" >
      ...
      <tr>
      <td class="td_sub_title" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="fil.5" /></span></td>
      <td class="td_sub_detail" align="left" width="80%">
      <span class="text_base">&nbsp;
        <gsmsg:write key="fil.15" />&nbsp;&nbsp;<gsmsg:write key="fil.fil030.3" />：<bean:write name="fil030Form" property="fil030VerKbn" />
      </span>
      </td>
      </tr>
      </logic:equal>
    ...
    <td class="td_sub_detail" align="left" width="80%">
      ...
      <td width="0%">
        <logic:empty name="fil030Form" property="fil030ImageName">
          ...
          <logic:equal name="fil030Form" property="fil030PersonalFlg" value="<%= GSConstFile.DSP_CABINET_PRIVATE %>" >
            <img src="../file/images/personal_cabinet.gif" alt="">
          </logic:equal>
        </logic:empty>
        <logic:notEmpty name="fil030Form" property="fil030ImageName">
        <logic:equal name="fil030Form" property="cmnMode" value="0">
          <img width="30" src="../file/fil030.do?CMD=getImageFile&fil010DspCabinetKbn=<bean:write name="fil030Form" property="fil010DspCabinetKbn" />" name="pitctImage" alt="<gsmsg:write key="cmn.photo" />" border="1" onload="">
        </logic:equal>
        <logic:equal name="fil030Form" property="cmnMode" value="1">
