...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:notEqual name="historyMdl" property="usrJkbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_DELETE) %>">
      ...
      <logic:equal value="1" name="historyMdl" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
      <span class="text_base <%= mukouserClass %>"><bean:write name="historyMdl" property="usrSeiMei" /></span>
    </logic:notEqual>
    </td>
    ...
    <bean:define id="mukouserClass" value=""/>
    <logic:equal value="1" name="accessMdl" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
    <tr class="<%= td_colors[idx.intValue() % 2] %>">
    <td class="prj_td" align="left"><span class="<%= mukouserClass %>"><bean:write name="accessMdl" property="usiSyainNo" /></span></td>
    <td class="prj_td" align="left"><span class="text_base <%= mukouserClass %>"><bean:write name="accessMdl" property="usiSei" />&nbsp;<bean:write name="accessMdl" property="usiMei" /></span></td>
    <td class="prj_td" align="left"><span class="text_base <%= mukouserClass %>"><bean:write name="accessMdl" property="usiYakusyoku" /></span></td>
    <td class="prj_td" align="center">
