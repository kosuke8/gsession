  ...
  <td align="left">
    ...
    <logic:equal name="bbs130Form" property="bbs130IniPostTypeKbn" value="true">
        ...
        <td align="left">
          ...
          <dt><a href="#" onClick="return buttonPush('iniSetting');"><span class="text_link"><gsmsg:write key="cmn.default.setting" /></span></a></dt>
          <dd><div class="text"><li><gsmsg:write key="bbs.bbs110.5" /></li></div></dd>
          </dl>
        </td>
        </tr>
    </logic:equal>
