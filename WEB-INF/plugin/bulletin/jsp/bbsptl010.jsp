...
<logic:notEmpty name="bbsptl010Form" property="threadList">
    ...
    <a href="../bulletin/bbs060.do?bbs010forumSid=<bean:write name="bbsptl010Form" property="bbsPtlBfiSid" />&threadSid=<bean:write name="thdMdl" property="btiSid" />&bbsmainFlg=1">
    ...
    <logic:equal name="thdMdl" property="btsTempflg" value="1">
      <img src="../bulletin/images/icon_file.gif" height="15" alt="<gsmsg:write key="cmn.attach.file" />" class="attach_file_icon">
    </logic:equal>
    <span class="<%= titleClass %>"><bean:write name="thdMdl" property="btiTitle" /></span></a>
    </td>
    <td class="<%= tdClass %>">
