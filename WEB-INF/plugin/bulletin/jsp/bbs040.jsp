      ...
      <tr>
        ...
        <td class="td_type20">
          <span class="text_base2">
            ...
            <label for="bbs040publicStatus_01"><gsmsg:write key="bbs.bbs040.3" /></label>
            &nbsp;
            <html:checkbox name="bbs040Form" styleId="bbs040publicStatus_02" property="bbs040publicStatusScheduled" value="1" />
            <label for="bbs040publicStatus_02"><gsmsg:write key="bbs.bbs010.4" /></label>
          </span>
          <html:checkbox name="bbs040Form" styleId="bbs040publicStatus_03" property="bbs040publicStatusOver" value="1" />
          <label for="bbs040publicStatus_03"><gsmsg:write key="bbs.bbs040.4" /></label>
        </span>
        </td>
      </tr>
