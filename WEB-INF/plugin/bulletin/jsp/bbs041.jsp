...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table width="100%" cellpadding="5" cellspacing="0">
      <td align="right">
        <img src="../common/images/arrow2_l.gif" alt="<gsmsg:write key="cmn.previous.page" />" class="img_bottom" height="20" width="20" onClick="buttonPush('prevPage');"><html:select property="bbs041page1" onchange="changePage(0);" styleClass="paging_box text_i">
    ...
    <table width="100%" cellpadding="5" cellspacing="5" align="center">
      ...
      <td valign="middle" class="<%= tdColor %>">
        ...
        <div class="item_text">
        <a href="javascript:clickResult(<bean:write name="resultMdl" property="bfiSid" />, <bean:write name="resultMdl" property="btiSid" />);">
        <!-- 重要度 -->
        ...
        <span class="text_link"><bean:write name="resultMdl" property="btiTitle" /></span>
        </a>
        ...
        <tr>
        <td>
        <logic:equal name="resultMdl" property="bwiType" value="<%= String.valueOf(jp.groupsession.v2.bbs.GSConstBulletin.CONTENT_TYPE_TEXT_PLAIN) %>"><bean:write name="resultMdl" property="bwiValueView" /></logic:equal>
        <logic:equal name="resultMdl" property="bwiType" value="<%= String.valueOf(jp.groupsession.v2.bbs.GSConstBulletin.CONTENT_TYPE_TEXT_HTML) %>"><bean:write name="resultMdl" property="bwiValuePlainView" /></logic:equal>
        </td>
        </tr>
        </table>
        <div>
        ...
        <bean:define id="yukoFlg" name="resultMdl" property="userYukoKbn" type="java.lang.Integer"/>
          <% if (yukoFlg.intValue() == 1) { %>
            <span class="mukouser"><bean:write name="resultMdl" property="userName" /></span>
          <% } else { %>
            <span><bean:write name="resultMdl" property="userName" /></span>
          <% } %>
    ...
    <logic:greaterThan name="count2" value="1">
      <tr>
      <td align="right">
        <img src="../common/images/arrow2_l.gif" alt="<gsmsg:write key="cmn.previous.page" />" class="img_bottom" height="20" width="20" onClick="buttonPush('prevPage');"><html:select property="bbs041page2" onchange="changePage(1);" styleClass="paging_box text_i">
          <html:optionsCollection name="bbs041Form" property="bbsPageLabel" value="value" label="label" />
        </html:select><img src="../common/images/arrow2_r.gif" alt="<gsmsg:write key="cmn.next.page" />" class="img_bottom" height="20" width="20" onClick="buttonPush('nextPage');"></td>
      </tr>
    </logic:greaterThan>
