...
<body class="body_03" onunload="windowClose();" onload="showLengthId($('input_area_plain')[0], <%= maxLengthValue %>, 'inputlength');">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table width="100%" class="tl0" border="0" cellpadding="5">
      ...
      <!-- 本文 -->
      <tr>
        <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.content" /></span><span class="text_r3">※</span>
      </td>
      <td align="left" class="td_type20">
        ...
        <div id="input_area_html">
          <textarea name="bbs090valueHtml" id="inputstr_tinymce">
<bean:write name="bbs090Form" property="bbs090valueHtml" /></textarea>
        </div>
        <textarea name="bbs090value" style="width:100%;" rows="10" id="input_area_plain" onkeyup="showLengthStr(value, <%= maxLengthValue %>, 'inputlength');" >
<bean:write name="bbs090Form" property="bbs090value"/></textarea>
      ...
      <td align="left" class="td_type20">
        ...
        &nbsp;<input type="button" class="btn_attach" value="<gsmsg:write key="cmn.attached" />" name="attacheBtn" onClick="opnTemp('bbs090files', 'bulletin', '0', '0', '<bean:write name="bbs090Form" property="tempDirId" />');">
        <br>
