...
public class Bbs020Action extends AbstractBulletinAction {
     ...
     * @throws Exception 実行例外
     */
    private void __doUpdateSortUp(
            HttpServletRequest req, HttpServletResponse res, Bbs020Form form,
            Connection con, ActionMapping map)
                    throws Exception {

        __doUpdateSort(req, form, con, map, GSConstBulletin.FORUM_SORT_UP);
    }
     ...
     * @throws Exception 実行例外
     */
    private void __doUpdateSortDown(
            HttpServletRequest req, HttpServletResponse res, Bbs020Form form,
            Connection con, ActionMapping map)
                    throws Exception {

        __doUpdateSort(req, form, con, map, GSConstBulletin.FORUM_SORT_DOWN);
    }
     ...
     * @throws Exception 実行例外
     */
    private void __doUpdateSort(
            HttpServletRequest req, Bbs020Form form,
            Connection con, ActionMapping map, String mode)
                    throws Exception {
        ...
        try {
            ...
            Bbs020ParamModel paramMdl = new Bbs020ParamModel();
            paramMdl.setParam(form);
            biz.updateSort(paramMdl, con, mode, userSid, adminUser);
            paramMdl.setFormData(form);
            commitFlg = true;
