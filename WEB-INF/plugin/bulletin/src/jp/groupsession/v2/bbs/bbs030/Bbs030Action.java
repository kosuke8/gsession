...
public class Bbs030Action extends AbstractBulletinAction {
    ...
    private ActionForward __doAddUser(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.addMember(paramMdl, GSConstBulletin.ACCESS_KBN_WRITE);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doDelUser(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.delMember(paramMdl, GSConstBulletin.ACCESS_KBN_WRITE);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doAddUserRead(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.addMember(paramMdl, GSConstBulletin.ACCESS_KBN_READ);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doDelUserRead(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.delMember(paramMdl, GSConstBulletin.ACCESS_KBN_READ);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doAddUserAdm(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.addMember(paramMdl, GSConstBulletin.ACCESS_KBN_FORUM_ADM);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doDelUserAdm(
        ...
        paramMdl.setParam(form);
        Bbs030Biz biz = new Bbs030Biz();
        biz.delMember(paramMdl, GSConstBulletin.ACCESS_KBN_FORUM_ADM);
        paramMdl.setFormData(form);
    ...
    private ActionForward __doGetImageFile(ActionMapping map,
        ...
        String tempDir =
                _getBulletinTempDir(req, form) +  GSConstBulletin.TEMP_ICN_BBS + "/";
