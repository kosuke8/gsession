...
public class Anp150ParamModel extends Anp070ParamModel {
    ...
    private List <UsrLabelValueBean> anp150TargetLabel__ = null;
    /** 設定非対象ユーザ・グループリスト (追加用 右)*/
    private List <UsrLabelValueBean> anp150NoTargetLabel__ = null;
     ...
     */
    public List<UsrLabelValueBean> getAnp150TargetLabel() {
     ...
     */
    public void setAnp150TargetLabel(List<UsrLabelValueBean> anp150TargetLabel) {
     ...
     */
    public List<UsrLabelValueBean> getAnp150NoTargetLabel() {
     ...
     */
    public void setAnp150NoTargetLabel(List<UsrLabelValueBean> anp150NoTargetLabel) {
