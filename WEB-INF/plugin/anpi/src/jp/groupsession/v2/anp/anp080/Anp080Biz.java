...
public class Anp080Biz {
    ...
    public void setConfData(Anp080ParamModel anp080Model, RequestModel reqMdl, Connection con)
        ...
        //基本URL
        anp080Model.setAnp080SvBaseUrlAuto(cmnBiz.getBaseUrl(reqMdl));
     ...
     */
    private ArrayList<UsrLabelValueBean> __getAdminFullLavle(
        ...
        return usrBiz.getSelectedLabel(leftFull, con);
    }
}