                ...
                <logic:notEmpty name="anp160Form" property="anp160DspSenderList">
                  ...
                  <logic:iterate id="urBean" name="anp160Form" property="anp160DspSenderList" indexId="idx">
                     ...
                     <td width="0%" nowrap>
                        ...
                        <logic:equal value="1" name="urBean" property="anp160usrUkoFlg"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
                     <span class="text_base <%= mukouserClass %>"><bean:write name="urBean" property="anp160Name" />
                     &nbsp;&nbsp;</span></td>
