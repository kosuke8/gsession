          ...
          <logic:iterate id="haisin" name="anp130Form" property="anp130HaisinList" indexId="idx">
              ...
              <tr class="<%= tdType %>">
                ...
                <td align="left"   nowrap>
                    ...
                    <logic:equal value="1" name="haisin" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
                    <span class="<%=mukouserClass%>"><bean:write name="haisin" property="name" /></span>
                    </logic:equal>
