        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tl0 table_td_border">
          ...
          <logic:notEmpty name="anp110Form" property="anp110List">
              <logic:iterate id="detailModel" name="anp110Form" property="anp110List" indexId="idx">
                ...
                <tr class="<%= tdType %>">
                  <td align="left"   nowrap><span class="<%=mukouserClass%>"><bean:write name="detailModel" property="syainNo" /></span></td>
                  <td align="left"   nowrap><span class="<%=mukouserClass%>"><a href="#" onclick="selectUser(<bean:write name="detailModel" property="usrSid" />,'<bean:write name="detailModel" property="name" />');"><bean:write name="detailModel" property="name" /></a></span></td>
                  <td align="left" nowrap><span class="<%=mukouserClass%>"><bean:write name="detailModel" property="post" /></span></td>
                  <td align="left" nowrap><span class="<%=mukouserClass%>"><bean:write name="detailModel" property="mailAdr" /></span></td>
