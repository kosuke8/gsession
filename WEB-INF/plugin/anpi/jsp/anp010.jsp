            ...
            <IMG SRC="../common/images/spacer.gif" width="1px" height="10px" border="0"><br>
             <table class="tl0 table_td_border" width="100%" cellpadding="5" cellspacing="0">
                ...
                <tr class="td_type1">
                    ...
                    <logic:equal value="1" name="adminUsr" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
                    <span class="<%= mukouserClass %>"><bean:write name="adminUsr" property="label"/></span><br>
                    </logic:iterate>
                    </td>
                </tr>
             </table>
              ...
              <logic:iterate id="detailModel" name="anp010Form" property="anp010List" indexId="idx">
                ...
                <tr class="<%= tdType %>">
                  ...
                  <logic:equal name="detailModel" property="usrJkbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
                    ...
                    <a href="#" onclick="selectSyosai(<bean:write name="detailModel" property="usrSid" />);"><span class="<%= mukouserClass %>"><bean:write name="detailModel" property="name" /></span></a>
                  </logic:equal>
