...
<body class="body_03" onload="showLengthId($('#inputstr1')[0],<%=maxLengthComment %>,'inputlength1'); <%=dspChangeScript%>">
...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td width="0%">
    <table id="usrInfoTable" cellpadding="10" cellspacing="0" border="0" width="100%" class="tl_u2">
        <tr>
            <!-- 社員/職員番号 -->
