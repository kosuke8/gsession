    ...
    <table cellpadding="10" cellspacing="0" border="0" width="100%" class="tl_u2">
        ...
        <tr>
            ...
            <td valign="middle" align="left" class="td_wt" >
               ...
               <logic:equal value="1" name="anp140Form"  property="anp140usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
               <span class="text_base <%= mukouserClass%>"><bean:write name="anp140Form" property="anp140Name"/></span>
               </logic:equal>
               <logic:notEqual name="anp140Form"  property="anp140usrJkbn" value="<%= String.valueOf(GSConst.JTKBN_TOROKU) %>">
               <del><span class="text_base"><bean:write name="anp140Form" property="anp140Name"/></span></del>
               </logic:notEqual>
            </td>
        </tr>
              ...
              <% } %>
                  ...
                  <logic:iterate id="Jyookyo" name="anp140Form" property="anp140JyokyoList" indexId="idx">
                     ...
                     <logic:notEqual name="Jyookyo" property="apsType" value="<%= String.valueOf(jp.groupsession.v2.anp.GSConstAnpi.SEND_TYPE_GROUP) %>">
                       ...
                       <bean:define id="mukouserClass" value="" />
                       <logic:equal value="1" name="Jyookyo" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
                       <span class="<%=mukouserClass%>"><bean:write name="Jyookyo" property="nameTo"/></span>
                       </logic:equal>
