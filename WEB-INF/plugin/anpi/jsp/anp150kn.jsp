      ...
      <span class="text_r1"><gsmsg:write key="anp.anp150kn.02"/></span>
        ...
        <logic:notEmpty name="anp150knForm" property="anp150knOkUsrList">
          <logic:iterate id="usrName" name="anp150knForm" property="anp150knOkUsrList">
            ...
            <logic:equal value="1" name="usrName" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
          <br>
          <span class="text_base <%= mukouserClass %>"><bean:write name="usrName" property="label" /></span>
          </logic:iterate>
        </logic:notEmpty>
        </logic:notEqual>
        <br>
        ...
        <logic:notEmpty name="anp150knForm" property="anp150knCutUsrList">
          ...
          <logic:iterate id="cutUsrName" name="anp150knForm" property="anp150knCutUsrList">
            <bean:define id="mukouserClass" value="" />
            <logic:equal value="1" name="cutUsrName" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
            <br>
            <span class="text_base <%= mukouserClass %>"><bean:write name="cutUsrName" property="label"/></span>
          </logic:iterate>
          <br>
