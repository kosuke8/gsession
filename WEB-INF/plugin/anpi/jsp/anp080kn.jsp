            ...
            <td valign="middle" align="left" class="td_wt" width="100%">
                <logic:notEmpty name="anp080knForm" property="anp080AdmUserLabel">
                  ...
                  <logic:iterate id="urBean" name="anp080knForm" property="anp080AdmUserLabel" indexId="idx">
                     ...
                     <logic:equal value="1" name="urBean" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
                     <span class="<%=mukouserClass%>"><bean:write name="urBean" property="label"/></span><br>
                  </logic:iterate>
                  </span>
                </logic:notEmpty>
            </td>
