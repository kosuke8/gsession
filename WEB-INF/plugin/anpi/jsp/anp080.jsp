                ...
                <table width="0%" border="0">
                  ...
                  <td align="center">
                    <select size="10" multiple name="anp080SelectAdmUserSid" class="select01">
                      ...
                      <logic:equal value="1" name="laveValueBean" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                      <option class="<%=mukouserClass%>" value="<bean:write name="laveValueBean" property="value"/>"><bean:write name="laveValueBean" property="label"/></option>
                      </logic:iterate>
                      </logic:notEmpty>
                  ...
                  <td valign="top" rowspan="3">
                    <select size="10" multiple name="anp080SelectBelongSid" class="select01">
                      ...
                      <logic:iterate id="laveValueBean" name="anp080Form" property="anp080BelongLabel" scope="request">
                        <bean:define id="mukouserClass" value="" />
                        <logic:equal value="1" name="laveValueBean" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                        <option class="<%=mukouserClass%>" value="<bean:write name="laveValueBean" property="value" scope="page"/>"><bean:write name="laveValueBean" property="label" scope="page"/></option>
                      </logic:iterate>
                      </logic:notEmpty>
                      <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                    </select>
