...
public class Ntp040Action extends AbstractNippouAction {
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        } else if (cmd.equals("getConpanyWithAnken")) {
            //案件履歴に紐づく企業・顧客情報取得
            __getConpanyWithAnken(map, uform, req, res, con);
        } else {
            //初期表示
    ...
    */
     ...
     * @throws Exception 実行例外
     */
    private void __getConpanyWithAnken(ActionMapping map, Ntp040Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
    throws Exception {
        ...
        //企業・顧客情報取得
        Ntp040Biz biz = new Ntp040Biz(con, getRequestModel(req));
        JSONObject jsonData = biz.getCompanyWithAnkenHistory(ankenSid);
