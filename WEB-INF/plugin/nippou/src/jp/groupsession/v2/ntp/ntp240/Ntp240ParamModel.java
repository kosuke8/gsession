...
public class Ntp240ParamModel extends Ntp090ParamModel {
    ...
    /** ユーザラベル */
    private List<UsrLabelValueBean> ntp240UserLabel__;
     ...
     */
    public List<UsrLabelValueBean> getNtp240UserLabel() {
        return ntp240UserLabel__;
    }
    /**
     * <p>ntp240UserLabel をセットします。
     * @param userLabel ntp240UserLabel
     */
    public void setNtp240UserLabel(List<UsrLabelValueBean> userLabel) {
        ntp240UserLabel__ = userLabel;
    }
    /**
