...
public class Ntp020ParamModel extends Ntp010ParamModel {
    ...
    /** ユーザコンボ */
    private List<UsrLabelValueBean> ntp020UsrLabelList__ = null;
    /** 自動リロード時間 */
     ...
     */
    public List<UsrLabelValueBean> getNtp020UsrLabelList() {
        return ntp020UsrLabelList__;
    }
    /**
     * <p>ntp020UsrLabelList をセットします。
     * @param userLabel ntp020UsrLabelList
     */
    public void setNtp020UsrLabelList(List<UsrLabelValueBean> userLabel) {
        ntp020UsrLabelList__ = userLabel;
    }
    /**
