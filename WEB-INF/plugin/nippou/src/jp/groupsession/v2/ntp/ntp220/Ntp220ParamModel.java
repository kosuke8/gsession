...
public class Ntp220ParamModel extends Ntp010ParamModel {
    ...
    /** ユーザラベル */
    private List<UsrLabelValueBean> ntp220UserLabel__;
    /** ユーザSID */
     ...
     */
    public List<UsrLabelValueBean> getNtp220UserLabel() {
        return ntp220UserLabel__;
    }

    /**
     * <p>ntp220UserLabel をセットします。
     * @param userLabel ntp220UserLabel
     */
    public void setNtp220UserLabel(List<UsrLabelValueBean> userLabel) {
        ntp220UserLabel__ = userLabel;
    }
