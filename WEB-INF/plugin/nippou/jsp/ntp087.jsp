    ...
    --%>
          ...
          <td align="center">
            <html:select property="ntp087SelectLeft" size="7" styleClass="select01" multiple="true">
              ...
              <logic:iterate id="gplBean" name="ntp087Form" property="ntp087LeftList" scope="request" type="jp.groupsession.v2.ntp.model.NtpLabelValueModel">
                <logic:equal name="gplBean" property="styleClass" value="0">
                <html:option styleClass="<%=gplBean.getCSSClassNameOption() %>" value="<%=gplBean.getValue() %>"><bean:write name="gplBean" property="label" /></html:option>
                </logic:equal>
                <logic:notEqual name="gplBean" property="styleClass" value="0">
                <html:option styleClass="select03" value="<%=gplBean.getValue() %>"><bean:write name="gplBean" property="label" /></html:option>
                </logic:notEqual>
              </logic:iterate>
              </logic:notEmpty>
          ...
          <td>
            <html:select property="ntp087SelectRight" size="7" styleClass="select01" multiple="true">
              ...
              <logic:iterate id="gprBean" name="ntp087Form" property="ntp087RightList" scope="request" type="jp.groupsession.v2.ntp.model.NtpLabelValueModel">
                <logic:equal name="gprBean" property="styleClass" value="0">
                  <html:option styleClass="<%=gprBean.getCSSClassNameOption() %>" value="<%=gprBean.getValue() %>"><bean:write name="gprBean" property="label" /></html:option>
                </logic:equal>
                <logic:notEqual name="gprBean" property="styleClass" value="0">
                <html:option styleClass="select03" value="<%=gprBean.getValue() %>"><bean:write name="gprBean" property="label" /></html:option>
                </logic:notEqual>
              </logic:iterate>
              </logic:notEmpty>
            </html:select>
