        ...
        <td align="left" class="td_type20" width="100%" id="ntpNoticeUsrArea">
          ...
          <td align="center">
            <html:select property="ntp095SelectLeft" size="7" styleClass="select01" multiple="true">
              ...
              <logic:iterate id="gplBean" name="ntp095Form" property="ntp095LeftList" scope="request" type="jp.groupsession.v2.ntp.model.NtpLabelValueModel">
          ...
          <td>
            <html:select property="ntp095SelectRight" size="7" styleClass="select01" multiple="true">
              ...
              <logic:iterate id="gprBean" name="ntp095Form" property="ntp095RightList" scope="request" type="jp.groupsession.v2.ntp.model.NtpLabelValueModel">
