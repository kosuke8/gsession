...
<%@ taglib uri="/WEB-INF/ctag-jsmsg.tld" prefix="gsjsmsg" %>
 ...
 <bean:define id="datatominval" name="dataMdl" property="toMin"/>
            ...
            <logic:equal name="ntp040Form" property="ntp040AnkenCompanyUse" value="0">
              ...
              <td width="30%" align="left" class="<%= tdColor %> text_i" nowrap>
                      ...
                      <tr>
                        ...
                        <td valign="top" style="padding-left:10px;" id="commentDspAreaTable_<%= idx + 1 %>_<bean:write name="ntpCmtMdl" property="npcSid" />">
                          <logic:notEqual name="usrInfMdl" property="usrJkbn" value="<%= String.valueOf(GSConst.JTKBN_DELETE) %>">
                              <span class="<%=UserUtil.getCSSClassNameNormal(usrInfMdl.getUsrUkoFlg()) %>" style="font-size:12px;color:#333333;"><b><bean:write name="usrInfMdl" property="usiSei"/>&nbsp;<bean:write name="usrInfMdl" property="usiMei"/></b></span>
