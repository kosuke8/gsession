...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <logic:equal name="ntp040Form" property="cmd" value="add">
      ...
      <logic:equal value="1" name="ntp040Form" property="ntp040UsrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
      <span class="text_base <%= mukouserClass %>"><bean:write name="ntp040Form" property="ntp040UsrName" /></span>
      </td>
      </tr>
