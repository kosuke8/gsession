  ...
  <td align="left">
    ...
    <td align="left" class="td_type20">
      ...
      <td align="center">
        ...
        <logic:iterate id="urBean" name="ntp062Form" property="ntp061SelectUsrLavel" scope="request" type="CmnUsrmInfModel">
      ...
      <td>
         ...
         <logic:notEmpty name="ntp062Form" property="ntp061BelongLavel" scope="request">
          <logic:iterate id="urBean" name="ntp062Form" property="ntp061BelongLavel" scope="request" type="CmnUsrmInfModel">
            <option class="<%=UserUtil.getCSSClassNameOption(urBean.getUsrUkoFlg())%>" value="<bean:write name="urBean" property="usrSid" scope="page"/>"><bean:write name="urBean" property="usiSei" scope="page"/>　<bean:write name="urBean" property="usiMei" scope="page"/></option>
          </logic:iterate>
         </logic:notEmpty>
        <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
...
--%>
    ...
    <%--制限なし --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitView" styleId="ntp061NanPermitView0" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_ALL) %>" /><span class="text_base7"><label for="ntp061NanPermitView0"><gsmsg:write key="cmn.nolimit" /></label></span>&nbsp;
    <%--担当者のみ --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitView" styleId="ntp061NanPermitView1" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_TANTO) %>" /><span class="text_base7"><label for="ntp061NanPermitView1"><gsmsg:write key="address.62" /></label></span>&nbsp;
    <%--ユーザグループ指定 --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitView" styleId="ntp061NanPermitView2" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_USERGROUP) %>" /><span class="text_base7"><label for="ntp061NanPermitView2"><gsmsg:write key="ntp.ntp061.1" /></label></span>&nbsp;
    <logic:notEqual name="ntp062Form" property="ntp061NanPermitView" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_ALL) %>">
    <jsp:include page="/WEB-INF/plugin/common/jsp/usrgrpselect.jsp">
       <jsp:param value="ntp062Form" name="thisFormName"/>
    ...
    <%--制限なし --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitEdit" styleId="ntp061NanPermitEdit0" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_ALL) %>" /><span class="text_base7"><label for="ntp061NanPermitEdit0"><gsmsg:write key="cmn.nolimit" /></label></span>&nbsp;
    <%--担当者のみ --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitEdit" styleId="ntp061NanPermitEdit1" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_TANTO) %>" /><span class="text_base7"><label for="ntp061NanPermitEdit1"><gsmsg:write key="address.62" /></label></span>&nbsp;
    <%--ユーザグループ指定 --%>
    <html:radio name="ntp062Form" property="ntp061NanPermitEdit" styleId="ntp061NanPermitEdit2" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_USERGROUP) %>" /><span class="text_base7"><label for="ntp061NanPermitEdit2"><gsmsg:write key="ntp.ntp061.1" /></label></span>&nbsp;
    <logic:equal name="ntp062Form" property="ntp061NanPermitView" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_ALL) %>">
    <jsp:include page="/WEB-INF/plugin/common/jsp/usrgrpselect.jsp">
       <jsp:param value="ntp062Form" name="thisFormName"/>
       <jsp:param value="ntp061NanPermitUsrGrp" name="id"/>
