                                         ...
                                         <tr>
                                          ...
                                          <td class="td_wt5 title_area_2" width="100%" colspan="3" align="left">
                                            ...
                                            <div class="titleArea2 title_area">
                                               ...
                                               <logic:equal value="1" name="ntpUsrInfMdl" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>

                                               <span class="<%= mukouserClass %> %>" style="font-color:#eeeeee;font-size:13px;line-height:1em;"><bean:write name="ntpUsrInfMdl" property="usiSei" />&nbsp;&nbsp;<bean:write name="ntpUsrInfMdl" property="usiMei" /></span>
                                            ...
                                            <logic:iterate id="npcMdl" name="dataMdl" property="ntp030CommentList">
                                              ...
                                              <table class="commentDspAreaTable_<bean:write name="dataMdl" property="ntp030NtpSid" />_<bean:write name="ntpCmtMdl" property="npcSid" />">
                                                <tr>
                                                  ...
                                                  <bean:define id="mukouserClass" value=""/>
                                                  <logic:equal value="1" name="usrInfMdl" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser"/></logic:equal>
                                                    <span class="<%= mukouserClass %>" style="font-size:12px;color:#333333;"><b><bean:write name="usrInfMdl" property="usiSei"/>&nbsp;<bean:write name="usrInfMdl" property="usiMei"/></b></span>
