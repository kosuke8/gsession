                        ...
                        <td colspan="6" class="td_type20" nowrap="nowrap" width="86%">
                         ...
                         <html:select property="ntp100SltUser" styleClass="select01">
                          <logic:iterate id="user" name="ntp100Form" property="ntp100UserLabel" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
                            <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><%=user.getLabel() %></html:option>
                          </logic:iterate>
                         </html:select>
                        </td>
                        </tr>
                    ...
                    ～
                      ...
                      <logic:notEmpty name="ntp100Form" property="ntp100NippouList">
                        ...
                        <td colspan="6" class="td_type20" nowrap>
                          ...
                          <span style="white-space: nowrap"><html:multibox styleId="userName" name="ntp100Form" property="ntp100CsvOutField" value="2" /><label for="userName" class="text_base"><gsmsg:write key="cmn.user.name" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="ntpDate" name="ntp100Form" property="ntp100CsvOutField" value="3" /><label for="ntpDate" class="text_base"><gsmsg:write key="ntp.35" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="frTime" name="ntp100Form" property="ntp100CsvOutField" value="4" /><label for="frTime" class="text_base"><gsmsg:write key="cmn.starttime" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="toTime" name="ntp100Form" property="ntp100CsvOutField" value="5" /><label for="toTime" class="text_base"><gsmsg:write key="cmn.endtime" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="ankenCode" name="ntp100Form" property="ntp100CsvOutField" value="6" /><label for="ankenCode" class="text_base"><gsmsg:write key="ntp.29" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="cmpCode" name="ntp100Form" property="ntp100CsvOutField" value="7" /><label for="cmpCode" class="text_base"><gsmsg:write key="address.7" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="title" name="ntp100Form" property="ntp100CsvOutField" value="8" /><label for="title" class="text_base"><gsmsg:write key="cmn.title" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="titleColor" name="ntp100Form" property="ntp100CsvOutField" value="9" /><label for="titleColor" class="text_base">タイトル色</label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="kbunruicode" name="ntp100Form" property="ntp100CsvOutField" value="10" /><label for="kbunruicode" class="text_base"><gsmsg:write key="ntp.117" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="khouhoucode" name="ntp100Form" property="ntp100CsvOutField" value="11" /><label for="khouhoucode" class="text_base"><gsmsg:write key="ntp.118" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="value" name="ntp100Form" property="ntp100CsvOutField" value="12" /><label for="value" class="text_base"><gsmsg:write key="cmn.content" /></label></span><wbr>
                          <span style="white-space: nowrap"><html:multibox styleId="mikomido" name="ntp100Form" property="ntp100CsvOutField" value="13" /><label for="mikomido" class="text_base"><gsmsg:write key="ntp.32" /></label></span><wbr>
                          </td>
                      ...
                      -->
                          ...
                          <th class="table_bg_7D91BD"><a href="javascript:void(0)" onclick="clickSortTitle('4')"><span class="text_tlw"><gsmsg:write key="cmn.title" />/<gsmsg:write key="cmn.content" /></span></a></th>
                            ...
                            <td class="<%= tdColor %> " align="center" valign="middle" nowrap><span class="<%=UserUtil.getCSSClassNameNormal(ntpMdl.getUserUkoFlg()) %>"><bean:write name="ntpMdl" property="userName" /></span></td>
