  ...
  <td>
    ...
    <logic:equal name="ntp062knForm" property="ntp061NanPermitView" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_ALL) %>">
        ...
        <logic:equal name="ntp062knForm" property="ntp061NanPermitEdit" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_USERGROUP) %>">
            ...
            <logic:iterate id="user" name="ntp062knForm" property="ntp061NanPermitUsrGrp.selectedList(edit)" type="UsrLabelValueBean">
    ...
    <logic:equal name="ntp062knForm" property="ntp061NanPermitView" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.NAP_KBN_USERGROUP) %>">
        ...
        <bean:write name="ntp062knForm" property="ntp061NanPermitUsrGrp.selectedListName(view)"/>:<br />
        <logic:iterate id="user" name="ntp062knForm" property="ntp061NanPermitUsrGrp.selectedList(view)" type="UsrLabelValueBean">
           <span class="<%=user.getCSSClassNameNormal()%>"><bean:write name="user" property="label" /></span><br>
           <html:hidden property="ntp061NanPermitUsrGrp.selected(view)" value="<%=user.getValue() %>" />
        </logic:iterate>
        </br>
        <bean:write name="ntp062knForm" property="ntp061NanPermitUsrGrp.selectedListName(edit)"/>:<br />
        <logic:iterate id="user" name="ntp062knForm" property="ntp061NanPermitUsrGrp.selectedList(edit)" type="UsrLabelValueBean">
           <span class="<%=user.getCSSClassNameNormal()%>"><bean:write name="user" property="label" /></span><br>
           <html:hidden property="ntp061NanPermitUsrGrp.selected(edit)" value="<%=user.getValue() %>" />
        </logic:iterate>
