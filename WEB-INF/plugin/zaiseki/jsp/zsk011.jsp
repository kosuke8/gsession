...
<td>
  ...
  <td align="left" class="td_wt" width="80%"><span class="text_base <%=UserUtil.getCSSClassNameNormal(ukoFlg)%>"><bean:write name="zsk011Form" property="zsk011UpdateUserName" /></span></td>
  </tr>
  <tr>
