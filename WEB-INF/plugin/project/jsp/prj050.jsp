    ...
    <td class="td_sub_detail" align="left">
      ...
      <td align="center">
        <html:select property="prj050tanto" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj050Form" property="adminMemberLabel"  type="UsrLabelValueBean">
      ...
      <td>
        <html:select property="prj050member" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj050Form" property="memberLabel"  type="UsrLabelValueBean">
            <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label" /></html:option>
          </logic:iterate>
        </html:select>
      </td>
