    ...
    <logic:notEmpty name="prj150Form" property="member">
      ...
      <logic:iterate name="prj150Form" property="member" scope="request" id="member" indexId="index" type="Prj150MemberForm ">
        ...
        <td class="<%= tblColor %>" align="left">
          <a class="<%=UserUtil.getCSSClassNameNormal(member.getUsrUkoFlg())%>" href="javaScript:void(0);" onClick="return openUserInfoWindow('<bean:write name="member" property="usrSid" />');"><bean:write name="member" property="usrName" /></a>
        </td>
        <td class="<%= tblColor %>" align="left">
