    ...
    <td align="left" class="td_sub_detail">
      ...
      <td align="center">
        <html:select property="prj020syozokuMember" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj020Form" property="syozokuMemberLabel" type="UsrLabelValueBean">
      ...
      <td valign="top">
        <html:select property="prj020user" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj020Form" property="userLabel" type="UsrLabelValueBean">
            <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>" ><bean:write name="user" property="label"/></html:option>
          </logic:iterate>
    ...
    <td align="left" class="td_sub_detail">
      ...
      <td align="center">
        ...
        <html:select property="prj020adminMember" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj020Form" property="adminMemberLabel" type="UsrLabelValueBean">
            <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>" ><bean:write name="user" property="label"/></html:option>
          </logic:iterate>
      ...
      <td>
        <html:select property="prj020prjMember" multiple="true" size="5" styleClass="select01">
          <logic:iterate id="user" name="prj020Form" property="memberLabel" type="UsrLabelValueBean">
            <html:option styleClass="<%=user.getCSSClassNameOption() %>" value="<%=user.getValue() %>" ><bean:write name="user" property="label"/></html:option>
          </logic:iterate>
        </html:select>
      </td>
