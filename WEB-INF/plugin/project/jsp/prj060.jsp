...
<td width="100%" align="center">
  ...
  <td width="65%" valign="top">
    ...
    <span class="text_base_prj <%=UserUtil.getCSSClassNameNormal(ukoFlg)%>"><bean:write name="prj060Form" property="addUserName" /></span>
    </logic:equal>
    ...
    <td class="td_sub_detail" colspan="3">
      ...
      <logic:iterate id="memMdl" name="prj060Form" property="userList" scope="request" type="UserModel">
        ...
        <span class="text_base_prj <%=UserUtil.getCSSClassNameNormal(memMdl.getUsrUkoFlg())%>"><bean:write name="memMdl" property="sei" />&nbsp;<bean:write name="memMdl" property="mei" /></span>
        </logic:equal>
    ...
    <td>
      ...
      <span class="<%=UserUtil.getCSSClassNameNormal(comMdl.getUsrUkoFlg())%>"><bean:write name="comMdl" property="sei" />&nbsp;<bean:write name="comMdl" property="mei" /></span>
      </logic:equal>
    ...
    <td>
      ...
      <td class="td_sub_detail">
        ...
        <td nowrap>
          ...
          <span class="<%=UserUtil.getCSSClassNameNormal(prjHis.getUsrUkoFlg())%>"><bean:write name="prjHis" property="sei" />&nbsp;<bean:write name="prjHis" property="mei" /></span>
          </logic:equal>
