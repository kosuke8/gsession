    ...
    <td align="left" class="td_sub_detail">
      ...
      <td align="center">
        <html:select property="prj140syozokuMember" multiple="true" size="5" styleClass="select01">
           <logic:iterate id="user" name="prj140Form" property="syozokuMemberLabel" type="UsrLabelValueBean">
      ...
      <td>
        <html:select property="prj140user" multiple="true" size="5" styleClass="select01">
           <logic:iterate id="user" name="prj140Form" property="userLabel" type="UsrLabelValueBean">
           <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
           </logic:iterate>
        </html:select>
      </td>
    ...
    <td align="left" class="td_sub_detail">
      ...
      <td align="center">
        ...
        <html:select property="prj140adminMember" multiple="true" size="5" styleClass="select01">
           <logic:iterate id="user" name="prj140Form" property="adminMemberLabel" type="UsrLabelValueBean">
           <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
           </logic:iterate>
        </html:select>
      </td>
      ...
      <td>
        <html:select property="prj140prjMember" multiple="true" size="5" styleClass="select01">
           <logic:iterate id="user" name="prj140Form" property="memberLabel" type="UsrLabelValueBean">
           <html:option value="<%=user.getValue() %>" styleClass="<%=user.getCSSClassNameOption() %>"><bean:write name="user" property="label"/></html:option>
           </logic:iterate>
        </html:select>
      </td>
