...
<td width="100%" align="center">
  ...
  <tr>
    ...
    <td width="100%" align="left">
      <logic:equal name="userMdl" property="status" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.JTKBN_TOROKU) %>">
      <span class="blue_link <%=UserUtil.getCSSClassNameNormal(userMdl.getUsrUkoFlg())%>"><a href="javaScript:void(0);" onClick="return openUserInfoWindow('<bean:write name="userMdl" property="userSid" />');"><bean:write name="userMdl" property="sei" />&nbsp;<bean:write name="userMdl" property="mei" /></a></span>
      </logic:equal>
  ...
  <tr><td colspan="4" align="left"><html:errors/></td></tr>
    ...
    <table width="100%">
      ...
      <logic:notEmpty name="prjMdl" property="todoTantoList">
        ...
        <span class="text_base <%=UserUtil.getCSSClassNameNormal(tantoMdl.getUsrUkoFlg())%>"><bean:write name="tantoMdl" property="userName" /></span>
        </logic:equal>
