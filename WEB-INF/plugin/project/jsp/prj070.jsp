...
<td width="100%" align="center">
  ...
  <div>
    ...
    <html:checkbox property="prj070JoinOnlyFlg" styleId="onlyFlg" value="true"><label for="onlyFlg"><gsmsg:write key="project.prj070.7"/></label></html:checkbox>
    </logic:equal>
    <logic:notEqual name="prj070Form" property="prj070scPrjSid" value="-1">
    <html:checkbox property="prj070JoinOnlyFlg" styleId="onlyFlg" disabled="true"><label for="onlyFlg"><gsmsg:write key="project.prj070.7"/></label></html:checkbox>
    </logic:notEqual>
  </div>
  </td>
  <!-- 管理番号入力欄 -->
  ...
  <td width="40%" class="td_sub_detail"<%= tantoRow %>>
    ...
    <span class="<%=UserUtil.getCSSClassNameNormal(memMdl.getUsrUkoFlg())%>"><bean:write name="memMdl" property="usiSei" />&nbsp;<bean:write name="memMdl" property="usiMei" /></span>&nbsp;&nbsp;
    </logic:iterate>
    </logic:notEmpty>
    </span>
  </td>
