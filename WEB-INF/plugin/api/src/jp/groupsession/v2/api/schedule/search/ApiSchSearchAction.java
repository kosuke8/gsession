...
public class ApiSchSearchAction extends AbstractApiSchAction {
    ...
    public Document createXml(ActionForm form, HttpServletRequest req,
        ...
        ArrayList<SchDataModel> schDataList = schSearchDao.getScheduleList(sqlSchedule, true);
        ...
        if (pconfig.getPlugin("reserve") != null && sameInputFlg) {
            reserveListMap = searchBiz.getSelectResList(con, schduleSidList, sessionUsrSid, rsvAdmin);
        }
        ...
        for (Integer scdSid : schduleSidList) {
            ...
            if (ableEdit) ableEditList.add(scdSid);
        }
        // --------------------------------------------------------
