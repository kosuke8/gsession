...
//        ntpMdl.setScdRsSid(scdResSid);
    ...
    throws UnsupportedEncodingException {
        ...
        //スレッドのURLを作成
        StringBuffer ntpUrl = reqMdl__.getRequestURL();
        if (ntpUrl != null || ntpUrl.toString().length() > 0) {
            nippouUrl = ntpUrl.substring(0, ntpUrl.lastIndexOf("/api/"));
