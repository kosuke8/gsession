...
<%-- 氏名 --%><a href="#" onClick="return sort(<%= String.valueOf(jp.groupsession.v2.adr.adr010.Adr010Const.SORTKEY_UNAME) %>);">
...
<%-- 会社名 --%><th width="<%= header_width[1] %>" class="detail_tbl sort_select_area">
...
<%--役職--%><a href="#" onClick="return sort(<%= String.valueOf(jp.groupsession.v2.adr.adr010.Adr010Const.SORTKEY_POSITION) %>);">
       <span class="cel_adr_data">
...
<%--会社名--%><a href="#" onClick="return sort(<%= String.valueOf(jp.groupsession.v2.adr.adr010.Adr010Const.SORTKEY_CONAME) %>);">
    <span class="cel_adr_data">
    <logic:equal name="adr010Form" property="adr010sortKey" value="<%= String.valueOf(jp.groupsession.v2.adr.adr010.Adr010Const.SORTKEY_CONAME) %>">
       <logic:equal name="adr010Form" property="adr010orderKey" value="<%= String.valueOf(jp.groupsession.v2.adr.adr010.Adr010Const.ORDERKEY_ASC) %>" >
           <gsmsg:write key="cmn.company.name" />▲
...
<%--会社名／拠点--%><td><bean:write name="detailMdl" property="companyName" />
     <% if (cmdMode.intValue() != Adr010Const.CMDMODE_PROJECT) { %>
