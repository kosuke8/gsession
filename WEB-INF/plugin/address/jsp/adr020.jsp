  ...
  <td align="left">
    ...
    <td width="30%" valign="middle" align="left" class="td_wt" rowspan="5">
      ...
      <td align="center" class="td_body01" valign="top">
        ...
        <logic:notEmpty name="adr020Form" property="selectTantoCombo">
          <logic:iterate id="user" name="adr020Form" property="selectTantoCombo"  >
      ...
      <td colspan="2">
        ...
        <logic:notEmpty name="adr020Form" property="noSelectTantoCombo">
          <logic:iterate id="user" name="adr020Form" property="noSelectTantoCombo"  >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
    ...
    <td valign="middle" align="left" class="td_wt" colspan="1">
      ...
      <logic:equal name="adr020Form" property="adr020addPositionBtnFlg" value="1">
         &nbsp;<a href="#" onClick="return openpos();"><span valign="bottom"><img src="../common/images/plus.gif" alt="<gsmsg:write key="address.adr020.6" />" border="0" tabindex="14"></span></a>
      </logic:equal>
      </td>
      </tr>
      </table>
