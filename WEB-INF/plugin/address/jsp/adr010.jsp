...
<%-- 会社 --%><span><gsmsg:write key="address.139" /></span>
      </td>
      </tr>
      <tr>
      <td class="sel_menu_area sel_menu_title" id="1" nowrap>
<%-- 氏名 --%><span><gsmsg:write key="cmn.name" /></span>
      </td>
      </tr>
      <tr>
      <td class="sel_menu_area sel_menu_title" id="2" nowrap>
<%-- 担当者 --%><span><gsmsg:write key="cmn.staff" /></span>
      </td>
      </tr>
      <tr>
      <td class="sel_menu_area sel_menu_title" id="3" nowrap>
<%--プロジェクト--%><span><gsmsg:write key="cmn.project" /></span>
      </td>
      </tr>
      <tr>
      <td class="sel_menu_area sel_menu_title" id="4" nowrap>
<%-- 詳細検索 --%><span><gsmsg:write key="cmn.advanced.search" /></span>
      </td>
      </tr>
      <tr>
      <td class="sel_menu_area sel_menu_title" id="5" nowrap>
<%--コンタクト履歴--%><span><gsmsg:write key="address.6" /></span>
      </td>
      </tr>
      </table>
