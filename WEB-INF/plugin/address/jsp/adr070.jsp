    ...
    <td valign="middle" align="left" class="td_wt">
      ...
      <td align="center" class="td_body01" valign="top">
        ...
        <logic:notEmpty name="adr070Form" property="selectTantoCombo">
          <logic:iterate id="user" name="adr070Form" property="selectTantoCombo"  >
      ...
      <td align="center" class="td_body01" valign="top">
        ...
        <logic:notEmpty name="adr070Form" property="noSelectTantoCombo">
          <logic:iterate id="user" name="adr070Form" property="noSelectTantoCombo"  >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
    ...
    <td valign="middle" align="left" class="td_wt">
      ...
      <div id="viewuser" class="spacer">
        ...
        <td align="center" class="td_body01" valign="top">
          ...
          <logic:iterate id="user" name="adr070Form" property="selectPermitViewUser"  >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
        ...
        <td align="center" class="td_body01" valign="top">
          ...
          <td>
            ...
            <logic:iterate id="user" name="adr070Form" property="noSelectPermitViewUser"  >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
    ...
    <td valign="middle" align="left" class="td_wt">
      ...
      <div id="edituser" class="spacer">
        ...
        <td align="center" class="td_body01" valign="top">
          ...
          <logic:iterate id="user" name="adr070Form" property="selectPermitEditUser"  >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
        ...
        <td align="center" class="td_body01" valign="top">
          ...
          <td>
            ...
            <logic:iterate id="user" name="adr070Form" property="noSelectPermitEditUser" >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
