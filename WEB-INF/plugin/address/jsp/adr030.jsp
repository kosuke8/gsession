...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <dt><a href="#" onClick="return buttonPush('arestset');"><span class="text_link"><gsmsg:write key="address.adr320.1" /></span></a></dt>
    <dd><div class="text"><li><gsmsg:write key="address.adr320.2" /></li></div></dd>
    </dl>
    </td>
    </tr>
    <tr>
    ...
    <td align="left">
    <dl class="decorate_textbox1">
    <dt><a href="#" onClick="return buttonPush('address');"><span class="text_link"><gsmsg:write key="address.adr330.1" /></span></a></dt>
    <dd><div class="text"><li><gsmsg:write key="address.adr330.2" /></li></div></dd>
    </dl>
    </td>
    </tr>
    </table>
