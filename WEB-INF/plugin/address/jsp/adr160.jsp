...
--%>
    ...
    <logic:notEqual name="conMdl" property="adcAddusrJkbn" value="0">
        <del><bean:write name="conMdl" property="adcAdduserDspSei" />&nbsp;<bean:write name="conMdl" property="adcAdduserDspMei" /></del>
    </logic:notEqual>
    <logic:equal name="conMdl" property="adcAddusrJkbn" value="0">
        ...
        <span class="<%=mukouserClass%>"><bean:write name="conMdl" property="adcAdduserDspSei" />&nbsp;<bean:write name="conMdl" property="adcAdduserDspMei" /></span>
    </logic:equal>
    </td>
    </tr>
    </logic:iterate>
