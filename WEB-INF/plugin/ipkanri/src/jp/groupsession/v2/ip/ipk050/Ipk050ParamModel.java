...
public class Ipk050ParamModel extends Ipk040ParamModel {
    ...
    /** 追加用ユーザ一覧 */
    private List<UsrLabelValueBean> leftUserList__ = null;
    /** 追加済みユーザ一覧 */
     ...
     * @return leftUserList
     */
    public List<UsrLabelValueBean> getLeftUserList() {
     ...
     */
    public void setLeftUserList(List<UsrLabelValueBean> leftUserList) {
