  ...
  <td>
    ...
    <td tclass="text_base">
      ...
      <td class="td_type20_1" cellspacing="0" cellpadding="0">
        ...
        <logic:iterate id="user" name="ipk050Form" property="leftUserList"  >
      ...
      <html:select name="ipk050Form" property="selectRightUser" size="5" multiple="true" styleClass="select01">
        ...
        <logic:iterate id="user" name="ipk050Form" property="rightUserList"  >
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukouserClass" value="" />
            <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
            <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
        ...
        <logic:iterate id="labelValueBean" name="ipk050Form" property="leftUserList">
            <bean:define id="mukouserClass" value="" />
            <logic:equal name="labelValueBean" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
            <span class="<%=mukouserClass%>"><bean:write name="labelValueBean" property="label"/></span><br>
        </logic:iterate>
        </logic:notEmpty>
        </logic:equal>
    </td>
