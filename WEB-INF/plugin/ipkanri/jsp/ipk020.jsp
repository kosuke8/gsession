...
<br>
  ...
  <td class="td_type1" cellspacing="0" cellpadding="0">
    ...
    <td align="left">
      ...
      <logic:iterate id="user" name="ipk020Form" property="leftUserList"  >
      ...
      <logic:iterate id="user" name="ipk020Form" property="rightUserList"  >
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukouserClass" value="" />
            <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
            <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
  ...
  <logic:iterate id="param" name="ipk020Form" property="leftUserList">
    <bean:define id="mukouserClass" value="" />
    <logic:equal name="param" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
    <span class="<%=mukouserClass%>"><bean:write name="param" property="label" /></span><br />
  </logic:iterate>
  </logic:notEmpty>
  </td>
  </logic:equal>
