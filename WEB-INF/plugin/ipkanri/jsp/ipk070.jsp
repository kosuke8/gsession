  ...
  <td>
    ...
    <logic:notEmpty name="searchModel" property="iadAdmList">
      <logic:iterate id="addAdm" name="searchModel" property="iadAdmList">
        ...
        <bean:define id="mukouserClass" value="" />
        <logic:equal name="addAdm" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
        <span class="<%=mukouserClass%>"><bean:write name="addAdm" property="usiSei" />&nbsp;<bean:write name="addAdm" property="usiMei" /></span><br>
        </logic:equal>
