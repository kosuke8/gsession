...
public class Enq910ParamModel extends Enq900ParamModel {
    ...
    /** アンケート発信対象者リスト（左） */
    private ArrayList<UsrLabelValueBean> enq910AddSenderLabel__ = null;
    /** アンケート発信対象者リスト（右） */
    private ArrayList<UsrLabelValueBean> enq910BelongSenderLabel__ = null;
    /** アンケート発信対象者 選択SID （左） */
     ...
     */
    public ArrayList<UsrLabelValueBean> getEnq910AddSenderLabel() {
    ...
    public void setEnq910AddSenderLabel(
            ArrayList<UsrLabelValueBean> enq910AddSenderLabel) {
     ...
     */
    public ArrayList<UsrLabelValueBean> getEnq910BelongSenderLabel() {
    ...
    public void setEnq910BelongSenderLabel(
            ArrayList<UsrLabelValueBean> enq910BelongSenderLabel) {
