...
public class GSConstEnquete {
    ...
    /** フォルダ表示項目 */
    public static final String[] CONF_LIST_FOLDER = {"受信", "　未回答", "　回答済", "発信", "　未公開", "　回答受付中", "　回答受付終了", "　結果公開終了", "　草稿"};
    public static final int[] CONF_LIST_FOLDER_NO = {0, 1, 2, 10, 11, 12, 13, 14, 20};
