...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <tbody id="dspArea">
      ...
      <tr>
        <td valign="middle" align="left" class="table_bg_A5B4E1" width="20%" nowrap>
          <span class="text_bb1"><gsmsg:write key="enq.enq810.02"/></span>
        </td>
        <td align="left" class="td_wt" width="80%">
          <span class="text_base">
          ...
          <span id="canAnswer" >
            <html:checkbox name="enq930Form" property="enq930CanAnswer" styleId="enq930CanAnswer" onclick="check();"/><label for="enq930CanAnswer"><gsmsg:write key="enq.enq010.06" /></label>
          </span>
        </td>
      </tr>
    </tbody>
