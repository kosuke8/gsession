              ...
              <td align="center" valign="top">
                <select size="10" name="enq910SelectAddSenderSid" class="select01" style="width:100%;" multiple>
                  <logic:notEmpty name="enq910Form" property="enq910AddSenderLabel" scope="request">
                    <logic:iterate id="labelValueBean" name="enq910Form" property="enq910AddSenderLabel" scope="request" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
                      <option class="<% if (labelValueBean.getUsrUkoFlg() == 1) { %>mukouser_option<% } %>" value="<bean:write name="labelValueBean" property="value"/>"><bean:write name="labelValueBean" property="label"/></option>
                    </logic:iterate>
                  </logic:notEmpty>
                </select>
              </td>
              ...
              <td align="center" valign="top" rowspan="3">
                <select size="10" name="enq910SelectBelongSenderSid" class="select01" style="width:100%;" multiple>
                  <logic:notEmpty name="enq910Form" property="enq910BelongSenderLabel" scope="request">
                    <logic:iterate id="labelValueBean" name="enq910Form" property="enq910BelongSenderLabel" scope="request" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
                      <option class="<% if (labelValueBean.getUsrUkoFlg() == 1) { %>mukouser_option<% } %>" value="<bean:write name="labelValueBean" property="value"/>"><bean:write name="labelValueBean" property="label"/></option>
                    </logic:iterate>
                  </logic:notEmpty>
                </select>
