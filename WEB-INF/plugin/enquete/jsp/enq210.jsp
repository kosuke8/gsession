        ...
        <td colspan="3" class="td_type20" align="left" valign="middle">
          ...
          <td align="center">
            ...
            <logic:notEmpty name="enq210Form" property="selectAnswerCombo">
              <logic:iterate id="user" name="enq210Form" property="selectAnswerCombo" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
          ...
          <td>
            ...
            <logic:notEmpty name="enq210Form" property="noSelectAnswerCombo">
              <logic:iterate id="user" name="enq210Form" property="noSelectAnswerCombo" type="jp.groupsession.v2.usr.model.UsrLabelValueBean">
                <bean:define id="mukouserClass" value="" />
                <logic:equal value="1" name="user" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                <html:option value="<%=user.getValue() %>" styleClass="<%= mukouserClass %>"><bean:write name="user" property="label"/></html:option>
              </logic:iterate>
