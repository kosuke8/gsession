            ...
            if (paramMdl.getSch041TimeKbn().equals(String.valueOf(GSConstSchedule.TIME_EXIST))) {
                ...
                if (svReserves != null) {
                    ...
                    for (int i = 0; i < svReserves.length; i++) {
                        ...
                        //スケジュール編集時は、施設予約登録者IDおよび登録日時に編集前の値を設定
                        if (paramMdl.getCmd().equals(GSConstSchedule.CMD_EDIT)) {
                           yrkAddDataEdit(paramMdl, reqMdl, svReserves[i], yrkParam);
                        } else {
                        ...
                        int schPublic = NullDefault.getInt(paramMdl.getSch041Public(),
                        ...
                        if (mdl != null) {
                            if (RsvCommonBiz.isRskKbnRegCheck(mdl.getRskSid())) {
                                ...
                                if (paramMdl.getCmd().equals(GSConstSchedule.CMD_EDIT)) {
                                    kyrkAddDataEdit(paramMdl, reqMdl, svReserves[i], kyrkMdl);
                                } else {
