...
public class Sch240ParamModel extends Sch230ParamModel {
    ...
    /** 制限対象 未選択コンボ */
    private List<UsrLabelValueBean> sch240subjectNoSelectCombo__  = null;
    ...
    /** 許可ユーザ 未選択コンボ */
    private List<UsrLabelValueBean> sch240accessNoSelectCombo__  = null;
     ...
     */
    public List<UsrLabelValueBean> getSch240subjectNoSelectCombo() {
    ...
    public void setSch240subjectNoSelectCombo(
            List<UsrLabelValueBean> sch240subjectNoSelectCombo) {
     ...
     */
    public List<UsrLabelValueBean> getSch240accessNoSelectCombo() {
    ...
    public void setSch240accessNoSelectCombo(
            List<UsrLabelValueBean> sch240accessNoSelectCombo) {
