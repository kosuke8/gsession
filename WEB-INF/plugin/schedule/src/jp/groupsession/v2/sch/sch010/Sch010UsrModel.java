...
public class Sch010UsrModel extends AbstractModel {
     ...
     * @return schUkoFlg
     */
    public int getSchUkoFlg() {
        return schUkoFlg__;
    }
    /**
     * <p>schMukoFlg をセットします。
     * @param schUkoFlg schUkoFlg
     */
    public void setSchUkoFlg(int schUkoFlg) {
        schUkoFlg__ = schUkoFlg;
    }
}
