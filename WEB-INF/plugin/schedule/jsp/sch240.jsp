      ...
      <tr>
        ...
        <td align="left">
          ...
          <logic:notEmpty name="sch240Form" property="sch240subjectSelectCombo">
            ...
            <logic:iterate name="sch240Form" property="sch240subjectSelectCombo" id="subUser">
          ...
          <logic:notEmpty name="sch240Form" property="sch240subjectNoSelectCombo">
            ...
            <logic:iterate name="sch240Form" property="sch240subjectNoSelectCombo" id="noSelect">
      ...
      <tr>
        <td>
          ...
          <td align="center">
            ...
            <logic:iterate name="sch240Form" property="sch240editUserSelectCombo" id="editSelect">

              <logic:equal name="editSelect" property="usrUkoFlg" value="1">
                <option value='<bean:write name="editSelect" property="value"/>' class="mukouser_option">
              </logic:equal>
              <logic:notEqual name="editSelect" property="usrUkoFlg" value="1">
                <option value='<bean:write name="editSelect" property="value"/>'>
              </logic:notEqual>
              <bean:write name="editSelect" property="label"/>
          ...
          <td rowspan="3" align="left" style="border: 0px;">
            ...
            <logic:iterate name="sch240Form" property="sch240accessNoSelectCombo" id="editNoSelect">
          ...
          <td align="center">
            ...
            <logic:iterate name="sch240Form" property="sch240accessSelectCombo" id="accessSelect">
