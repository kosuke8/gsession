...
<td width="100%" align="center">
  ...
  <td colspan="<%= totalCols.toString() %>" class="td_type0">
    ...
    <td width="0%" align="right" nowrap>
      <input type="button" value="Cal" onclick="resetCmd();sch030OpenCalendar();wrtCalendarByBtn(this.form.sch010DspDate, 'sch030CalBtn')" class="calendar_btn2" id="sch030CalBtn">
    </td>
