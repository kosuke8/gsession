...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td class="td_type1">
      <span class="text_base"><gsmsg:write key="schedule.sch081.1" /></span><br><br>
      <div>
        午前：
        <html:select property="sch081AmFrHour">
          <html:optionsCollection name="sch081Form" property="sch081AmFrHourLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081AmFrMin">
          <html:optionsCollection name="sch081Form" property="sch081AmFrMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
        ～
        <html:select property="sch081AmToHour">
          <html:optionsCollection name="sch081Form" property="sch081AmToHourLabel" value="value" label="label" />
        </html:select>
         <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081AmToMin">
          <html:optionsCollection name="sch081Form" property="sch081AmToMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
      </div>
      <div>
        午後：
        <html:select property="sch081PmFrHour">
          <html:optionsCollection name="sch081Form" property="sch081PmFrHourLabel" value="value" label="label" />
        </html:select>
         <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081PmFrMin">
          <html:optionsCollection name="sch081Form" property="sch081PmFrMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
        ～
        <html:select property="sch081PmToHour">
          <html:optionsCollection name="sch081Form" property="sch081PmToHourLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081PmToMin">
          <html:optionsCollection name="sch081Form" property="sch081PmFrMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
      </div>
      <div>
        終日：
        <html:select property="sch081AllDayFrHour">
          <html:optionsCollection name="sch081Form" property="sch081AllDayFrHourLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081AllDayFrMin">
          <html:optionsCollection name="sch081Form" property="sch081AllDayFrMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
        ～
        <html:select property="sch081AllDayToHour">
          <html:optionsCollection name="sch081Form" property="sch081AllDayToHourLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.hour.input" />
        <html:select property="sch081AllDayToMin">
          <html:optionsCollection name="sch081Form" property="sch081AllDayToMinuteLabel" value="value" label="label" />
        </html:select>
        <gsmsg:write key="cmn.minute.input" />
      </div>
    </td>
