...
<td width="100%" align="center">
  ...
  <td colspan="6" class="td_type20" width="86%" nowrap>
   ...
   <logic:iterate id="nowSelectUserLabel" name="sch100Form" property="sch100UserLabel">
      ...
      <%-- 初期検索対象ユーザ設定 --%>
      <logic:notEmpty name="sch100Form" property="sch100SelectUsrSid">

        <%-- 初期検索対象ユーザ設定のためのデータを取得  --%>
        <bean:define id="selectUser" name="sch100Form" property="sch100SelectUsrSid"/>
        ...
        <logic:equal name="nowSelectUserLabel" property="usrUkoFlg" value="1">
          <% if (selectUser.equals(String.valueOf(nowSelectUser))) { %>
            <option value='<bean:write name="nowSelectUserLabel" property="value"/>' class="mukouser_option" selected>
          <% } else { %>
            <option value='<bean:write name="nowSelectUserLabel" property="value"/>' class="mukouser_option">
          <% } %>
      ...
      <logic:empty name="sch100Form" property="sch100SelectUsrSid">
...
-->
    ...
    <tr>
    <td class="<%= tdColor %>" align="left" valign="middle" nowrap>
