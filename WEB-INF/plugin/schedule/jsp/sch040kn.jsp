  ...
  <td align="center">
    ...
    <span id="lt"><img src="../common/images/groupicon.gif" alt="<gsmsg:write key="cmn.group" />" border="0"></span>
      ...
      <logic:equal name="sch040knForm" property="sch040UsrUkoFlg" value="1">
        <span class="text_base mukouser"><bean:write name="sch040knForm" property="sch040UsrName" /></span>
      </logic:equal>
    ...
    <td align="left" class="<%= tdColor %>">
      ...
      <logic:notEqual name="sch040knForm" property="sch040AddUsrJkbn" value="9">
        <logic:equal name="sch040knForm" property="sch040AddUsrUkoFlg" value="1">
          <span class="mukouser"><bean:write name="sch040knForm" property="sch040AddUsrName" /></span>
        </logic:equal>
