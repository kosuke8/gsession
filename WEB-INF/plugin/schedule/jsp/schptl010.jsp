...
<div id="tooltips_sch<bean:write name="schptl010Form" property="schDspGrpSid" />">
    ...
    <a href="javascript:void(0);" onClick="return moveDailyScheduleFromPtl('day', <bean:write name="calBean" property="dspDate" />, '<%= schFormId %>');">
    ...
    <%= Integer.parseInt(strDspDate.substring(4, 6)) %><gsmsg:write key="cmn.month" /><bean:write name="calBean" property="dspDayString" /></span></a></th>
    </logic:iterate>
    </logic:notEmpty>
    </tr>
