  ...
  <td align="center">
    ...
    <span id="lt"><img src="../common/images/groupicon.gif" alt="<gsmsg:write key="cmn.group" />" border="0"></span>
      ...
      <logic:equal name="sch041Form" property="sch040UsrUkoFlg" value="1">
        <span class="text_base mukouser"><bean:write name="sch041Form" property="sch040UsrName" /></span>
      </logic:equal>
    ...
    <td align="left" class="<%= tdColor %>" nowrap>
       <html:select property="sch041FrYear" styleId="selYear" onchange="setToDay()">
        <html:optionsCollection name="sch041Form" property="sch040YearLabel" value="value" label="label" />
     </html:select>
     <html:select property="sch041FrMonth" styleId="selMonth" onchange="setToDay()">
        <html:optionsCollection name="sch041Form" property="sch040MonthLabel" value="value" label="label" />
     </html:select>
     <html:select property="sch041FrDay" styleId="selDay" onchange="setToDay()">
        <html:optionsCollection name="sch041Form" property="sch040DayLabel" value="value" label="label" />
     </html:select>
       <input type="button" value="Cal" onclick="wrtCalendarByBtn(this.form.selDay, this.form.selMonth, this.form.sch041FrYear, 'sch041FrCalBtn')" onfocus="setToDay()" class="calendar_btn" id="sch041FrCalBtn">
    ...
    <td align="left" class="<%= tdColor %>" nowrap>
     <html:select property="sch041ToYear" styleId="seleYear" onchange="setFromDay()">
        <html:optionsCollection name="sch041Form" property="sch040YearLabel" value="value" label="label" />
     </html:select>
     <html:select property="sch041ToMonth" styleId="seleMonth" onchange="setFromDay()">
        <html:optionsCollection name="sch041Form" property="sch040MonthLabel" value="value" label="label" />
     </html:select>
     <html:select property="sch041ToDay" styleId="seleDay" onchange="setFromDay()">
        <html:optionsCollection name="sch041Form" property="sch040DayLabel" value="value" label="label" />
     </html:select>
     <input type="button" value="Cal" onclick="wrtCalendarByBtn(this.form.seleDay, this.form.seleMonth, this.form.seleYear, 'sch041ToCalBtn')" onfocus="setFromDay()" class="calendar_btn" id="sch041ToCalBtn">
    ...
    <td align="left" class="<%= tdColor %>">
     <html:select styleId="sch041FrHour" property="sch041FrHour" onchange="setToTime()" >
        <html:optionsCollection name="sch041Form" property="sch040HourLabel" value="value" label="label" />
     </html:select>
     <gsmsg:write key="cmn.hour.input" />
     <html:select styleId="sch041FrMin" property="sch041FrMin" onchange="setToTime()">
...
～
     <html:select styleId="sch041ToHour" property="sch041ToHour" onchange="setFromTime()">
        <html:optionsCollection name="sch041Form" property="sch040HourLabel" value="value" label="label" />
     </html:select>
     <gsmsg:write key="cmn.hour.input" />
     <html:select styleId="sch041ToMin" property="sch041ToMin" onchange="setFromTime()">
        <html:optionsCollection name="sch041Form" property="sch040MinuteLabel" value="value" label="label" />
     </html:select>
     <gsmsg:write key="cmn.minute.input" />
     <div class="text_time">
       ...
       <span class="text_base  time_master">
          &nbsp;&nbsp;
          <a href="javaScript:void(0);" onclick="setAmTime();">
        ...
        <span class="text_base time_master">
          &nbsp;&nbsp;
          <a href="javaScript:void(0);" onclick="setPmTime();">
       ...
       <span class="text_base time_master">
         &nbsp;&nbsp;
         <a href="javaScript:void(0);" onclick="setAllTime();">
