...
<body class="body_03" onload="changeEnableDisableTime(); changeEnableDisable(); changeEnableDisablePublic(); changeEnableDisableSame();">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <!-- 時間 -->
    <tr>
    <td valign="middle" align="left" class="table_bg_A5B4E1" width="20%" id="schTimeArea1" nowrap rowspan="2">
      <span class="text_bb1"><gsmsg:write key="cmn.time" /></span><span class="text_r2">※</span>
    </td>
    <td valign="middle" align="left" class="td_wt">
      <html:radio name="sch086Form" styleId="sch086TimeType_01" property="sch086TimeType" value="<%= String.valueOf(GSConstSchedule.SAD_INIEDIT_STYPE_ADM) %>" onclick="changeEnableDisableTime();" /><label for="sch086TimeType_01"><span class="text_base"><gsmsg:write key="cmn.set.the.admin" /></span></label>&nbsp;
      <html:radio name="sch086Form" styleId="sch086TimeType_02" property="sch086TimeType" value="<%= String.valueOf(GSConstSchedule.SAD_INIEDIT_STYPE_USER) %>" onclick="changeEnableDisableTime();" /><label for="sch086TimeType_02"><span class="text_base"><gsmsg:write key="cmn.set.eachuser" /></span></label>
    </td>
    </tr>

    <tr>
     <td valign="middle" align="left" class="td_wt" width="100%" id="schTimeArea2">
     <!-- 開始時間 -->
      <span class="text_bb1"><gsmsg:write key="cmn.starttime" />：</span>
      <!-- 時 -->
      <html:select property="sch086DefFrH">
        <html:optionsCollection name="sch086Form" property="sch086HourLabel" value="value" label="label" />
      </html:select>
      <gsmsg:write key="cmn.hour.input" />
      <!-- 分 -->
      <html:select property="sch086DefFrM">
        <html:optionsCollection name="sch086Form" property="sch086MinuteLabel" value="value" label="label" />
      </html:select>
    ...
    <br>
      ...
      <!-- 時 -->
      <html:select property="sch086DefToH">
        <html:optionsCollection name="sch086Form" property="sch086HourLabel" value="value" label="label" />
      </html:select>
      <gsmsg:write key="cmn.hour.input" />
      <!-- 分 -->
      <html:select property="sch086DefToM">
        <html:optionsCollection name="sch086Form" property="sch086MinuteLabel" value="value" label="label" />
      </html:select>
      <gsmsg:write key="cmn.minute.input" />
