...
public class Tcd020Biz {
    ...
    private void __doInitOneData(Tcd020ParamModel paramMdl,
        ...
        String tcd020AHour = "8";
        String tcd020AMinute = "0";
        ...
        paramMdl.setTcd020AHour(
                NullDefault.getString(paramMdl.getTcd020AHour(), tcd020AHour));
        paramMdl.setTcd020AMinute(
                NullDefault.getString(paramMdl.getTcd020AMinute(), tcd020AMinute));
