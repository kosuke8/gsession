...
public class Tcd020Form extends Tcd010Form {
    ...
    /** A作業時間　時間 */
    private String tcd020AHour__;
    /** A作業時間　分   */
    private String tcd020AMinute__;
    ...
    public String getTcd020AHour() {
        return tcd020AHour__;
    }

    /**
     * <p>tcd020AHour をセットします。
     * @param tcd020AHour tcd020AHour
     */
    public void setTcd020AHour(String tcd020AHour) {
    	tcd020AHour__ = tcd020AHour;
    }

    /**
     * <p>tcd020AMinute を取得します。
     * @return tcd020AMinute
     */
    public String getTcd020AMinute() {
        return tcd020AMinute__;
    }

    /**
     * <p>tcd020AMinute をセットします。
     * @param tcd020AMinute tcd020AMinute
     */
    public void setTcd020AMinute(String tcd020AMinute) {
    	tcd020AMinute__ = tcd020AMinute;
    }
    ...
    public ActionErrors validateCheck(RequestModel reqMdl, TcdAdmConfModel admConf) {
        ...
        GsMessage gsMsg = new GsMessage(reqMdl);
            ...
            //A作業時間　片側入力チェック
            if (tcd020AHour__.equals("-1") && !tcd020AMinute__.equals("-1")
            || !tcd020AHour__.equals("-1") && tcd020AMinute__.equals("-1")
            ) {
                gsmsg = gsMsg.getMessage("tcd.24");
                msg = new ActionMessage("error.input.notvalidate.data", gsmsg);
                errors.add("" + "error.input.notvalidate.data", msg);
        ...
        if (!StringUtil.isNullZeroString(tcd020HolDays__)) {
            if (__checkRange(
                ...
                if (ValidateUtil.isSpaceStart(tcd020HolDays__)) {
                    ...
                    gsmsg = gsMsg.getMessage("project.src.83");
