...
public class Tcd010Biz {
    ...
    public void setInitData(Tcd010ParamModel paramMdl,
        ...
        //ユーザ種別 = 一般ユーザの場合、選択されたグループが所属グループかを確認
        ...
        paramMdl.setTcd010List(
                getTimeCardList(paramMdl, Integer.parseInt(dspUsrSid), admConf, con, reqMdl));
        //前月・当月の集計値を取得
    ...
    public ArrayList<Tcd010Model> getTimeCardList(
        ...
        while (date.compareDateYMD(endDate) != UDate.SMALL) {
            ...
            if (tcdMdl == null) {
                ...
                tcdMdl.setTcd010KadoStr("10:00");
                tcdMdl.setTcd010ProjectAStr("TEST");
            ...
            if (tcdMdl.getTcdIntime() != null) {
                ...
                if (sysDate.compareDateYMD(tcdMdl.getTcdDate()) == UDate.SMALL
                        ...
                        && tcBiz.isOver24HoursOrTenAM(tcdMdl.getTcdDate(), inTime)) {
