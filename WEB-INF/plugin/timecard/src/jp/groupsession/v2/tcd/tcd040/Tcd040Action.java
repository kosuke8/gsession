...
public class Tcd040Action extends AbstractTimecardAction {
     ...
     */
    public boolean isAccessOk(HttpServletRequest req, Connection con, Tcd040Form form)
    throws SQLException {
        //セッション情報を取得
        ...
        if (usrKbn == GSConstTimecard.USER_KBN_NORMAL) {
            ...
            return biz.isGroupAdmin(con, paramMdl, usModel.getUsrsid());
        }
