...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <tr>
    <th align="left" class="table_bg_A5B4E1" width="20%" nowrap>
    <span class="text_bb1"><gsmsg:write key="tcd.192" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></th>
    <td align="left" class="td_type1" width="80%">

      <html:select name="tcd020Form" property="tcd020AHour" >
      <html:optionsCollection name="tcd020Form" property="tcd020HourLabel" />
      </html:select>
      <gsmsg:write key="cmn.time" />
      <html:select name="tcd020Form" property="tcd020Minute">
      <html:optionsCollection name="tcd020Form" property="tcd020MinuteLabel" />
      </html:select>
      <gsmsg:write key="cmn.minute.input" />
