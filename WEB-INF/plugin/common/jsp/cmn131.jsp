    ...
    <td align="left" class="td_wt">
      ...
      <td>
        <html:select property="cmn131selectUserSid" size="6" multiple="true" styleClass="select01">
          <logic:iterate id="user" name="cmn131Form" property="cmn131MbLabelList" >
      ...
      <td align="center">
        <html:select property="cmn131addUserSid" size="6" multiple="true" styleClass="select01">
           <logic:iterate id="user" name="cmn131Form" property="cmn131AdLabelList" >
            <logic:equal value="1" name="user" property="usrUkoFlg">
            <option value='<bean:write name="user" property="value"/>' class="mukouser_option"><bean:write name="user" property="label"/></option>
            </logic:equal>
            <logic:equal value="0" name="user" property="usrUkoFlg">
    ...
    <td align="left" class="td_wt">
      ...
      <td>
        <html:select property="cmn131refSelectUserSid" size="6" multiple="true" styleClass="select01">
          <logic:iterate id="user" name="cmn131Form" property="cmn131refMbLabelList" >
            <logic:equal value="1" name="user" property="usrUkoFlg">
            <option value='<bean:write name="user" property="value"/>' class="mukouser_option"><bean:write name="user" property="label"/></option>
            </logic:equal>
            <logic:equal value="0" name="user" property="usrUkoFlg">
      ...
      <td align="center">
        <html:select property="cmn131refAddUserSid" size="6" multiple="true" styleClass="select01">
          <logic:iterate id="user" name="cmn131Form" property="cmn131refAdLabelList" >
            <logic:equal value="1" name="user" property="usrUkoFlg">
            <option value='<bean:write name="user" property="value"/>' class="mukouser_option"><bean:write name="user" property="label"/></option>
            </logic:equal>
            <logic:equal value="0" name="user" property="usrUkoFlg">
