...
<body class="body_03" style="width:100%" onload="setDisableGroup();">
...
<html:hidden property="cmn230LeftTitleName" />
<html:hidden property="cmn230RightTitleName" />
<logic:equal name="cmn230Form" property="cmn230TabMode" value="1">
<html:hidden property="cmn230SearchStr" />
</logic:equal>
<html:hidden property="cmn230SearchStrSv" />
...
<logic:iterate id="sid" name="cmn230Form" property="cmn230banUserSid" scope="request">
    <input type="hidden" name="cmn230banUserSid" value="<bean:write name="sid" />">
</logic:iterate>
<logic:iterate id="sid" name="cmn230Form" property="cmn230banGroupSid" scope="request">
    <input type="hidden" name="cmn230banGroupSid" value="<bean:write name="sid" />">
</logic:iterate>
<logic:iterate id="sid" name="cmn230Form" property="cmn230disableGroupSid" scope="request">
    <input type="hidden" name="cmn230disableGroupSid" value="<bean:write name="sid" />">
</logic:iterate>
      ...
      <div style="padding-left:7px;width:250px;height:500px;overflow:scroll;">
          ...
          <logic:iterate id="mdl" name="cmn230Form" property="groupList" indexId="idx">
            ...
            <logic:equal name="mdl" property="classLevel" value="1">
              ...
              <% } %>
              <li>
                <a id="group_branch<bean:write name="mdl" property="groupSid" />" href="javascript:void(0);" onClick="return changeGroup('<bean:write name="mdl" property="groupSid" />');">
        ...
        <tr class="td_type1 <%= String.valueOf(back) %>" style="font-size:90%;" id="<bean:write name="userMdl" property="usrSid" />">
          ...
          <!-- 氏名 -->
            <a href="javaScript:void(0);" onclick="moveUserButton('230_belowarrow', '<bean:write name="userMdl" property="usrSid" />');">
              <span class="normal_link <logic:equal name="userMdl" property="usrUkoFlg" value="1">mukouser</logic:equal>"><bean:write name="userMdl" property="usiSei" />&nbsp;<bean:write name="userMdl" property="usiMei" /></span>
            </a>
          <!-- 役職 -->
        ...
        <tr class="td_type1 <%= String.valueOf(back) %>" style="font-size:90%;" id="<bean:write name="selUserMdl" property="usrSid" />">
          ...
          <!-- 氏名 -->
            <a href="#" onclick="moveUserButton('230_abovearrow', '<bean:write name="selUserMdl" property="usrSid" />');">
              <span class="normal_link <logic:equal name="selUserMdl" property="usrUkoFlg" value="1">mukouser</logic:equal>"><bean:write name="selUserMdl" property="usiSei" />&nbsp;<bean:write name="selUserMdl" property="usiMei" /></span>
            </a>
            <!-- 役職 -->
        ...
        <tr class="td_type1 <%= String.valueOf(back) %>" style="font-size:90%;" id="<bean:write name="selUserMdl2" property="usrSid" />">
          ...
          <!-- 氏名 -->
            <a href="#" onclick="moveUserButton('230_abovearrow2', '<bean:write name="selUserMdl2" property="usrSid" />');">
              <span class="normal_link <logic:equal name="selUserMdl2" property="usrUkoFlg" value="1">mukouser</logic:equal>"><bean:write name="selUserMdl2" property="usiSei" />&nbsp;<bean:write name="selUserMdl2" property="usiMei" /></span>
            </a>
            <!-- 役職 -->
