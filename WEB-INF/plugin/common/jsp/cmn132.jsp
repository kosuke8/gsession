...
<!--   </table> -->
    ...
    <td align="left" class="td_wt" width="100%"><span class="text_base  <logic:equal name="cmn132Form" property="cmn132owner.usrUkoFlg" value="1">mukouser</logic:equal>"><bean:write name="cmn132Form" property="cmn132owner.usiSei" />&nbsp<bean:write name="cmn132Form" property="cmn132owner.usiMei" /></span></td>
    </tr>
    </logic:equal>
    <tr>
        ...
        <logic:notEmpty name="cmn132Form" property="cmn131knMemberList" scope="request">
          ...
          <table class="tl0" boreder="0" width="100%">
            ...
            <logic:iterate id="memMdl" name="cmn132Form" property="cmn131knMemberList" scope="request">
              <tr>
                <td class="td_type1">
                  <span class="text_base <logic:equal name="memMdl" property="usrUkoFlg" value="1">mukouser</logic:equal>">
                ...
                <td class="td_type1">
                    <logic:notEmpty name="memMdl" property="belongGrpList">
                      <logic:iterate id="grp" name="memMdl" property="belongGrpList">
                        <div class="text_base  <logic:equal name="memMdl" property="usrUkoFlg" value="1">mukouser</logic:equal>"><bean:write name="grp" property="groupName"/></div>
                      </logic:iterate>
                    </logic:notEmpty>
                </td>
