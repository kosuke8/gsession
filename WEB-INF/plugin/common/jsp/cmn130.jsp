  ...
  <td align="left">
    ...
    <logic:notEmpty name="cmn130Form" property="cmn130SharedGroupList" scope="request">
      ...
      <logic:notEqual name="mod" value="<%= String.valueOf(idx.intValue() % 2) %>">
        ...
        <td nowrap>
        <logic:equal name="grpMdl" property="owner.usrUkoFlg" value="0">
          <bean:define id="linkClass" value="sc_ttl_sat" />
        </logic:equal>
        <logic:notEqual  name="grpMdl" property="owner.usrUkoFlg" value="0">
          <bean:define id="linkClass" value="sc_ttl_sat mukouser" />
        </logic:notEqual>
        <a href="javascript:void(0)" onClick="return opnDetail('<bean:write name="grpMdl" property="mgpSid" />', '1');">
