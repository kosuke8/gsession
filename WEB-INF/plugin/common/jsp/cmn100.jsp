...
<% String tableWidth = "550"; %>
  ...
  <td align="center">
    ...
    <table width="<%= tableWidth %>" class="tl0" border="0" cellpadding="0">
    <span id="mukouserMessage" class="text_kakunin text_r2"><gsmsg:write key="cmn.cmn100.1" /></span>
    </table>
    </logic:notEqual>
    ...
    <table width="<%= tableWidth %>" class="tl0" border="0" cellpadding="0" >
    <span id="mukouserMessage" class="text_kakunin text_r2"><gsmsg:write key="cmn.cmn100.6" /></span>
    </table>
    </logic:equal>

    <table id="usrInfoTable" width="<%= tableWidth %>" class="tl0" border="0" cellpadding="0">
    <tr>
    ...
    <td rowspan="4" colspan="2" class="td_type1" align="center">
    ...
    <logic:notEqual name="cmn100Form" property="cmn100usiBdateKf" value="<%= close %>"><span class="text_r1">
    <tr>
    ...
    <% if (addressRow != 1) { %>
        ...
        <td rowspan="<%= addressRow %>" class="table_bg_A5B4E1">
        <span class="text_bb1"><gsmsg:write key="cmn.address" />
        </td>
 ...
 <table width="<%= tableWidth %>" class="tl0" border="0" cellpadding="0">
    ...
    <tr>
    <td width="50%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
    <td width="25%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
    <td width="25%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
    </tr>

    <tr>
    <td align="left" class="td_type5" colspan="1">
      <div id="title"><span id="lt" class="text_tl2"><gsmsg:write key="cmn.affiliation.group" /></span></div>
    </td>
    <td align="center" colspan="1" class="td_type5">
      <p class="text_kakunin"><gsmsg:write key="user.35" /></p>
    </td>
    <td align="center" class="td_type5" colspan="1">
      <p class="text_kakunin"><gsmsg:write key="cmn.group.admin" /></p>
    </td>
    </tr>
    ...
    <logic:iterate id="group" name="cmn100Form" property="cmn100grpNmlist" indexId="idx" scope="request">
      ...
      <td colspan="1" align="left" class="<bean:write name="tblColor" />">
        <bean:write name="groupMdl" property="groupName" />
      </td>
      <td colspan="1" align="center" class="<bean:write name="tblColor" />">
        <logic:equal name="group" property="defaultGroupSid" value="1">
        <div><img src="../common/images/groupicon.gif" alt="<gsmsg:write key="user.35" />"></div>
        </logic:equal>
      </td>
      <td colspan="1" align="center" class="<bean:write name="tblColor" />">
        <logic:equal name="groupMdl" property="grpKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.USER_ADMIN) %>">
        <div><img src="../common/images/key.gif" alt="<gsmsg:write key="cmn.admin" />"></div>
        </logic:equal>
      </td>
      </tr>
    </logic:iterate>
  ...
  <logic:notEqual name="cmn100Form" property="cmn100QrDispKbn" value="0" >
    <table width="<%= tableWidth %>" class="tl0" border="0" cellpadding="0">
      <tr>
      <td width="40%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
      <td width="30%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
      <td width="30%"><img src="../common/images/spacer.gif" width="20px" height="5px" border="0"></td>
      </tr>
      <tr>
      <td align="left" class="td_type5" colspan="3">
          <div id="title"><span id="lt" class="text_tl2"><gsmsg:write key="cmn.cmn100.4" /></span></div>
      </td>
      </tr>

      <tr>
      <td colspan="3" align="center" class="td_type1">
