...
public class GSConstCommon {
    ...
    public static final int FILE_UPLOAD_MODE_EDITOR = 7;
    ...
    /** GSモバイル 携帯 リンク 表示する */
    public static final int MOBILE_LINK_ON = 0;
    /** GSモバイル 携帯 リンク 表示しない */
    public static final int MOBILE_LINK_OFF = 1;
    /** GSモバイル スマートフォン リンク 表示する */
    public static final int SMARTPHONE_LINK_ON = 0;
    /** GSモバイル スマートフォン リンク 表示しない */
    public static final int SMARTPHONE_LINK_OFF = 1;
    /** CrossRide リンク 表示する */
