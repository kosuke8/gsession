...
public class Cmn131Form extends AbstractGsForm {
    ...
    /** グループコンボ */
    private List<LabelValueBean> cmn131GpLabelList__ = null;
    /** 現在選択中のメンバーコンボ */
    private List<UsrLabelValueBean> cmn131MbLabelList__ = null;
    /** 追加用メンバーコンボ */
    private List<UsrLabelValueBean> cmn131AdLabelList__ = null;
    /** 追加参照権限 グループコンボ */
    private List<LabelValueBean> cmn131refGpLabelList__ = null;
    /** 追加参照権限 選択グループのメンバーコンボ */
    private List<UsrLabelValueBean> cmn131refMbLabelList__ = null;
    /** 追加参照権限 追加用メンバーコンボ */
    private List<UsrLabelValueBean> cmn131refAdLabelList__ = null;
...
//        GSValidateCommon.validateMember(errors, cmn131userSid__);
     ...
     */
    public List<LabelValueBean> getCmn131GpLabelList() {
     ...
     */
    public void setCmn131GpLabelList(List<LabelValueBean> cmn131GpLabelList) {
     ...
     */
    public List<UsrLabelValueBean> getCmn131AdLabelList() {
     ...
     */
    public void setCmn131AdLabelList(List<UsrLabelValueBean> cmn131AdLabelList) {
     ...
     */
    public List<LabelValueBean> getCmn131refGpLabelList() {
    ...
    public void setCmn131refGpLabelList(
            List<LabelValueBean> cmn131refGpLabelList) {
     ...
     */
    public List<UsrLabelValueBean> getCmn131refAdLabelList() {
    ...
    public void setCmn131refAdLabelList(
            List<UsrLabelValueBean> cmn131refAdLabelList) {
