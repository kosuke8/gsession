...
public class Cmn120Biz {
    ...
    throws SQLException {
        ...
        if (cmn120Model.getCmn120DspKbn() == 0) {
            ...
            for (LabelValueBean lv : allGrpLabelList) {
                if (banGrpSids.contains(lv.getValue())) {
            ...
            if (cmn120Model.getCmn120DspKbn() == 1) {
                ...
                //回覧板アカウントのみ設定
                if (dao.selectCirAccountCnt(null) > 0) {
        ...
        List<UsrLabelValueBean> rightList
        ...
        if (cmn120Model.getCmn120DspKbn() == 0 || cmn120Model.getCmn120DspKbn() == 1) {
            ...
            Map<Integer, UsrLabelValueBean> userLabelMap
            = new HashMap<Integer, UsrLabelValueBean>();
     ...
     * @throws SQLException SQL実行時例外
     */
    private List<UsrLabelValueBean> __getOtherSelUsr(
            Connection con, String[] users) throws SQLException {

        List<UsrLabelValueBean> selUsrInf = new ArrayList<UsrLabelValueBean>();
        Cmn120Dao dao = new Cmn120Dao(con);
