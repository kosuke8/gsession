...
public class Cmn001ParamModel extends AbstractParamModel {
    ...
    /** GSモバイル 携帯 リンク表示フラグ(ZION) */
    private int cmn001MobileLinkFlg__ = GSConstCommon.MOBILE_LINK_ON;
    /** GSモバイル スマートフォン リンク表示フラグ(ZION) */
    private int cmn001SmartPhoneLinkFlg__ = GSConstCommon.SMARTPHONE_LINK_ON;
    /** CrossRide リンク表示フラグ(ZION) */
    private int cmn001CrossRideLinkFlg__ = GSConstCommon.CROSSRIDE_LINK_ON;
    /** アプリ リンク表示フラグ(ZION) */
    private int cmn001AppLinkFlg__ = GSConstCommon.APP_LINK_ON;
    ...
    /**
     * <p>cmn001MobileLinkFlg を取得します。
     * @return cmn001MobileLinkFlg
     */
    public int getCmn001MobileLinkFlg() {
        return cmn001MobileLinkFlg__;
    }
    /**
     * <p>cmn001MobileLinkFlg をセットします。
     * @param cmn001MobileLinkFlg cmn001MobileLinkFlg
     */
    public void setCmn001MobileLinkFlg(int cmn001MobileLinkFlg) {
        cmn001MobileLinkFlg__ = cmn001MobileLinkFlg;
    }
    /**
     * <p>cmn001SmartPhoneLinkFlg を取得します。
     * @return cmn001SmartPhoneLinkFlg
     */
    public int getCmn001SmartPhoneLinkFlg() {
        return cmn001SmartPhoneLinkFlg__;
    }
    /**
     * <p>cmn001SmartPhoneLinkFlg をセットします。
     * @param cmn001SmartPhoneLinkFlg cmn001SmartPhoneLinkFlg
     */
    public void setCmn001SmartPhoneLinkFlg(int cmn001SmartPhoneLinkFlg) {
        cmn001SmartPhoneLinkFlg__ = cmn001SmartPhoneLinkFlg;
    }
    /**
     * <p>cmn001CrossRideLinkFlg を取得します。
     * @return cmn001CrossRideLinkFlg
     */
    public int getCmn001CrossRideLinkFlg() {
        return cmn001CrossRideLinkFlg__;
    }
    /**
     * <p>cmn001CrossRideLinkFlg をセットします。
     * @param cmn001CrossRideLinkFlg cmn001CrossRideLinkFlg
     */
    public void setCmn001CrossRideLinkFlg(int cmn001CrossRideLinkFlg) {
        cmn001CrossRideLinkFlg__ = cmn001CrossRideLinkFlg;
    }
    /**
     * <p>cmn001AppLinkFlg を取得します。
     * @return cmn001AppLinkFlg
     */
    public int getCmn001AppLinkFlg() {
        return cmn001AppLinkFlg__;
    }
    /**
     * <p>cmn001AppLinkFlg をセットします。
     * @param cmn001AppLinkFlg cmn001AppLinkFlg
     */
    public void setCmn001AppLinkFlg(int cmn001AppLinkFlg) {
        cmn001AppLinkFlg__ = cmn001AppLinkFlg;
    }
