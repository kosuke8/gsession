...
public class Cmn131Biz {
    ...
    throws SQLException {
        ...
        cmn131Model.setCmn131MbLabelList(labelListSelect);
        ...
        ArrayList<UsrLabelValueBean> labelListAdd = new ArrayList<UsrLabelValueBean>();
        ...
        if (refGpSid == GSConstCommon.GRP_SID_GRPLIST) {
            ...
            ArrayList<UsrLabelValueBean> grpLabelListAdd = new ArrayList<UsrLabelValueBean>();
            ...
            for (GroupModel bean : allGpList) {
                if (!fullGrepList.contains(String.valueOf("G" + bean.getGroupSid()))) {
                    grpLabelListAdd.add(new UsrLabelValueBean(
            ...
            ArrayList<UsrLabelValueBean> refLabelListAdd = new ArrayList<UsrLabelValueBean>();
            for (int i = 0; i < refUsList.size(); i++) {
                CmnUsrmInfModel cuiMdl = refUsList.get(i);
                refLabelListAdd.add(new UsrLabelValueBean(cuiMdl));
            }
