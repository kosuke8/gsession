...
public class Cmn120ParamModel extends AbstractParamModel {
    ...
    /** 追加用ユーザ一覧 */
    private List<UsrLabelValueBean> cmn120LeftUserList__ = null;
    /** 追加済みユーザ一覧 */
    private List<UsrLabelValueBean> cmn120RightUserList__ = null;
    /** グループdisabledフラグリスト*/
     ...
     */
    public List<UsrLabelValueBean> getCmn120LeftUserList() {
        return cmn120LeftUserList__;
    }
    /**
     * @param cmn120LeftUserList 設定する cmn120LeftUserList。
     */
    public void setCmn120LeftUserList(List<UsrLabelValueBean> cmn120LeftUserList) {
        cmn120LeftUserList__ = cmn120LeftUserList;
    }
    /**
     * @return cmn120RightUserList を戻します。
     */
    public List<UsrLabelValueBean> getCmn120RightUserList() {
        return cmn120RightUserList__;
    }
    /**
     * @param cmn120RightUserList 設定する cmn120RightUserList。
     */
    public void setCmn120RightUserList(List<UsrLabelValueBean> cmn120RightUserList) {
