...
public class CommonBiz {
     ...
     */
    public String getTempDirID(String rootDir, String pluginId, RequestModel reqMdl)
            throws IOToolsException {
        String sessionId = null;
        if (reqMdl != null && reqMdl.getSession() != null) {
            sessionId = reqMdl.getSession().getId();
        }
        return getTempDirID(rootDir, pluginId, sessionId);
    }
     ...
     * @throws IOToolsException IOエラー
     */
    public String getTempDirID(String rootDir, String pluginId, String sessionId)
            throws IOToolsException {
        String tmpPath = null;
        String uuidStr = null;
        ...
        for (int i = 0; i < 3; i++) {
            ...
            tmpPath = getTempDir(rootDir, pluginId, sessionId, uuidStr);
    ...
    public String getTempDir(String rootDir, String pluginId,
        ...
        return getTempDir(rootDir, pluginId, sessionId, tempDirId);
    }
    /**
     * <br>[機  能] テンポラリディレクトリパスを取得する
     * <br>[解  説]
     ...
     */
    public String getTempDir(String rootDir, String pluginId,
            String sessionId, String tempDirId) {
    ...
    public String getTempDir(String rootDir, String pluginId, RequestModel reqMdl) {
        ...
        */
        ...
        return getTempDir(rootDir, pluginId, sessionId);
    }
    /**
     * <br>[機  能] テンポラリディレクトリパスを取得する
     * <br>[解  説]
     ...
     * @return テンポラリディレクトリパス
     */
    public String getTempDir(String rootDir, String pluginId, String tempDirId) {
        String savePath = "";
...
//        tempDir.append(GSConst.FILE_SAVE_DIR);
     ...
     * @throws IOToolsException
     */
    public int deleteAllLogicalDeletedBinInf(Connection con, String rootPath) throws SQLException, IOToolsException {
        ...
        for (int i = 0; i < cbList.size(); i++) {
            ...
            deleteFile(cbMdl, rootPath);

        }
        ITempFileUtil tempFileUtil
        = (ITempFileUtil) GroupSession.getContext().get(GSContext.TEMP_FILE_UTIL);

        count = tempFileUtil.deleteAllLogicalDeletedBinInf(con);
        return count;
    }
