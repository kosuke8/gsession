...
public class Man280Biz {
    ...
    throws SQLException {
        ...
        if (forumSltGp == Man280Form.GRP_SID_GRPLIST) {
            ...
            for (int i = 0; i < usList.size(); i++) {
                ...
                labelListAdd.add(new UsrLabelValueBean(cuiMdl));
            }
        }
        ...
        if (!paramMdl.getMan120pluginId().equals(GSConst.PLUGINID_MAIN)) {
            ...
            List<UsrLabelValueBean> labelListAddAdmin = new ArrayList<UsrLabelValueBean>();
            ...
            if (adminSltGp == Man280Form.GRP_SID_GRPLIST) {
                ...
                for (GroupModel bean : allGpList) {
                    ...
                    if (!fullGrepList.contains(String.valueOf("G" + bean.getGroupSid()))) {
                        labelListAddAdmin.add(new UsrLabelValueBean(
                                bean.getGroupName(), String.valueOf("G" + bean.getGroupSid())));
                    }
                }
     ...
     */
    private ArrayList<UsrLabelValueBean> __getMemberList(Man280ParamModel paramMdl, Connection con)
    throws SQLException {

        //取得するユーザSID・グループSID
        String[] leftFull = paramMdl.getMan280memberSid();
        UserGroupSelectBiz usrSelBiz = new UserGroupSelectBiz();
        return usrSelBiz.getSelectedLabel(leftFull, con);
    }
     ...
     * @throws SQLException SQL実行時例外
     */
    private ArrayList<UsrLabelValueBean> __getAdminList(Man280ParamModel paramMdl, Connection con)
    throws SQLException {
