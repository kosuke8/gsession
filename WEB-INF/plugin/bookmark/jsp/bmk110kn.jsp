...
<td width="100%" align="center">
  ...
  <td>
    ...
    <logic:equal name="bmk110knForm" property="bmk110PubEditKbn" value="<%= String.valueOf(jp.groupsession.v2.bmk.GSConstBookmark.EDIT_POW_USER) %>">
        ...
        <logic:notEmpty name="bmk110knForm" property="bmk110RightUserList">
          <logic:iterate id="user" name="bmk110knForm" property="bmk110RightUserList">
              ...
              <span class="<%=mukouserClass%> %>" style="padding-left:10px"><bean:write name="user" property="label" /></span><br>
          </logic:iterate>
        </logic:notEmpty>
