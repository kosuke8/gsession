      ...
      <logic:iterate id="resultMdl" name="bmk070Form" property="bmk070ResultList" indexId="idx">
          ...
          <td class="<%= tdColor %>" width="0%" nowrap>
            ...
            <tr>
               ...
               <logic:equal name="resultMdl" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
               <td class="td_type20" valign="top" align="center"><a href="javaScript:void(0);" onClick="openUserInfoWindow(<bean:write name="resultMdl" property="usrSid" />);"><span class="<%=mukouserClass%>"><bean:write name="resultMdl" property="usrName" /></span></a>&nbsp;</td>
            </tr>
            <tr>
