...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt">
         ...
         <logic:iterate id="user" name="sml390Form" property="sml390sbdTargetSelectCombo">
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukoclass">&nbsp;</bean:define>
            <logic:equal name="user" property="usrUkoFlg" value="1">
                <bean:define id="mukoclass">mukouser_option</bean:define>
            </logic:equal>
            <html:option styleClass="<%=mukoclass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
         </logic:iterate>
         </logic:notEmpty>
         ...
         <logic:iterate id="user" name="sml390Form" property="sml390sbdTargetNoSelectCombo">
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukoclass">&nbsp;</bean:define>
            <logic:equal name="user" property="usrUkoFlg" value="1">
                <bean:define id="mukoclass">mukouser_option</bean:define>
    ...
    <td align="left" class="td_wt">
         ...
         <logic:iterate id="user" name="sml390Form" property="sml390sbpTargetSelectCombo">
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukoclass">&nbsp;</bean:define>
            <logic:equal name="user" property="usrUkoFlg" value="1">
                <bean:define id="mukoclass">mukouser_option</bean:define>
         ...
         <logic:iterate id="user" name="sml390Form" property="sml390sbpTargetNoSelectCombo">
            <bean:define id="userValue" name="user" property="value" />
            <bean:define id="mukoclass">&nbsp;</bean:define>
            <logic:equal name="user" property="usrUkoFlg" value="1">
                <bean:define id="mukoclass">mukouser_option</bean:define>
