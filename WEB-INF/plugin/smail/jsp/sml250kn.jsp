   ...
   --%>
      <logic:notEmpty name="sml250knForm" property="userKbnUserSelectCombo">
        <ul>
          ...
          <li><span class="<bean:write name="usrLabelClass"/>" ><bean:write name="userKbnLabel" property="label" /></span></li>
          </logic:iterate>
        </ul>
      </logic:notEmpty>
...
<!-- 対象 -->
    ...
    <br>
      <logic:iterate id="okUser" name="sml250knForm" property="sml250knUsrOkLabelList">
        ...
        <span class="text_base <bean:write name="usrLabelClass" />"><bean:write name="okUser"  property="label"/></span><br>
      </logic:iterate>
      <span class="text_base">(<bean:write name="sml250knForm" property="sml250knUsrCnt" />&nbsp;<gsmsg:write key="cmn.user" />)</span>
    </logic:notEmpty>
    </logic:equal>
    ...
    <br>
      <logic:iterate id="ngUser" name="sml250knForm" property="sml250knUsrNgLabelList">
        ...
        <span class="text_base <bean:write name="usrLabelClass" />"><bean:write name="ngUser" property="label"/></span><br>
      </logic:iterate>
