            ...
            <tr>
              <td class="td_type1">
                ...
                <html:select name="sml250Form" property="sml250userKbnUserSelect" size="11" styleClass="smail_select01" multiple="true">
                  ...
                  <logic:iterate id="user" name="sml250Form" property="userKbnUserSelectCombo">
                    <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>" ><bean:write name="user" property="label" /></option>
                  </logic:iterate>
                  </logic:notEmpty>
                </html:select>
              </td>
              ...
              <td class="td_type1">
                ...
                <html:select name="sml250Form" property="sml250userKbnUserNoSelect" size="9" styleClass="smail_select01" multiple="true">
                  ...
                  <logic:iterate id="user" name="sml250Form" property="userKbnUserNoSelectCombo">
                    <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>" ><bean:write name="user" property="label" /></option>
                  </logic:iterate>
                  </logic:notEmpty>
                </html:select>
...
--%>
      ...
      <td>
        <html:select property="sml250selectUserSid" size="6" multiple="true" styleClass="select01">
          <logic:notEmpty name="sml250Form" property="sml250MbLabelList">
          <logic:iterate id="user" name="sml250Form" property="sml250MbLabelList">
             <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>" ><bean:write name="user" property="label" /></option>
          </logic:iterate>
          </logic:notEmpty>
          <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
      ...
      <td align="center">
        <html:select property="sml250addUserSid" size="6" multiple="true" styleClass="select01">
          <logic:iterate id="user" name="sml250Form" property="sml250AdLabelList">
            <option value="<bean:write name="user" property="value"/>" class="<logic:equal name="user" property="usrUkoFlg" value="1">mukouser_option</logic:equal>" ><bean:write name="user" property="label" /></option>
          </logic:iterate>
          <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
        </html:select>
                  ...
                  <div id="atesaki_area" style="width: 370px" class="atesaki_scroll_area">
                    ...
                    <logic:iterate id="user" name="sml250Form" property="sml250AutoDestToLabelList">
                        <div class="atesaki_to_user" id="0">
                            ...
                            <span class="<bean:write name="mukoclass"/>"><bean:write name="user" property="label" /></span>&nbsp;&nbsp;[<span class="add_usr_del">削除</span>]
                        </div>
                    </logic:iterate>
                    </logic:notEmpty>
                    </div>
