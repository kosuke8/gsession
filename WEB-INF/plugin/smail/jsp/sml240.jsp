...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="prj_td">
      <a href="#" onClick="return editAccount(<%= String.valueOf(jp.groupsession.v2.sml.GSConstSmail.CMDMODE_EDIT) %>, <bean:write name="accountData" property="accountSid" />);"><span class="text_link <%=mukouserClass %>"><bean:write name="accountData" property="accountName" /></span></a>
    </td>
    <td align="left" class="prj_td">
