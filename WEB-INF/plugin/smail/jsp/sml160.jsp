  ...
  <td>
    ...
    <td align="left" class="td_wt" width="100%">
      ...
      <div id="accountSelArea">
        ...
        <span id="selAccountNameArea"><bean:write name="sml160Form" property="sml160AccountName" /></span>
        </logic:notEmpty>
        <input id="accountSelBtn" type="button" name="btn_add" class="btn_base1_3" value="<gsmsg:write key="wml.102" /><gsmsg:write key="cmn.select" />" ></div>
    </td>
    </tr>
