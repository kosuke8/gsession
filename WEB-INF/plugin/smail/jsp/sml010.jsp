...
<script language="JavaScript" src="../smail/js/message/sml010.jsp?<%= GSConst.VERSION_PARAM %>"></script>
          ...
          <html:select property="smlViewAccount" styleId="account_comb_box" styleClass="text_base account_select">
            <logic:notEmpty name="sml010Form" property="sml010AccountList">
              <logic:iterate id="accountMdl" name="sml010Form" property="sml010AccountList">
                ...
                <bean:define id="optClass" value="mukouser_option" />
                </logic:equal>
                <bean:define id="optClass" value="" />
                <logic:equal name="accountMdl" property="usrUkoFlg" value="1">
                <bean:define id="optClass" value="mukouser_option" />
          ...
          <logic:notEmpty name="sml010Form" property="sml010AccountList">
            ...
            <logic:iterate id="accountMdl" name="sml010Form" property="sml010AccountList">
              <logic:notEqual name="accountMdl" property="accountSid" value="<%= String.valueOf(viewAccoutVal) %>">
                <div class="account_sel_txt <logic:equal name="accountMdl" property="usrUkoFlg" value="1">mukouser</logic:equal>" id="<bean:write name="accountMdl" property="accountSid" />"><bean:write name="accountMdl" property="accountName" /></div>
              </logic:notEqual>
            </logic:iterate>
          </logic:notEmpty>
        </div>
          ...
          <logic:iterate id="usrList" name="sml010Form" property="sml010userList" >
            ...
            <logic:equal name="usrList" property="usiPictKf" value="0">
              ...
              <logic:notEmpty name="usrList" property="sacSid">
                ...
                <a class="syain_sel_check_txt syain_sel_txt" id="sac<bean:write name="usrList" property="sacSid" />">
              </logic:notEmpty>
              <logic:empty name="usrList" property="sacSid">
                ...
                <a class="syain_sel_check_txt syain_sel_txt <logic:equal name="usrList" property="usrUkoFlg" value="1">mukouser</logic:equal>" id="<bean:write name="usrList" property="usrSid" />">
              </logic:empty>

              <logic:equal name="sml010Form" property="photoDspFlg" value="0">
                <logic:equal name="usrList" property="binSid" value="0">
                  <img src="../user/images/photo.gif" name="userImage" onload="initImageView50('userImage<bean:write name="usrList" property="usrSid"/>')" alt="<gsmsg:write key="cmn.photo" />" border="1" width="25px" class="img_bottom"/>
                </logic:equal>
                <logic:notEqual name="usrList" property="binSid" value="0">
                  <img src="../common/cmn100.do?CMD=getImageFile&cmn100binSid=<bean:write name="usrList" property="binSid"/>" name="userImage" onload="initImageView50('userImage<bean:write name="usrList" property="usrSid"/>')" alt="<gsmsg:write key="cmn.photo" />" border="1" width="25px" height="28px" class="img_bottom"/>
                </logic:notEqual>
              </logic:equal>
            ...
            <logic:notEqual name="usrList" property="usiPictKf" value="0">
              ...
              <logic:equal name="sml010Form" property="photoDspFlg" value="0">
                <span style="color:#fc2929;display:inline-block;text-align:center;vertical-align:text-bottom;cursor:pointer;" class="photo_hikokai4 syain_sel_check_img"><gsmsg:write key="cmn.private.photo" /></span>
              </logic:equal>

              <a id=<bean:write name="usrList" property="usrSid"/> style="vertical-align:middle" class="syain_sel_check_txt syain_sel_txt <logic:equal name="usrList" property="usrUkoFlg" value="1">mukouser</logic:equal>">
              <bean:write name="usrList" property="usiSei" />&nbsp;<bean:write name="usrList" property="usiMei" /></a>
            </logic:notEqual>
        ...
        <table class="clear_table mail_create_area display_none" width="100%" cellpadding="0" cellspacing="0">
          ...
          <td class="mail_create_sel_send">
            ...
            <div class="clear_div" style="float:left;">
              <input type="text" name="sml020Title" maxlength="<%= maxLengthTitle %>" style="width:581px;" value="" class="text_base">
            </div>
            ...
            <td class="mail_create_sel_send mail_create_sel_send_bottom">
              ...
              <tr>
                ...
                <td width="100%" align="left" valign="middle">
                  ...
                  <input type="button" class="btn_delete" value="<gsmsg:write key="cmn.delete" />" name="dellTmpBtn">
                </td>
              </tr>
              </table>
        ...
        <table width="100%" class="mail_create_area display_none" cellpadding="0" cellspacing="0" style="clear:both;">
          ...
          <tr>
            ...
            <div class="mail_create_sel_send_title_body"><gsmsg:write key="cmn.body" /><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></div>
              ...
              <div id="text_input_area"><textarea id="text_input" class="html_text_input sml_textarea" name="sml020Body" rows="20" wrap="soft" onkeyup="showLengthStr(value, <%= maxLengthText %>, 'inputlength');" id="inputstr"></textarea></div>

              <div id="text_count_area" align="right" style="padding-right:5px;">
              <span class="font_string_count">現在の文字数:</span><span id="inputlength" class="font_string_count">0</span>&nbsp;<span class="font_string_count_max">/&nbsp;<%= maxLengthText %>&nbsp;文字</span>
              </div>
        ...
        <table class="clear_table mail_kakunin_area display_none" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="mail_check_body_bottom">
              <a class="mail_check_body_bottom_pdf" href="javascript:void(0);" "><span class="mail_check_body_bottom_txt"><gsmsg:write key="wml.237" /></span></a>
              <a class="mail_check_body_bottom_eml" href="javascript:void(0);" "><span class="mail_check_body_bottom_txt">eml形式でエクスポート</span></a>
            </td>
          </tr>
