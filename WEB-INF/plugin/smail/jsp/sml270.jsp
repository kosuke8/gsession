...
<td width="100%" align="center">
  ...
  <tr><td>
    ...
    <logic:iterate id="acuntData" name="sml270Form" property="accountList">
      ...
      <logic:equal name="acuntData" property="usrUkoFlg" value="1"><bean:define id="mukouserClass"  >mukouser</bean:define></logic:equal>
      <tr>
      <td align="center" class="smail_td1" nowrap><html:radio property="sml270sortAccount" value="<%= String.valueOf(acValue) %>" /></td>
      <td align="left" class="smail_td1"><span class="text_base <%=mukouserClass %>"><bean:write name="acuntData" property="accountName" /></span></td>
