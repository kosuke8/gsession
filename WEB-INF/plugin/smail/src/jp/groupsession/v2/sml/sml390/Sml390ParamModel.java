...
public class Sml390ParamModel extends Sml380ParamModel {
    ...
    private List<UsrLabelValueBean> sml390sbdTargetNoSelectCombo__  = null;
    /** 禁止送信先 アカウント */
    ...
    /** 許可ユーザ 未選択コンボ */
    private List<UsrLabelValueBean> sml390sbpTargetNoSelectCombo__  = null;
    /** 役職 */
     ...
     */
    public List<UsrLabelValueBean> getSml390sbpTargetNoSelectCombo() {
    ...
    public void setSml390sbpTargetNoSelectCombo(
            List<UsrLabelValueBean> sml390sbpTargetNoSelectCombo) {
     ...
     */
    public List<UsrLabelValueBean> getSml390sbdTargetNoSelectCombo() {
    ...
    public void setSml390sbdTargetNoSelectCombo(
            List<UsrLabelValueBean> sml390sbdTargetNoSelectCombo) {
