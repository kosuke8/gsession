      ...
      <td valign="middle" align="left" class="td_wt" width="100%">
        ...
        <td>
          <html:select property="ptl050accessKbnRead" size="13" style="width:220px;" styleClass="select01" multiple="true">
            ...
            <logic:iterate id="user" name="ptl050Form" property="ptl050LeftUserList">
              <bean:define id="usrValue" ><bean:write name="user" property="value"/></bean:define>
              <bean:define id="mukouserClass" value="" />
              <logic:equal value="1" name="user" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%= mukouserClass %>" value="<%= usrValue %>"><bean:write name="user" property="label"/></html:option>
            </logic:iterate>
            </logic:notEmpty>
          </html:select>
        </td>
        ...
        <html:select property="ptl050SelectRightUser" size="13" style="width:220px;" styleClass="select01" multiple="true">
          <logic:notEmpty name="ptl050Form" property="ptl050RightUserList">
            <logic:iterate id="user" name="ptl050Form" property="ptl050RightUserList">
              <bean:define id="usrValue" ><bean:write name="user" property="value"/></bean:define>
              <bean:define id="mukouserClass" value="" />
              <logic:equal value="1" name="user" property="usrUkoFlg"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%= mukouserClass %>" value="<%= usrValue %>"><bean:write name="user" property="label"/></html:option>
