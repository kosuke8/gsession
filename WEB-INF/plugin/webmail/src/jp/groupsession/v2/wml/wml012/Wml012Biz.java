...
public class Wml012Biz extends Wml010Biz {
     ...
     */
    public Wml012ParamModel getInitData(Connection con, RequestModel reqMdl,
                                        String tempRootDir, String tempDirId)
        throws SQLException, IOToolsException {

        Wml010Biz wml010Biz = new Wml010Biz();
        String tempDir = wml010Biz.getSendTempDir(tempRootDir, reqMdl, tempDirId);
    ...
    public void saveSendMailData(Wml012ParamModel paramMdl,
                                    RequestModel reqMdl, String tempRootDir, String tempDirId)
