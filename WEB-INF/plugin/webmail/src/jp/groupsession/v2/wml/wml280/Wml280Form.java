...
public class Wml280Form extends Wml270Form {
    ...
    /** アクセス権限 未選択コンボ */
    private List<UsrLabelValueBean> wml280accessNoSelectCombo__  = null;
     ...
     */
    public List<UsrLabelValueBean> getWml280accessNoSelectCombo() {
    ...
    public void setWml280accessNoSelectCombo(
            List<UsrLabelValueBean> wml280accessNoSelectCombo) {
