...
public class Wml012Action extends AbstractWebmailAction {
    ...
    public ActionForward __doInit(ActionMapping map, Wml012Form form,
        ...
        log__.info("WML PARAM: " + form.getWml012tempDirId());
        Wml012Biz biz = new Wml012Biz();
        Wml012ParamModel paramMdl = biz.getInitData(con, getRequestModel(req),
                                                    getTempPath(req), form.getWml012tempDirId());
        if (paramMdl != null) {
    ...
    public ActionForward __saveSendMailData(ActionMapping map, Wml012Form form,
        ...
        try {
            ...
            Wml012Biz biz = new Wml012Biz();
            biz.saveSendMailData(paramMdl, reqMdl, getTempPath(req), form.getWml012tempDirId());
            paramMdl.setFormData(form);
