...
public class Wml040Form extends Wml020Form {
    ...
    /** TOPコマンド 有効 */
    public static final int TOP_COMMAND_ENABLE = 0;
    /** TOPコマンド 無効 */
    public static final int TOP_COMMAND_DISABLE = 1;
    /** SMTP認証 OFF */
    ...
    /** アカウントID */
    private String wml040accountId__ = null;
    /** アカウント名 */
    ...
    /** 署名 自動挿入 */
    private int wml040signAuto__ = 0;
    /** 自動TO */
    ...
    /** TOPコマンド無効フラグ */
    private int wml040topCmd__ = TOP_COMMAND_ENABLE;
    /** SMTP認証ON/OFF */
    ...
    /** 代理人 ユーザ(未選択 選択用) コンボ */
    private List<UsrLabelValueBean> proxyUserNoSelectCombo__  = null;
    ...
    public ActionErrors validateCheck(Connection con, RequestModel reqMdl) throws Exception {
        ...
        //アカウントID入力チェック
        GSValidateWebmail.validateTextBoxInput(errors, wml040accountId__,
                "wml040accountId",
                gsMsg.getMessage(GSConstWebmail.TEXT_ACCOUNT_ID),
                GSConstWebmail.MAXLEN_ACCOUNT_ID, true);
        if (errors.isEmpty()) {
            if (!GSValidateUtil.isUseridFormat(wml040accountId__)) {
                //アカウントＩＤフォーマットチェック(ユーザIDと同じ)
                String textUserId = gsMsg.getMessage("wml.281");
                ActionMessage msg = new ActionMessage("error.input.format.text", textUserId);
                StrutsUtil.addMessage(errors, msg, "wml040accountId." + "error.input.format.text");
            } else {
                //重複チェック
                WmlAccountDao accountDao = new WmlAccountDao(con);
                if (accountDao.existAccount(wml040accountId__, getWmlAccountSid())) {
                    ActionMessage msg = new ActionMessage("error.select.dup.list",
                                        gsMsg.getMessage(GSConstWebmail.TEXT_ACCOUNT_ID));
                    StrutsUtil.addMessage(errors, msg,
                            "wml040accountId." + "error.select.dup.list");
                }
            }
        }
        ...
        */
        ...
        //署名自動挿入入力チェック
        GSValidateWebmail.validateRadioInput(
                reqMdl,
                errors,
                wml040signAuto__,
                "wml040signAuto",
                gsMsg.getMessage("wml.sign.auto"),
                new int[] {GSConstWebmail.WAC_SIGN_AUTO_INSERT,
        ...
        GSValidateWebmail.validateRadioInput(
                ...
                new int[] {GSConstWebmail.SIGN_POINT_TOP,
                                GSConstWebmail.SIGN_POINT_BOTTOM});
        ...
        GSValidateWebmail.validateRadioInput(
                ...
                new int[] {GSConstWebmail.SIGN_RECEIVE_NOT_DSP,
                                GSConstWebmail.SIGN_RECEIVE_DSP});
    ...
    /**
     * <p>wml040accountId を取得します。
     * @return wml040accountId
     */
    public String getWml040accountId() {
        return wml040accountId__;
    }
    /**
     * <p>wml040accountId をセットします。
     * @param wml040accountId wml040accountId
     */
    public void setWml040accountId(String wml040accountId) {
        wml040accountId__ = wml040accountId;
    }
    /**
     * <p>wml040name を取得します。
     * @return wml040name
    ...
    /**
     * <p>wml040signAuto を取得します。
     * @return wml040signAuto
     */
    public int getWml040signAuto() {
        return wml040signAuto__;
    }
    /**
     * <p>wml040signAuto をセットします。
     * @param wml040signAuto wml040signAuto
     */
    public void setWml040signAuto(int wml040signAuto) {
        wml040signAuto__ = wml040signAuto;
    }
    /**
    ...
    public void setHiddenParam(Cmn999Form msgForm) {
        ...
        msgForm.addHiddenParam("wml040accountId", getWml040accountId());
        ...
        msgForm.addHiddenParam("wml040topCmd", getWml040topCmd());
    ...
    /**
     * <p>wml040topCmd を取得します。
     * @return wml040topCmd
     */
    public int getWml040topCmd() {
        return wml040topCmd__;
    }
    /**
     * <p>wml040topCmd をセットします。
     * @param wml040topCmd wml040topCmd
     */
    public void setWml040topCmd(int wml040topCmd) {
        wml040topCmd__ = wml040topCmd;
    }
     ...
     */
    public List<UsrLabelValueBean> getProxyUserNoSelectCombo() {
    ...
    public void setProxyUserNoSelectCombo(
            List<UsrLabelValueBean> proxyUserNoSelectCombo) {
