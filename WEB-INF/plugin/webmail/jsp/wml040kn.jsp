...
<td width="100%" align="center">
  ...
  <td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="35%" nowrap><span class="text_bb1"><gsmsg:write key="wml.281" /></span></td>
    <td align="left" class="webmail_td1" width="65%">
    <bean:write name="wml040knForm" property="wml040accountId" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="wml.96" /></span></td>
      ...
      <logic:notEmpty name="wml040knForm" property="userKbnUserSelectCombo">
        <ul>
          <logic:iterate id="user" name="wml040knForm" property="userKbnUserSelectCombo">
              ...
              <li><span class="<%=mukouserClass%>"><bean:write name="user" property="label" /></span></li>
          </logic:iterate>
        </ul>
      </logic:notEmpty>
    </logic:notEqual>
