...
<td width="100%" align="center">
  ...
  <tr><td>
    ...
    <th align="center" class="table_bg_7D91BD" width="5%"><span class="text_tlw"><gsmsg:write key="wml.281" /></span></th>
    <th align="center" class="table_bg_7D91BD" width="25%"><span class="text_tlw"><gsmsg:write key="wml.96" /></span></th>
    <th align="center" class="table_bg_7D91BD" width="30%"><span class="text_tlw"><gsmsg:write key="cmn.mailaddress" /></span></th>
    ...
    <logic:iterate id="acuntData" name="wml100Form" property="accountList">
      ...
      <td align="left" class="smail_td1"><span class="text_base"><bean:write name="acuntData" property="accountUid" /></span></td>
