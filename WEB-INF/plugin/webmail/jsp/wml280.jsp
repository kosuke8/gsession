          ...
          <table width="99%">
            ...
            <tr>
              ...
              <td class="td_type1">
                ...
                <logic:equal name="destUserData" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
                <span class="text_base <%=mukouserClass%>"><bean:write name="destUserData" property="name" /></span>
...
-->
          ...
          <logic:notEmpty name="wml280Form" property="wml280accessFullSelectCombo">
            <logic:iterate id="user" name="wml280Form" property="wml280accessFullSelectCombo" >
          ...
          <logic:notEmpty name="wml280Form" property="wml280accessNoSelectCombo">
            <logic:iterate id="user" name="wml280Form" property="wml280accessNoSelectCombo" >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
          ...
          <logic:notEmpty name="wml280Form" property="wml280accessReadSelectCombo">
            <logic:iterate id="user" name="wml280Form" property="wml280accessReadSelectCombo" >
              <bean:define id="userValue" name="user" property="value" />
              <bean:define id="mukouserClass" value="" />
              <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
              <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
