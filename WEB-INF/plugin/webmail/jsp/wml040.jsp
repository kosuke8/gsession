...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table id="wml_settings" class="tl0" cellpadding="5" cellspacing="0" border="0" width="100%">
      <tr>
        <td class="table_bg_A5B4E1" width="250" nowrap><span class="text_bb1"><gsmsg:write key="wml.281" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></td>
        <td align="left" class="td_wt" width="750">
          <html:text name="wml040Form" property="wml040accountId" style="width:273px;" maxlength="<%= String.valueOf(GSConstWebmail.MAXLEN_ACCOUNT_ID) %>" />
        </td>
      </tr>
      <tr>
        <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="wml.96" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></td>
              ...
              <td class="td_type1">
                <html:select name="wml040Form" property="wml040userKbnUserSelect" size="11" styleClass="webmail_select01" multiple="true">
                  <logic:notEmpty name="wml040Form" property="userKbnUserSelectCombo">
                    <logic:iterate id="user" name="wml040Form" property="userKbnUserSelectCombo" >
              ...
              <td class="td_type1">
                ...
                <html:select name="wml040Form" property="wml040userKbnUserNoSelect" size="9" styleClass="webmail_select01" multiple="true">
                  <logic:notEmpty name="wml040Form" property="userKbnUserNoSelectCombo">
                    <logic:iterate id="user" name="wml040Form" property="userKbnUserNoSelectCombo" >
                      <bean:define id="userValue" name="user" property="value" />
                      <bean:define id="mukouserClass" value="" />
                      <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                      <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
              ...
              <td class="td_type1">
                <html:select name="wml040Form" property="wml040proxyUserSelect" size="11" styleClass="webmail_select01" multiple="true">
                  <logic:notEmpty name="wml040Form" property="proxyUserSelectCombo">
                    <logic:iterate id="user" name="wml040Form" property="proxyUserSelectCombo" >
                      <bean:define id="userValue" name="user" property="value" />
                      <bean:define id="mukouserClass" value="" />
                      <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                      <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
              ...
              <td class="td_type1">
                ...
                <html:select name="wml040Form" property="wml040proxyUserNoSelect" size="9" styleClass="webmail_select01" multiple="true">
                  <logic:notEmpty name="wml040Form" property="proxyUserNoSelectCombo">
                    <logic:iterate id="user" name="wml040Form" property="proxyUserNoSelectCombo" >
                      <bean:define id="userValue" name="user" property="value" />
                      <bean:define id="mukouserClass" value="" />
                      <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                      <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
    ...
    <table id="signSettings" class="tl0" cellpadding="5" cellspacing="0" border="0" width="100%">
      ...
      <tr>
        <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="wml.sign.auto" /></span></td>
        <td align="left" class="webmail_td1">
          ...
          &nbsp;<html:radio name="wml040Form" property="wml040signAuto" styleId="signAuto2" value="1" /><label for="signAuto2"><gsmsg:write key="wml.sign.auto.no" /></label>
        </td>
      </tr>
      ...
      <tr>
        <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="wml.278" /></span></td>
        <td align="left" class="webmail_td1">
          <html:radio name="wml040Form" property="wml040topCmd" styleId="topCmd1" value="0" /><label for="topCmd1"><gsmsg:write key="wml.279" /></label>
          &nbsp;<html:radio name="wml040Form" property="wml040topCmd" styleId="topCmd2" value="1" /><label for="topCmd2"><gsmsg:write key="wml.280" /></label>
        </td>
      </tr>
