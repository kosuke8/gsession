    ...
    <ul id="leftmenu">
      <li>
        ...
        <div>
          ...
          <div id="folder_list" style="width: 205px; padding-bottom:1px;">
            <div class="wrap">
              <div id="treewrapper">
                <div id="treediv"></div>
              </div>
...
「メール作成」タブを閉じてから再度実行してください。<br>
  ...
  <div id='dialog11'>
    <div class='hd'><gsmsg:write key="wml.wml010.36" /></div>
    <div class='bd'>
      <div class="width: 500px; margin-left: 20px; text-align: left!important;">
<span  class="text_bb1">
[<span id="msg_dialog11"></span>] を削除します。<br>
よろしいですか？<br>
</span>
<input type="hidden" name="wml010DelAttachParam" value="">
<input type="hidden" name="wml010DelAttachFileId" value="">
<input type="hidden" name="wml010DelAttachName" value="">
<input type="hidden" name="wml010DelAttachListKbn" value="">
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="../common/js/json2.js?<%= GSConst.VERSION_PARAM %>" charset="utf-8"></script>
