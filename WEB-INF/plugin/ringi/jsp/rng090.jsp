          ...
          <tr>
            ...
            <td width="100%" rowspan="2" align="left">
              <html:select property="rng090selectApprUser" size="10" styleClass="select02" multiple="true">
                ...
                <logic:iterate id="user" name="rng090Form" property="rng090apprUserList" >
          ...
          <tr>
            <td>
              <html:select property="rng090users" size="17" styleClass="select01" multiple="true">
                ...
                <logic:iterate id="user" name="rng090Form" property="rng090userList" >
                    <bean:define id="userValue" name="user" property="value" />
                    <bean:define id="mukouserClass" value="" />
                    <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                    <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
      ...
      <tr>
        <td align="left">
          <html:select property="rng090selectConfirmUser" size="5" styleClass="select01" multiple="true">
            ...
            <logic:iterate id="user" name="rng090Form" property="rng090confirmUserList"  >
                <bean:define id="userValue" name="user" property="value" />
                <bean:define id="mukouserClass" value="" />
                <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
