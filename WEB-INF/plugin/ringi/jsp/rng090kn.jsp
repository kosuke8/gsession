...
<logic:notEmpty name="rng090knForm" property="rng090FileLabelList" scope="request">
    ...
    <span class="text_base">
      ...
      <logic:iterate id="apprUser" name="rng090knForm" property="rng090knApprUserList">
        ...
        <span class="<%=mukouserClass%>"><bean:write name="apprUser" property="usiSei" />&nbsp;<bean:write name="apprUser" property="usiMei" /></span><br>
      </logic:iterate>
      </logic:notEmpty>
    </span>
    </td>
    ...
    <span class="text_base">
      ...
      <logic:iterate id="confirmUser" name="rng090knForm" property="rng090knConfirmUserList">
        ...
        <span class="<%=mukouserClass%>"><bean:write name="confirmUser" property="usiSei" />&nbsp;<bean:write name="confirmUser" property="usiMei" /></span><br>
      </logic:iterate>
      </logic:notEmpty>
    </span>
    </td>
