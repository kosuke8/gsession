...
<!-- 経路情報 --->
    ...
    <logic:iterate id="channelModel" name="rng020knForm" property="channelList" indexId="idx">
      ...
      <logic:equal name="channelModel" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
      <td valign="middle" align="left" class="td_wt" width="65%" nowrap><span class="text_base <%=mukouserClass%> %>" nowrap><bean:write name="channelModel" property="userName" /></span></td>
      </tr>
...
<!-- 確認 --->
    ...
    <logic:iterate id="confirmChannelModel" name="rng020knForm" property="confirmChannelList" indexId="indx">
      ...
      <bean:define id="mukouserClass" value="" />
      <logic:equal name="confirmChannelModel" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
      <td valign="middle" align="left" class="td_wt" width="65%" nowrap><span class="text_base <%=mukouserClass %>" nowrap><bean:write name="confirmChannelModel" property="userName" /></span></td>
      </tr>
      </logic:iterate>
    </logic:notEmpty>
