...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td>
    ...
    <td colspan="6" align="left" class="td_wt" width="100%">
    <logic:equal name="rng030Form" property="rng030apprUsrJkbn" value="9">
    <del><bean:write name="rng030Form" property="rng030apprUser" /></del>
    </logic:equal>
    <logic:notEqual name="rng030Form" property="rng030apprUsrJkbn" value="9">
    <bean:define id="mukouserClass" value="" />
    <logic:equal name="rng030Form" property="rng030apprUsrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
    <span class="<%=mukouserClass%>"><bean:write name="rng030Form" property="rng030apprUser" /></span>
    </logic:notEqual>
    </td>
    </tr>
    ...
    <% } %>
      ...
      <logic:equal name="apprUser" property="delUser" value="false">
        <bean:define id="mukouserClass" value="" />
        <logic:equal name="apprUser" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
    ...
    <% } %>
      ...
      <logic:equal name="confirmUser" property="delUser" value="false">
        <bean:define id="mukouserClass" value="" />
        <logic:equal name="confirmUser" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser" /></logic:equal>
        <span class="<%=mukouserClass%>" ><bean:write name="confirmUser" property="userName" /></span>
      </logic:equal>
      </td>
