          ...
          <tr>
            ...
            <td width="99%" rowspan="2" align="left">
              <html:select property="rng020selectApprUser" size="10" styleClass="select02" multiple="true">
                <logic:iterate id="user" name="rng020Form" property="rng020apprUserList">
          ...
          <tr>
            <td>
              <html:select property="rng020users" size="17" styleClass="select01" multiple="true">
                <logic:iterate id="user" name="rng020Form" property="rng020userList">
                <bean:define id="userValue" name="user" property="value" />
                <bean:define id="mukouserClass" value="" />
                <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
      ...
      <tr>
        <td align="left">
          <html:select property="rng020selectConfirmUser" size="5" styleClass="select01" multiple="true">
            <logic:iterate id="user" name="rng020Form" property="rng020confirmUserList" >
                <bean:define id="userValue" name="user" property="value" />
                <bean:define id="mukouserClass" value="" />
                <logic:equal name="user" property="usrUkoFlg" value="1"><bean:define id="mukouserClass" value="mukouser_option" /></logic:equal>
                <html:option styleClass="<%=mukouserClass %>" value="<%=String.valueOf(userValue) %>"><bean:write name="user" property="label" /></html:option>
