...
public class Rng020Biz {
    ...
    throws IOException, IOToolsException, SQLException, TempFileException {
        ...
        List<UsrLabelValueBean> addUserList
        ...
        List<UsrLabelValueBean> canUseAddUserList =
                new ArrayList<UsrLabelValueBean>(userSidList.length);
        for (UsrLabelValueBean addLabel : addUserList) {
