...
//        //ログインユーザSIDを取得
    ...
    private ActionForward __doConf(
        ...
        if (cirSid > 0) {
            ...
            if (ciMdl != null) {
                //出力内容
                String accountName = biz.getAccountName(paramMdl.getCirViewAccount(), con);
                StringBuilder sb = new StringBuilder();
                sb.append(textKakunin);
                sb.append("\n");
                sb.append("[title]");
                sb.append(ciMdl.getCifTitle());
                sb.append("\n");
                sb.append("[");
                ...
                cirBiz.outPutLog(map, reqMdl,
                        textEdit, GSConstLog.LEVEL_TRACE, sb.toString());
            }
        }
        //完了画面を表示
        ...
        if (cirSid > 0) {
            ...
            if (ciMdl != null) {
              ...
              sb.append(accountName);
                ...
                CirCommonBiz cirBiz = new CirCommonBiz(con);
                cirBiz.outPutLog(map, reqMdl,
                        textChange, GSConstLog.LEVEL_TRACE, sb.toString());
            }
        }
        //完了画面を表示
        return __setKanryoDsp(map, form, req);
