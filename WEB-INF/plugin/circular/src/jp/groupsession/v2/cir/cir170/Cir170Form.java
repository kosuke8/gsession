                ...
                for (CircularCsvModel accountData : accountList) {
                    ...
                    if (user1 && user2 && user3 && user4 && user5
                     && group1 && group2 && group3 && group4 && group5) {
                        ...
                        //グループ1
                        GSValidateCircular.validateCsvUserId(errors, accountData.getGroup1(),
                                                           "acntGroup1" + rowNum,
                        ...
                        //グループ2
                        GSValidateCircular.validateCsvUserId(errors, accountData.getGroup2(),
                                                           "acntGroup2" + rowNum,
                                                            rowStr + text_useGroup,
                                                            2);
                        if (errSize == errors.size()) {
                        ...
                        //グループ3
                        GSValidateCircular.validateCsvUserId(errors, accountData.getGroup3(),
                                                           "acntGroup3" + rowNum,
                                                            rowStr + text_useGroup,
                                                            3);
                        if (errSize == errors.size()) {
                        ...
                        //グループ4
                        GSValidateCircular.validateCsvUserId(errors, accountData.getGroup4(),
                                                           "acntGroup4" + rowNum,
                                                            rowStr + text_useGroup,
                                                            4);
                        if (errSize == errors.size()) {
                        ...
                        //グループ5
                        GSValidateCircular.validateCsvUserId(errors, accountData.getGroup5(),
                                                           "acntGroup5" + rowNum,
                                                            rowStr + text_useGroup,
                                                            5);
                        if (errSize == errors.size()) {
