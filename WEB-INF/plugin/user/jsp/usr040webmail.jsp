...
<!--       社員/職員番号 -->
      <td nowrap>
      <div>
       <span class="<%=mukoclass %>" style="font-color:#eeeeee;font-size:12px;line-height:1em;">
    ...
    <tr>
      ...
      <span class="text_link2 <%=mukoclass %>"><bean:write name="user" property="usiSei" />&nbsp;<bean:write name="user" property="usiMei" />
       </span>
       </a>
       <% } else { %>
          <span class="text_base <%=mukoclass %>"><bean:write name="user" property="usiSei" />&nbsp;<bean:write name="user" property="usiMei" /></span>
       <% } %>
      </td>
    </tr>
    <!-- 役職 -->
    <tr>
      <td nowrap>
       <span class="cel_user_data <%=mukoclass %>">
    ...
    <td>
        <logic:notEmpty name="user" property="belongGrpList">
          <logic:iterate id="grp" name="user" property="belongGrpList">
            <div class="cel_user_data <%=mukoclass %>"><bean:write name="grp" property="groupName"/></div>
          </logic:iterate>
        </logic:notEmpty>
    </td>
    <!-- 電話・内線 -->
    ...
    <td>
      ...
      <span class="cel_user_data <%=mukoclass %>" style="white-space: nowrap">
