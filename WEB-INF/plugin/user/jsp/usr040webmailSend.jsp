...
<%@ taglib uri="/WEB-INF/ctag-message.tld" prefix="gsmsg" %>
  ...
  <td width="30%" align="left">
   ...
   <tr class="td_type1">
   <td nowrap>
     <span class="text_base <%=mukoclass %>">
  ...
  <td width="30%" align="left">
   ...
   <tr class="td_type1">
   <td nowrap><span class="text_base <%=mukoclass %>"><bean:write name="ccMdl" property="usiSei" />&nbsp;&nbsp;<bean:write name="ccMdl" property="usiMei" /></span><br>
  ...
  <td width="30%" align="left">
   ...
   <tr class="td_type1">
   <td nowrap><span class="text_base <%=mukoclass%>"><bean:write name="bccMdl" property="usiSei" />&nbsp;&nbsp;<bean:write name="bccMdl" property="usiMei" /></span>
