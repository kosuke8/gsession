...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="cmn.shain.info" /> <gsmsg:write key="cmn.default" /><gsmsg:write key="cmn.display.settings" /> ]</td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="15%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.cmn100.4" /><gsmsg:write key="cmn.display.settings" /></span><span class="text_r2">※</span></td>
    <td class="td_type1">
    <html:radio styleId="dispEditOn" name="usr082Form" property="usr082QrDisp" value="1"/><label for="dispEditOn"><gsmsg:write key="cmn.display.ok" /></label>
    <html:radio styleId="dispEditOff" name="usr082Form" property="usr082QrDisp" value="0"/><label for="dispEditOff"><gsmsg:write key="cmn.dont.show" /></label>
    </td>
    </tr>
    </table>
