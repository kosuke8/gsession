      ...
      <td width="0%">
        ...
        <logic:notEmpty name="usr030Form" property="usr030users">
          <html:select property="usr030selectusers" style="width:550px;" size="20"  multiple="multiple">
            ...
            <option value='<bean:write name="user" property="usrSid"/>' class="mukouser_option"><bean:write name="user" property="usiName"/></option>
            </logic:equal>
      ...
      <td width="100%" align="center" valign="top">
        ...
        <td>
          ...
          <table width="0%" cellpadding="5">
            <tr>
            <td>
              <input type="button" name="btn_prjadd" class="btn_add_n3" value="<gsmsg:write key="user.59" />"  onClick="buttonPush('add');">
            </td>
            <td ></td>
            </tr>
            <tr>
            <td align="center" valign="top">
              <input type="button" name="btn_prjadd" class="btn_edit_n2" value="<gsmsg:write key="cmn.fixed2" />"  onClick="buttonPush('edit');"><br />
            </td>
            <td>
            ...
            <tr>
            <td>
              <input type="button" name="btn_prjadd" class="btn_uko" value="<gsmsg:write key="user.usr030.2" />"  onClick="buttonPush('yuko');">
            </td>
            <td>
              <input type="button" name="btn_prjadd" class="btn_mko" value="<gsmsg:write key="user.usr030.3" />"  onClick="buttonPush('muko');">
            </td>
            </tr>
            <tr>
            <td>
