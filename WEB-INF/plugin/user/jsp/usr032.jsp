  ...
  <td align="left">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="tab_bg_image_3_off" nowrap>
            <div class="tab_text_area_right">
                <a href="javascript:changeTab('multipleGroup');"><gsmsg:write key="user.usr032.6" /></a>
            </div>
        </td>
    ...
    <logic:equal name="usr032Form" property="usr032cmdMode" value="<%= String.valueOf(jp.groupsession.v2.usr.GSConstUser.MODE_MULTIPLE_GROUP) %>">
      ...
      &nbsp;<span class="text_base">*<gsmsg:write key="cmn.plz.specify2" arg0="<%= csvFileMsg %>" /></span>
      <br>&nbsp;<span class="text_base">*<gsmsg:write key="user.91" />⇒<a href="../user/usr032.do?CMD=Usr032_sample03&sample=1">【<gsmsg:write key="cmn.download" />】</a></span>
    </logic:equal>
    </td>
    </tr>
