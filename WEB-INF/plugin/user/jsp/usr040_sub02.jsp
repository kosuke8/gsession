...
<%@ taglib uri="/WEB-INF/ctag-message.tld" prefix="gsmsg" %>
    ...
    <html:hidden property="scrollPosition" />
      ...
      <tr valign="top">
      <td width="50%">
        <iframe src="../user/usr022.do" class="iframe_01" name="ctgFrame" width="100%" height="100%">
      ...
      <td width="45%" valign="middle" align="left">
        ...
        <td colspan="2" style="border:none;padding-top:15px;">
          <div width="50%" style="text-align:center;"><input type="button" name="grpSearch" class="btn_search_n1" value="絞込み" onClick="groupShiborikomi(1);"></div>
        </td>
        </tr>
        </table>
      </td>
