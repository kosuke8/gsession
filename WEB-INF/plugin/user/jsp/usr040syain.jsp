...
<%@ taglib uri="/WEB-INF/ctag-message.tld" prefix="gsmsg" %>
    ...
    <td>
      ...
      <td align="left" nowrap>
       <span style="font-color:#eeeeee;font-size:12px;" class="<bean:write name="ukoclass" />">
    ...
    <tr>
      <td align="left" nowrap>
       ...
       <span class="text_link2 <bean:write name="ukoclass" />">
    ...
    <tr>
      <td align="left" nowrap>
       <span class="cel_user_data <bean:write name="ukoclass" />">
    ...
    <td>
        <logic:notEmpty name="user" property="belongGrpList">
          <logic:iterate id="grp" name="user" property="belongGrpList">
            <div class="cel_user_data <bean:write name="ukoclass" />"><bean:write name="grp" property="groupName"/></div>
          </logic:iterate>
        </logic:notEmpty>
    </td>
    ...
    <td>
      ...
      <div class="cel_user_data <bean:write name="ukoclass" />">
        <logic:notEmpty name="user" property="usiTel1"><bean:write name="user" property="usiTel1" />
        ...
        <logic:notEmpty name="user" property="usiTelNai1">
          <div>
            <gsmsg:write key="user.136" />:<bean:write name="user" property="usiTelNai1" />
      ...
      <div class="cel_user_data <bean:write name="ukoclass" />" style="margin-top:10px">
        <logic:notEmpty name="user" property="usiTel2"><bean:write name="user" property="usiTel2" />
        ...
        <logic:notEmpty name="user" property="usiTelNai2">
          <div>
            <gsmsg:write key="user.136" />:<bean:write name="user" property="usiTelNai2" />
      ...
      <div class="cel_user_data <bean:write name="ukoclass" />" style="margin-top:10px">
        <logic:notEmpty name="user" property="usiTel3"><bean:write name="user" property="usiTel3" />
        ...
        <logic:notEmpty name="user" property="usiTelNai3">
          <div>
            <gsmsg:write key="user.136" />:<bean:write name="user" property="usiTelNai3" />
