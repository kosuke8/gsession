...
function setFromDay() {
    ...
    if (parseInt(frYear) > parseInt(toYear)) {
        ...
        frMonth = toMonth;
        frDay = toDay;
        document.forms[0].sch040FrYear.value = toYear;
        document.forms[0].sch040FrMonth.value = toMonth;
        document.forms[0].sch040FrDay.value = toDay;
     ...
     && parseInt(toMinute) > -1) {
        ...
        if (daySameFlg) {
            ...
            if (parseInt(frHour) > parseInt(toHour)) {
                frHour = toHour;
                document.forms[0].sch040FrHour.value = toHour;

            }
            if (parseInt(frHour) == parseInt(toHour)) {
                if (parseInt(frMinute) > parseInt(toMinute)) {
                    document.forms[0].sch040FrMin.value = toMinute;
                }
            }
        }
    }
...
//午前
function setAmTime() {
  $("#sch040FrHour").val($(':hidden[name="sch040AmFrHour"]').val());
  $("#sch040FrMin").val($(':hidden[name="sch040AmFrMin"]').val());
  $("#sch040ToHour").val($(':hidden[name="sch040AmToHour"]').val());
  $("#sch040ToMin").val($(':hidden[name="sch040AmToMin"]').val());
}

//午後
function setPmTime() {
  $("#sch040FrHour").val($(':hidden[name="sch040PmFrHour"]').val());
  $("#sch040FrMin").val($(':hidden[name="sch040PmFrMin"]').val());
  $("#sch040ToHour").val($(':hidden[name="sch040PmToHour"]').val());
  $("#sch040ToMin").val($(':hidden[name="sch040PmToMin"]').val());
}

//終日
function setAllTime() {
  $("#sch040FrHour").val($(':hidden[name="sch040AllDayFrHour"]').val());
  $("#sch040FrMin").val($(':hidden[name="sch040AllDayFrMin"]').val());
  $("#sch040ToHour").val($(':hidden[name="sch040AllDayToHour"]').val());
  $("#sch040ToMin").val($(':hidden[name="sch040AllDayToMin"]').val());
}
