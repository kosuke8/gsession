...
function opnTemp(listName, pluginId, fileLimit, mode, tempDirId) {
    var winWidth=558;
    var winHeight=290;
...
function opnTempPlus(listName, pluginId, fileLimit, mode, plusDir, tempDirId) {
    var winWidth=558;
    var winHeight=290;
    var winx = getCenterX(winWidth);
    var winy = getCenterY(winHeight);
