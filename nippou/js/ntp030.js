                ...
                if (data.length > 0) {
                    for (i=0; i<data.length; i++) {
                        ...
                        if (cmtdata.length > 0) {
                            for (j=0; j<cmtdata.length; j++) {
                                ...
                                commentStr +=  "</td><td id=\"commentDspAreaTable"
                                           ...
                                           +  "_"
                                           +  cmtMdl.npcSid
                                           +  "\" style=\"padding-top:5px;padding-left:10px;\" valign=\"top\"><span class=\"" + cmtUsermukoClass + "\" style=\"font-size: 12px; color: rgb(51, 51, 51);\"><b>"
                        ...
                        if (data[i].ankenViewable == true) {
                            cmtDspAreaStr = "<tr class=\"ntp030DspComment_tr_" + dataNtpSid + "\">"
                        ...
                        if (data[i].ntp030GoodFlg == 0) {
                            ...
                            goodBtnStr = "<span class=\"text_already_good\">"+ msglist["how.nice.doing"] +"</span>";
                        }
                        ...
                        if (data[i].ntp030DspKtbunrui != msglist["cmn.notset"]) {
                            actClass =  "<span style=\"font-color:#eeeeee;font-size:12px;line-height:1em;\">" + msglist["activities.class"] + "&nbsp;:&nbsp;" + data[i].ntp030DspKtbunrui + "</span>"
                                         +  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                        }
                        ...
                        if (data[i].ntp030DspKthouhou != msglist["cmn.notset"]) {
                            actMethod =   "<span style=\"font-color:#eeeeee;font-size:12px;line-height:1em;\">" + msglist["activity.method"] + "&nbsp;:&nbsp;" + data[i].ntp030DspKthouhou + "</span>"
                                         +  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                        }
                        ...
                        +                     "<span class=\"" + usermukoClass + "\" style=\"font-color:#eeeeee;font-size:13px;line-height:1em;\">" + usrInfMdl.usiSei + "&nbsp;&nbsp;" + usrInfMdl.usiMei + "</span>"
