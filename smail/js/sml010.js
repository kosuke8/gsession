...
//                  $('.head_menu_add_btn').click();
    ...
    $('.syain_sel_check_img').live("click", function(){
        $(this).next().click();
    });
    //ユーザ選択
        ...
        if (data["success"]) {
            try {
                ...
                if (data.sml090SearchResultList != null && data.sml090SearchResultList.length > 0) {
                    ...
                    if ($('#mail_search_list_head_tr').size() == 0) {
                    ...
                    for (i = 0; i < data.sml090SearchResultList.length; i++) {
                        ...
                        if (smlMdl.atesakiList != null) {
                            if (data.sml090SvMailSyubetsu != "1" && data.sml090SvMailSyubetsu != "2") {
                                ...
                                if (smlMdl.usrUkoFlg == "1" && smlMdl.usrJkbn != "9" && smlMdl.usrJkbn != "1") {
                                    listStr +=  " mukouser";
                                }
                                listStr +=  "\">";
                        ...
                        if (smlMdl.atesakiList != null) {
                            ...
                            for (l = 0; l < listSize; l++) {
                                ...
                                if (atesakiMdl.usrUkoFlg == "1" && atesakiMdl.usrJkbn != "9" && atesakiMdl.usrJkbn != "1") {
                                    atesakiNameStr +=  " mukouser";
                                }
                                atesakiNameStr +=  "\">";
                                ...
                                if (mailData.usrSid > 0) {
                                    if (mailData.usrJkbn == "0") {
                                        ...
                                        if (mailData.usrSid > 100) {
                                            var mukoclass = "";
                                            if (mailData.usrUkoFlg == "1") {
                                                mukoclass = " mukouser ";
                                            }
                                            atesakiKenmeiStr += "<a href=\"javaScript:void(0);\" class=\"atesaki_link"
                                            + mukoclass
                                ...
                                if (mailData.atesakiList.length > "0") {
                                    ...
                                    if(data.photoDspFlg=="0"){
                                        ...
                                        for (m = 0; m < mailData.atesakiList.length; m++) {
                                            ...
                                            atesakiKenmeiStr += "<span class=\"mail_check_txt";
                                            if (atesaki.usrSid > 0) {
                                                if (atesaki.usrJkbn == "0" && atesaki.usrUkoFlg == "1") {
                                                    atesakiKenmeiStr += " mukouser";
                                                }
                                            }
                                            atesakiKenmeiStr += "\" style=\"white-space: nowrap\">";
                                        ...
                                        for (m = 0; m < mailData.atesakiList.length; m++) {
                                            ...
                                            if (atesaki.usrSid > 0) {
                                                if (atesaki.usrJkbn == "0") {
                                                    if (atesaki.usrUkoFlg == "1") {
                                                        atesakiKenmeiStr += "<span class=\"mukouser\">";
                                                    }
                                                    atesakiKenmeiStr += htmlEscape(atesaki.usiSei) + "&nbsp;&nbsp;" + htmlEscape(atesaki.usiMei);
                                                    if (atesaki.usrUkoFlg == "1") {
                                                        atesakiKenmeiStr += "</span >";
                                                    }
                                ...
                                if (mailData.ccList.length > "0") {
                                    ...
                                    if(data.photoDspFlg=="0"){
                                        ...
                                        for (n = 0; n < mailData.ccList.length; n++) {
                                            ...
                                            atesakiKenmeiStr += "<span class=\"mail_check_txt";
                                            if (atesaki.usrSid > 0) {
                                                if (cc.usrJkbn == "0" && cc.usrUkoFlg == "1") {
                                                    atesakiKenmeiStr += " mukouser";
                                                }
                                            }
                                            atesakiKenmeiStr += "\" style=\"white-space: nowrap\">";
                                ...
                                if (mailData.bccList.length > "0") {
                                    ...
                                    if(data.photoDspFlg=="0"){
                                        ...
                                        for (o = 0; o < mailData.bccList.length; o++) {
                                            ...
                                            atesakiKenmeiStr += "<span class=\"mail_check_txt";
                                            if (bcc.usrSid > 0) {
                                                if (bcc.usrJkbn == "0" && bcc.usrUkoFlg == "1") {
                                                    atesakiKenmeiStr += " mukouser";
                                                }
                                            }
                                            atesakiKenmeiStr += "\" style=\"white-space: nowrap\">";
                                            ...
                                            for (t = 0; t < mailData.atesakiList.length; t++) {
                                                ...
                                                if (atesakiMdl.usrSid > 0) {
                                                    if (atesakiMdl.usrJkbn == "0") {
                                                        ...
                                                        atesakiKenmeiStr += "<a href=\"javaScript:void(0);\" class=\"atesaki_link" + mukoclass + "\" onClick=\"openUserInfoWindow(" + atesakiMdl.usrSid + ");\">"
...
//                                                  atesakiKenmeiStr += "<br>　　　　";
                                        ...
                                        if (mailData.ccList.length > 0) {
                                            ...
                                            for (c = 0; c < mailData.ccList.length; c++) {
                                                ...
                                                if (ccMdl.usrSid > 0) {
                                                    if (ccMdl.usrJkbn == "0") {
                                                        if (ccMdl.usrUkoFlg=="1") {
                                                            mukoclass = " mukouser";
                                                        }

                                                        atesakiKenmeiStr += "<a href=\"javaScript:void(0);\" class=\"atesaki_link" + mukoclass + "\" onClick=\"openUserInfoWindow(" + ccMdl.usrSid + ");\">"
...
//                                                  atesakiKenmeiStr += "<br>　　　　";
                                        ...
                                        if (mailData.bccList.length > 0) {
                                            ...
                                            for (b = 0; b < mailData.bccList.length; b++) {
                                                ...
                                                if (bccMdl.usrSid > 0) {
                                                    if (bccMdl.usrJkbn == "0") {
                                                        if (bccMdl.usrUkoFlg=="1") {
                                                            mukoclass = "<span class=\"mukouser\">";
                                                        }
...
//                                              atesakiKenmeiStr += "<br>　　　　";
                                    ...
                                    for (at = 0; at < mailData.atesakiList.length; at++) {
                                        ...
                                        if (atesakiMdl.usrSid > 0) {
                                            if (atesakiMdl.usrJkbn == "0") {
                                                ...
                                                opnSituation += "<td class=\"open_situation_td\"><span class=\"text_base2" + mukoclass + "\">" + htmlEscape(atesakiMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(atesakiMdl.usiMei) + "</span></td>";
                                            }
                                    ...
                                    for (cc = 0; cc < mailData.ccList.length; cc++) {
                                        ...
                                        if (ccMdl.usrSid > 0) {
                                            if (ccMdl.usrJkbn == "0") {
                                                ...
                                                opnSituation += "<td class=\"open_situation_td\"><span class=\"text_base2" + mukoclass + "\">" + htmlEscape(ccMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(ccMdl.usiMei) + "</span></td>";
                                            }
                                    ...
                                    for (bcc = 0; bcc < mailData.bccList.length; bcc++) {
                                        ...
                                        if (bccMdl.usrSid > 0) {
                                            if (bccMdl.usrJkbn == "0") {
                                                ...
                                                opnSituation += "<td class=\"open_situation_td\"><span class=\"text_base2" + mukoclass + "\">" + htmlEscape(bccMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(bccMdl.usiMei) + "</span></td>";
                                            }
        ...
        messagePop(msglist_sml010["sml.195"], 500, 200);
    }
    ...
    paramStr += "&cmn120BackUrl=smail"
        ...
        $.ajax({
            ...
            if (data["success"]) {
                ...
                try {
                    ...
                    if (data.cmn120RightUserList.length > 0) {
                        ...
                        for (l = 0; l < data.cmn120RightUserList.length; l++) {
                            ...
                            selUsrRightStr += "<option ";
                            if (selGrpMdl.usrUkoFlg == "1") {
                                selUsrRightStr += "class=\"mukouser_option\"";
                            }
                            selUsrRightStr += "value=\""
                                +  selGrpMdl.value
                                +  "\">"
                    ...
                    if (data.cmn120LeftUserList.length > 0) {
                        for (m = 0; m < data.cmn120LeftUserList.length; m++) {
                            ...
                            selUsrLeftStr += "<option ";
                            if (selGrpLeftMdl.usrUkoFlg == "1") {
                                selUsrLeftStr += "class=\"mukouser_option\"";
                            }
                            selUsrLeftStr += "value=\""
                                +  selGrpLeftMdl.value
                                +  "\">"
                ...
                alert(msglist_sml010["sml.196"] + ae);
            }
            } else {
                ...
                if (data.sml010userList.length > 0) {
                    for (u = 0; u < data.sml010userList.length; u ++) {
                        ...
                        if (usrMdl.usrSid != null && usrMdl.usrSid > 0) {
                            //通常ユーザ
                            var usrLabel = "<div class=\"syain_checkbox_area\">"
                                    + "<input class=\"syain_checkbox\" type=\"checkbox\" name=\"sml010usrSids\" value=\""
                                    + usrMdl.usrSid
                                    + "\" />&nbsp";

                            //画像非公開
                            if (data.photoDspFlg == 0 && usrMdl.usiPictKf != 0) {
                                usrLabel = usrLabel + "<span style=\"color:#fc2929;display:inline-block;text-align:center;vertical-align:text-bottom;"
                                + " cursor:pointer;\" class=\"photo_hikokai4 syain_sel_check_img\">" + msglist_sml010["cmn.private.photo"] + "</span>&nbsp;";
                            }

                            usrLabel = usrLabel + "<a class=\"syain_sel_check_txt syain_sel_txt";

                            if (usrMdl.usrUkoFlg == "1") {
                                usrLabel = usrLabel + " mukouser ";
                            }

                            usrLabel = usrLabel + "\" id=\""
                                    + usrMdl.usrSid
                                    + "\">";
                            ...
                            if (data.photoDspFlg == 0 && usrMdl.usiPictKf == 0) {
                                ...
                                if (usrMdl.binSid == 0) {
                                    usrLabel = usrLabel
                                    + "<img src=\"../user/images/photo.gif\" name=\"userImage\" alt=\"" + msglist_sml010["cmn.photo"] + "\""
                                    + " onload=\"initImageView50('userImage" + usrMdl.usrSid + "');\" border=\"1\" width=\"25px\" height=\"28px\""
                                    + " class=\"img_bottom\">&nbsp;";
                                } else {
                                    usrLabel = usrLabel
                                    + "<img src=\"../common/cmn100.do?CMD=getImageFile&cmn100binSid=" + usrMdl.binSid + "\""
                                    + " name=\"userImage\" alt=\"" + msglist_sml010["cmn.photo"] + "\""
                                    + " onload=\"initImageView50('userImage" + usrMdl.usrSid + "');\" border=\"1\" width=\"25px\" height=\"28px\""
                                    + " class=\"img_bottom\"/>&nbsp;";
                                }
                            }
...
//                  $('.head_menu_add_btn').click();
        ...
        $('input:checkbox[name=sml010usrSids]:checked').each(function(){
            ...
            var mukoclass = "";
            if (usrId != null) {
                if ($(this).next().hasClass("mukouser")) {
                    mukoclass = " mukouser";
                }
                var selFlg = false;
    ...
    if ($('#funcBtnKbn').val() == 0) {
        ...
        $('#cmn120SelectRightUser option').each(function(){
            ...
            if ($(this).val() != null && $(this).val() != 0 && $(this).val() != -1 && $(this).val() != "") {
                var addStr = "<div class=\"atesaki_to_user\" id=\"0\">";
                if ($(this).hasClass("mukouser_option")) {
                    addStr += "<span class=\"mukouser\"> ";
                }
                addStr += htmlEscape($(this).text());
                if ($(this).hasClass("mukouser_option")) {
                    addStr += "</span> ";
                }

                $('#atesaki_to_area').append(addStr
                        + "<input type=\"hidden\" name=\"sml020userSid\" value=\""
                        + $(this).val()
                        + "\" />&nbsp;&nbsp;[<span class=\"add_usr_del\">削除</span>]</div>");
        ...
        $('#cmn120SelectRightUser option').each(function(){
            ...
            if ($(this).val() != null && $(this).val() != 0 && $(this).val() != -1 && $(this).val() != "") {
                var addStr = "<div class=\"atesaki_cc_user\" id=\"1\">";
                if ($(this).hasClass("mukouser_option")) {
                    addStr += "<span class=\"mukouser\"> ";
                }
                addStr += htmlEscape($(this).text());
        ...
        $('#cmn120SelectRightUser option').each(function(){
            ...
            if ($(this).val() != null && $(this).val() != 0 && $(this).val() != -1 && $(this).val() != "") {
                var addStr = "<div class=\"atesaki_bcc_user\" id=\"2\">";
                ...
                $('#atesaki_bcc_area').append(addStr
        ...
        $('#cmn120SelectRightUser option').each(function(){
            ...
            if ($(this).val() != null && $(this).val() != 0 && $(this).val() != -1 && $(this).val() != "") {
                var addStr = "<div class=\"atesaki_search_user\" id=\"3\">";
                ...
                $('#atesaki_search_area').append(addStr
                    ...
                    if (data.photoDspFlg=="0") {
                        ...
                        for (d = 0; d < detail.atesakiList.length; d++) {
                            ...
                            if (atesaki.usrSid > 0) {
                                if (atesaki.usrJkbn == "0") {
                                    if (atesaki.usrUkoFlg == "1") {
                                        atesakiStr += "<span class=\"mukouser\">"
                                    }
                        ...
                        for (d = 0; d < detailCc.atesakiList.length; d++) {
                            ...
                            if (atesakiCc.usrSid > 0) {
                                if (atesakiCc.usrJkbn == "0") {
                                    if (atesakiCc.usrUkoFlg == "1") {
                                        atesakiCcStr += "<span class=\"mukouser\">"
                                    }
                        ...
                        for (d = 0; d < detailBcc.atesakiList.length; d++) {
                            ...
                            if (atesakiBcc.usrSid > 0) {
                                if (atesakiBcc.usrJkbn == "0") {
                                    if (atesakiBcc.usrUkoFlg == "1") {
                                        atesakiBccStr += "<span class=\"mukouser\">"
                                    }
            ...
            for (u = 0; u < mailData.sml020Atesaki.atesakiList.length; u++) {
                ...
                if (!selFlg) {
                    ...
                    if (atesakiMdl.usrSid > 0) {
                        ...
                        $('#atesaki_to_area').append("<div class=\"atesaki_to_user\" id=\"0\"><span class=\""
                                + mukoclass +"\">"
                                + htmlEscape(atesakiMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(atesakiMdl.usiMei)
                                + "</span>"
                                + "<input type=\"hidden\" name=\"sml020userSid\" value=\""
            ...
            for (u = 0; u < mailData.sml020AtesakiCc.atesakiList.length; u++) {
                ...
                if (!selFlg) {
                    ...
                    if (atesakiMdl.usrSid > 0) {
                        ...
                        $('#atesaki_cc_area').append("<div class=\"atesaki_cc_user\" id=\"0\"><span class=\""
                                + mukoclass +"\">"
                                + htmlEscape(atesakiMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(atesakiMdl.usiMei)
                                + "</span>"
                                + "<input type=\"hidden\" name=\"sml020userSidCc\" value=\""
            ...
            for (u = 0; u < mailData.sml020AtesakiBcc.atesakiList.length; u++) {
                ...
                if (!selFlg) {
                    ...
                    if (atesakiMdl.usrSid > 0) {
                        ...
                        $('#atesaki_bcc_area').append("<div class=\"atesaki_bcc_user\" id=\"0\"><span class=\""
                                + mukoclass +"\">"
                                + htmlEscape(atesakiMdl.usiSei) + "&nbsp;&nbsp;" + htmlEscape(atesakiMdl.usiMei)
                                + "</span>"
                                + "<input type=\"hidden\" name=\"sml020userSidBcc\" value=\""
